...
*Commit(s):* [JuliaLang/julia@e6f13e967a5b1289244fb48680b0bd434b4faa9f](https://github.com/JuliaLang/julia/commit/e6f13e967a5b1289244fb48680b0bd434b4faa9f) vs [JuliaLang/julia@6a4793ae77490c7704967acb996902661279396e](https://github.com/JuliaLang/julia/commit/6a4793ae77490c7704967acb996902661279396e)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/e6f13e967a5b1289244fb48680b0bd434b4faa9f#commitcomment-40728104)
...
failed process: Process(`docker run --detach --gpus all -e NVIDIA_VISIBLE_DEVICES=all -e NVIDIA_DRIVER_CAPABILITIES=all --mount type=bind,source=/tmp/jl_S3Zo8A/julia-6a4793ae77,target=/opt/julia,readonly --mount type=bind,source=/home/maleadt/.julia/registries,target=/usr/local/share/julia/registries,readonly --mount type=bind,source=/home/maleadt/.cache/NewPkgEval/artifacts,target=/var/cache/julia/artifacts --env JULIA_DEPOT_PATH=::/usr/local/share/julia --tmpfs /home/pkgeval:exec,uid=1000,gid=1000 --cpus=2 --env JULIA_NUM_THREADS=2 --name Grassmann-XjG5fw2Z --rm newpkgeval xvfb-run /opt/julia/bin/julia -e '    using InteractiveUtils
    ...
    Pkg.add(ARGS...)
    Pkg.test(ARGS...)
' Grassmann`, ProcessExited(125)) [125]
