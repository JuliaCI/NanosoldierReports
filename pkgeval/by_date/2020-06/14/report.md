...
*Commit(s):* [JuliaLang/julia@13b07fcc57d268b37234d8b8753b4ef3447be8db](https://github.com/JuliaLang/julia/commit/13b07fcc57d268b37234d8b8753b4ef3447be8db) vs [JuliaLang/julia@6b2ffd39135ff2a13a2ae8fa188da5ee0ac6f8c5](https://github.com/JuliaLang/julia/commit/6b2ffd39135ff2a13a2ae8fa188da5ee0ac6f8c5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/13b07fcc57d268b37234d8b8753b4ef3447be8db#commitcomment-39896905)
...
failed process: Process(`docker run --detach --gpus all -e NVIDIA_VISIBLE_DEVICES=all -e NVIDIA_DRIVER_CAPABILITIES=all --mount type=bind,source=/tmp/jl_oe4fXE,target=/opt/julia,readonly --mount type=bind,source=/home/maleadt/.julia/registries,target=/usr/local/share/julia/registries,readonly --mount type=bind,source=/home/maleadt/.cache/NewPkgEval/artifacts,target=/var/cache/julia/artifacts --env JULIA_DEPOT_PATH=::/usr/local/share/julia --tmpfs /home/pkgeval:exec,uid=1000,gid=1000 --cpus=2 --env JULIA_NUM_THREADS=2 --name MLJLinearModels-iNYLpSvg --rm newpkgeval xvfb-run /opt/julia/bin/julia -e '    using InteractiveUtils
    ...
    Pkg.add(ARGS...)
    Pkg.test(ARGS...)
' MLJLinearModels`, ProcessExited(125)) [125]
