...
*Commit(s):* [JuliaLang/julia@cf3d8b584a44d48b0dc66db9ab37f871f63a21c7](https://github.com/JuliaLang/julia/commit/cf3d8b584a44d48b0dc66db9ab37f871f63a21c7) vs [JuliaLang/julia@40cc4ad6cfe876f2b21e3e9fea6816dfafe01674](https://github.com/JuliaLang/julia/commit/40cc4ad6cfe876f2b21e3e9fea6816dfafe01674)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/cf3d8b584a44d48b0dc66db9ab37f871f63a21c7#commitcomment-38913813)
...
failed process: Process(`docker run --detach --gpus all -e NVIDIA_VISIBLE_DEVICES=all -e NVIDIA_DRIVER_CAPABILITIES=all --mount type=bind,source=/home/maleadt/.cache/NewPkgEval/usr/julia-1.5.0-DEV-cf3d8b584a/julia-cf3d8b584a,target=/opt/julia,readonly --mount type=bind,source=/home/maleadt/.julia/registries,target=/usr/local/share/julia/registries,readonly --mount type=bind,source=/home/maleadt/.cache/NewPkgEval/artifacts,target=/var/cache/julia/artifacts --env JULIA_DEPOT_PATH=::/usr/local/share/julia --tmpfs /home/pkgeval:exec,uid=1000,gid=1000 --cpus=2 --env JULIA_NUM_THREADS=2 --name Julia_v1.5.0-DEV-cf3d8b584a-VersionParsing-ZOjyre7V --rm newpkgeval xvfb-run /opt/julia/bin/julia -e '    using InteractiveUtils
    ...
    Pkg.add(ARGS...)
    Pkg.test(ARGS...)
' VersionParsing`, ProcessExited(125)) [125]
