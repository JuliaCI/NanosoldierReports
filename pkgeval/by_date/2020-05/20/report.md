...
*Commit(s):* [JuliaLang/julia@215519908f0148f0d6195ab561a065f7fc6e331d](https://github.com/JuliaLang/julia/commit/215519908f0148f0d6195ab561a065f7fc6e331d) vs [JuliaLang/julia@9655c212522176a0df6f2d87d8ae44620ed32ce3](https://github.com/JuliaLang/julia/commit/9655c212522176a0df6f2d87d8ae44620ed32ce3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/215519908f0148f0d6195ab561a065f7fc6e331d#commitcomment-39317404)

*Package Selection:* `ALL`

*Daily Job:* 2020-05-20 vs 2020-05-20
...
failed process: Process(`docker run --detach --gpus all -e NVIDIA_VISIBLE_DEVICES=all -e NVIDIA_DRIVER_CAPABILITIES=all --mount type=bind,source=/tmp/jl_KQFm36/julia-215519908f,target=/opt/julia,readonly --mount type=bind,source=/home/maleadt/.julia/registries,target=/usr/local/share/julia/registries,readonly --mount type=bind,source=/home/maleadt/.cache/NewPkgEval/artifacts,target=/var/cache/julia/artifacts --env JULIA_DEPOT_PATH=::/usr/local/share/julia --tmpfs /home/pkgeval:exec,uid=1000,gid=1000 --cpus=2 --env JULIA_NUM_THREADS=2 --name LRESolve-Bfk7F3Pa --rm newpkgeval xvfb-run /opt/julia/bin/julia -e '    using InteractiveUtils
    ...
    Pkg.add(ARGS...)
    Pkg.test(ARGS...)
' LRESolve`, ProcessExited(125)) [125]
