...
*Commit:* [JuliaLang/julia@9f93b3197a1da4ed21aa01dcdcd7df6020a3885c](https://github.com/JuliaLang/julia/commit/9f93b3197a1da4ed21aa01dcdcd7df6020a3885c)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/4e763466581eea139688ad27c4354410d728c7c8...9f93b3197a1da4ed21aa01dcdcd7df6020a3885c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/9f93b3197a1da4ed21aa01dcdcd7df6020a3885c#commitcomment-98552090)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-01-30 vs [2023-01-29](../../2023-01/29/report.md)
...
| `["inference", "abstract interpretation", "many_const_calls"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "allinference", "many_invoke_calls"]` | 1.05 (5%) :x: | 0.99 (1%)  |
...
| `["io", "serialization", ("deserialize", "Matrix{Float64}")]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "serialization", ("serialize", "Matrix{Float64}")]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["linalg", "arithmetic", ("*", "typename(SymTridiagonal)", "typename(SymTridiagonal)", 1024)]` | 6.73 (45%) :x: | 1.00 (1%)  |
| `["linalg", "arithmetic", ("-", "Matrix", "Matrix", 1024)]` | 1.96 (45%) :x: | 1.00 (1%)  |
| `["linalg", "small exp #29116"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "foldl", "foldl(+, filter(...); init = 0.0)"]` | 3.18 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (large)", "y negative", "x negative", "Float32")]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (large)", "y negative", "x positive", "Float32")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", ("0.00024414062f0 <= abs(x) < 9f0", "positive argument", "Float32")]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 4π/4", "negative argument", "Float32")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 4π/4", "negative argument", "Float64")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 4π/4", "positive argument", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 5π/4", "negative argument", "Float32")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 5π/4", "negative argument", "Float64")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 6π/4", "positive argument", "Float32")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 6π/4", "positive argument", "Float64")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 7π/4", "positive argument", "Float32")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 7π/4", "positive argument", "Float64")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.10.0-DEV.421
Commit 9f93b3197a (2023-01-22 15:55 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3399 MHz     563573 s       1184 s     109177 s  149046496 s          0 s
       #2  3476 MHz   11587617 s        649 s     320849 s  137909252 s          0 s
       #3  3228 MHz     573746 s        604 s      80418 s  149152151 s          0 s
       #4  3248 MHz     415950 s        617 s      77168 s  149047393 s          0 s
  Memory: 31.320838928222656 GB (18997.53515625 MB free)
  Uptime: 1.49947668e7 sec
