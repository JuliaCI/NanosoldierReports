...
*Commit:* [JuliaLang/julia@7a76e32c0e28133c3e229df7009c1eb7a6cc86d5](https://github.com/JuliaLang/julia/commit/7a76e32c0e28133c3e229df7009c1eb7a6cc86d5)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/58b239c5b8eaffec3b9b99e6d7c37e8ae6129d6d...7a76e32c0e28133c3e229df7009c1eb7a6cc86d5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/7a76e32c0e28133c3e229df7009c1eb7a6cc86d5#commitcomment-147252753)

*Tag Predicate:* `ALL`

*Daily Job:* 2024-09-26 vs [2024-09-23](../../2024-09/23/report.md)
...
| `["alloc", "strings"]` | 21.43 (5%) :x: | 1.42 (1%) :x: |
...
| `["array", "index", ("sumcolon", "Base.ReinterpretArray{Float32, 2, Int32, Matrix{Int32}, false}")]` | 1.06 (50%)  | 1.02 (1%) :x: |
| `["array", "setindex!", ("setindex!", 1)]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (10, "scal_tup")]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "union", "Set", "Set")]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", ("Set", "Int", "==", "self")]` | 1.27 (25%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 8.10 (5%) :x: | 1.18 (1%) :x: |
| `["inference", "abstract interpretation", "REPL.REPLCompletions.completions"]` | 5.40 (5%) :x: | 1.09 (1%) :x: |
| `["inference", "abstract interpretation", "broadcasting"]` | 11.18 (5%) :x: | 1.12 (1%) :x: |
| `["inference", "abstract interpretation", "many_global_refs"]` | 0.57 (5%) :white_check_mark: | 0.89 (1%) :white_check_mark: |
...
| `["inference", "abstract interpretation", "many_opaque_closures"]` | 0.95 (5%) :white_check_mark: | 0.99 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 3.01 (5%) :x: | 1.15 (1%) :x: |
| `["inference", "abstract interpretation", "rand(Float64)"]` | 8.63 (5%) :x: | 1.15 (1%) :x: |
| `["inference", "allinference", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.11 (5%) :x: | 1.12 (1%) :x: |
| `["inference", "allinference", "REPL.REPLCompletions.completions"]` | 1.05 (5%)  | 1.06 (1%) :x: |
...
| `["inference", "allinference", "rand(Float64)"]` | 1.10 (5%) :x: | 1.11 (1%) :x: |
...
| `["io", "skipchars"]` | 1.00 (5%)  | 1.08 (1%) :x: |
| `["linalg", "arithmetic", ("*", "typename(Bidiagonal)", "Vector", 1024)]` | 0.54 (45%) :white_check_mark: | 0.50 (1%) :white_check_mark: |
| `["linalg", "arithmetic", ("*", "typename(Bidiagonal)", "Vector", 256)]` | 0.58 (45%)  | 0.50 (1%) :white_check_mark: |
...
| `["misc", "foldl", "foldl(+, filter(...))"]` | 1.76 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "acos", ("abs(x) < 0.5", "negative argument", "Float64")]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", ("abs(x) < 0.5", "positive argument", "Float64")]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", ("one", "negative argument", "Float64")]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", ("one", "positive argument", "Float64")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["shootout", "meteor_contest"]` | 1.27 (5%) :x: | 1.01 (1%)  |
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 4, 31)]` | 1.80 (20%) :x: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 3, 31)]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_example!", "Float32", 4, 64)]` | 1.32 (20%) :x: | 1.00 (1%)  |
...
| `["sort", "issues", "small Int view"]` | 1.43 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 3", "sort(rand(2n, 2n, n); dims=2)"]` | 1.23 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 3", "sort(rand(2n, 2n, n); dims=3)"]` | 1.23 (20%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", ("Ac_mul_B", "dense 50x50, sparse 50x50 -> dense 50x50")]` | 1.32 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", ("Ac_mul_B", "dense 5x50, sparse 5x50 -> dense 50x50")]` | 1.31 (30%) :x: | 1.00 (1%)  |
...
| `["string", "==(::SubString, ::String)", "different"]` | 1.68 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum", "Int64", 1)]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum3", "BigFloat", 0)]` | 1.29 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_sum3", "BigFloat", 1)]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.12.0-DEV.1250
Commit 7a76e32c0e (2024-09-25 23:35 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz     445812 s        183 s     121583 s   93427417 s          0 s
       #2  3500 MHz    5919832 s         93 s     144267 s   87982062 s          0 s
       #3  3501 MHz     317672 s        122 s      54238 s   93666143 s          0 s
       #4  3500 MHz     313276 s         99 s      65779 s   93617830 s          0 s
       #5  3503 MHz     261919 s         72 s      47308 s   93649041 s          0 s
       #6  3501 MHz     287440 s         59 s      62648 s   93197885 s          0 s
       #7  3502 MHz     304114 s        111 s      52369 s   93597925 s          0 s
       #8  3501 MHz     268520 s         73 s      42808 s   93692086 s          0 s
  Memory: 31.30148696899414 GB (21167.56640625 MB free)
  Uptime: 9.40846243e6 sec
