...
*Commit:* [JuliaLang/julia@9ed4087f7f515f76a71164e292b013043b862053](https://github.com/JuliaLang/julia/commit/9ed4087f7f515f76a71164e292b013043b862053)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/1aa65c33f24e7a6c7a341ce4a13202bfb6ac4811...9ed4087f7f515f76a71164e292b013043b862053)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/9ed4087f7f515f76a71164e292b013043b862053#commitcomment-109185546)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-04-16 vs [2023-04-14](../../2023-04/14/report.md)
...
| `["collection", "iteration", ("Dict", "Int", "iterate")]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", ("Dict", "Int", "length")]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", ("Set", "Int", "first")]` | 0.63 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", ("Vector", "Int", "last")]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "accessor", "millisecond"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "accessor", "month"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "Date"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", ("> q0.99", "Vector{Float32}")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findnext", ("BitVector", "50-50")]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "bitshift", ("Int", "UInt")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "bitshift", ("UInt", "UInt")]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", ("randexp", "ImplicitRNG", "ImplicitFloat64")]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "Float32", "Float32")]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("mul", "Float64", "ComplexF64")]` | 0.21 (50%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("sub", "Float32", "Float32")]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("sub", "UInt64", "Complex{UInt64}")]` | 0.23 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", ("zero", "Float64")]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cbrt", ("very small", "negative argument", "Float32")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cbrt", ("very small", "positive argument", "Float32")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float64", "sin_kernel")]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float32", "cos_kernel")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", ("2pow35", "positive argument", "Float32")]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "13786"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "iteration", "in"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "iteration", "indexed"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", ("argument reduction (hard) abs(x) < 8π/4", "positive argument", "Float64")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", ("iseven", "Int64")]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", ("iseven", "UInt64")]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", ("isinf", "ComplexF64")]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", ("isinf", "Float32")]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", ("isinteger", "Float32")]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", ("isnan", "ComplexF32")]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", ("isnan", "ComplexF64")]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", ("isnan", "Float64")]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float64", "cos_kernel")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float64", "cos_kernel")]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "positive argument", "Float32", "sin_kernel")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", ("no reduction", "zero", "Float32")]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Linear", "inner_aliased", "Float32", 4095)]` | 0.76 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("sort", "Union{Nothing, BigFloat}", 0)]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.10.0-DEV.1013
Commit 9ed4087f7f (2023-04-13 13:04 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3900 MHz     334073 s      35470 s     319439 s   62023774 s          0 s
       #2  3900 MHz    5607185 s      22734 s     347092 s   56861905 s          0 s
       #3  3511 MHz     330275 s      23051 s     268563 s   62167810 s          0 s
       #4  3900 MHz     243221 s      21074 s     255585 s   62166056 s          0 s
  Memory: 31.313323974609375 GB (21114.8984375 MB free)
  Uptime: 6.29965793e6 sec
  Load Avg:  1.1  1.04  1.02
  WORD_SIZE: 64
  LIBM: libopenlibm
