...
*Commit:* [JuliaLang/julia@8327e859b51a926d499babe71dafa23f5bbb0840](https://github.com/JuliaLang/julia/commit/8327e859b51a926d499babe71dafa23f5bbb0840)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/bc33c81b5d2d8397be92bf5d488dfe721b116d7c...8327e859b51a926d499babe71dafa23f5bbb0840)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/8327e859b51a926d499babe71dafa23f5bbb0840#commitcomment-107492600)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-04-04 vs [2023-04-03](../../2023-04/03/report.md)
...
|----|------------|--------------|
| `["array", "any/all", ("any", "Vector{Float32}")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "reductions", ("mean", "Float64")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["broadcast", "mix_scalar_tuple", (10, "scal_tup")]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.84 (5%) :white_check_mark: | 0.96 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "REPL.REPLCompletions.completions"]` | 0.80 (5%) :white_check_mark: | 0.93 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "many_opaque_closures"]` | 0.75 (5%) :white_check_mark: | 0.90 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 0.80 (5%) :white_check_mark: | 0.96 (1%) :white_check_mark: |
| `["inference", "allinference", "REPL.REPLCompletions.completions"]` | 0.93 (5%) :white_check_mark: | 0.99 (1%) :white_check_mark: |
| `["inference", "allinference", "many_opaque_closures"]` | 0.89 (5%) :white_check_mark: | 0.97 (1%) :white_check_mark: |
| `["inference", "allinference", "println(::QuoteNode)"]` | 0.94 (5%) :white_check_mark: | 0.99 (1%)  |
| `["inference", "optimization", "println(::QuoteNode)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["inference", "optimization", "rand(Float64)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["linalg", "arithmetic", ("3-arg mul!", 2)]` | 1.55 (45%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "Float64", "Complex{UInt64}")]` | 3.53 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("very small", "positive argument", "Float32")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", ("large", "negative argument", "Float64")]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", ("large", "positive argument", "Float64")]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int64", 4, 32)]` | 1.20 (20%) :x: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "two_reductions", "Float64", 3, 31)]` | 0.69 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("map", "*", "BigInt", "(false, false)")]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Missing, BigInt}", 1)]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.10.0-DEV.929
Commit 8327e859b5 (2023-03-31 21:27 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3900 MHz     256346 s      27182 s     273030 s   51883294 s          0 s
       #2  3511 MHz    4111966 s      18133 s     292505 s   48119995 s          0 s
       #3  3900 MHz     258120 s      18259 s     238666 s   51980904 s          0 s
       #4  3900 MHz     191950 s      16988 s     231065 s   51988382 s          0 s
  Memory: 31.313323974609375 GB (22662.43359375 MB free)
  Uptime: 5.26748706e6 sec
