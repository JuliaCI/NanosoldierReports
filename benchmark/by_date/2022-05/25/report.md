...
*Commit:* [JuliaLang/julia@5e1c5cfdfe2bdd782decd568b2c18baed76f6979](https://github.com/JuliaLang/julia/commit/5e1c5cfdfe2bdd782decd568b2c18baed76f6979)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/7f84d46ce01b9400a61dd5660c7607a4629abad6...5e1c5cfdfe2bdd782decd568b2c18baed76f6979)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5e1c5cfdfe2bdd782decd568b2c18baed76f6979#commitcomment-74474771)

*Tag Predicate:* `ALL`

*Daily Job:* 2022-05-25 vs [2022-05-24](../../2022-05/24/report.md)
...
| `["alloc", "strings"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "comprehension", ("comprehension_collect", "Vector{Float64}")]` | 2.33 (5%) :x: | 1.00 (1%)  |
...
| `["broadcast", "typeargs", ("array", 5)]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "typeargs", ("tuple", 5)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "deletion", ("IdDict", "Int", "filter!")]` | 1.73 (25%) :x: | 1.00 (1%)  |
| `["collection", "deletion", ("Set", "Int", "filter!")]` | 0.57 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findall", ("> q0.5", "Vector{UInt64}")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "optimization", "domsort_ssa!"]` | 0.98 (5%)  | 0.99 (1%) :white_check_mark: |
| `["inference", "optimization", "sin(42)"]` | 0.98 (5%)  | 0.99 (1%) :white_check_mark: |
| `["inference", "println(::QuoteNode)"]` | 0.98 (5%)  | 0.99 (1%) :white_check_mark: |
...
| `["misc", "foldl", "foldl(+, filter(...))"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "foldl", "foldl(+, filter(...); init = 0.0)"]` | 3.21 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", ("RangeGenerator", "UInt128", "1:4294967297")]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("rand!", "MersenneTwister", "ComplexF16")]` | 2.10 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand!", "MersenneTwister", "Float16")]` | 3.13 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand", "MersenneTwister", "ComplexF16")]` | 1.91 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand", "MersenneTwister", "Float16")]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randn!", "MersenneTwister", "ComplexF16")]` | 1.67 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randn", "MersenneTwister", "ComplexF16")]` | 1.68 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", ("zero", "Float64")]` | 1.35 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (easy) abs(x) < 2π/4", "negative argument", "Float64")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (easy) abs(x) < 2π/4", "positive argument", "Float64")]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 3, 31)]` | 1.68 (20%) :x: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matmat", "(16, 16)", "(16, 16)")]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matmat", "(8, 8)", "(8, 8)")]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matvec", "(16, 16)", "(16,)")]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum2", "Float64", 1)]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "filter", "Union{Nothing, BigFloat}", 0)]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("sort", "Union{Missing, BigInt}", 1)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 5e1c5cfdfe (2022-05-23 02:41 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3330 MHz       7186 s         15 s        998 s     927051 s          0 s
       #2  2988 MHz     250290 s          0 s      11416 s     673973 s          0 s
       #3  2935 MHz       5495 s          0 s        573 s     929055 s          0 s
       #4  2898 MHz       3641 s          0 s        527 s     930748 s          0 s
       #5  2953 MHz       6094 s          0 s        544 s     926338 s          0 s
       #6  2570 MHz       4986 s          0 s        516 s     930042 s          0 s
       #7  2916 MHz       3524 s          0 s        528 s     931567 s          0 s
       #8  2918 MHz       8239 s          0 s        550 s     926475 s          0 s
  Memory: 31.32082748413086 GB (23834.22265625 MB free)
  Uptime: 93620.62 sec
