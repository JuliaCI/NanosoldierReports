...
*Commit:* [JuliaLang/julia@2cad2a771b1bf0592ffd3c725a0913299630b3bf](https://github.com/JuliaLang/julia/commit/2cad2a771b1bf0592ffd3c725a0913299630b3bf)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/5e7d7c3eeb78773f62bdf17267fb59f0d221be9a...2cad2a771b1bf0592ffd3c725a0913299630b3bf)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/2cad2a771b1bf0592ffd3c725a0913299630b3bf#commitcomment-112750972)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-05-10 vs [2023-05-08](../../2023-05/08/report.md)
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.09 (5%) :x: | 1.02 (1%) :x: |
| `["inference", "abstract interpretation", "REPL.REPLCompletions.completions"]` | 1.09 (5%) :x: | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "broadcasting"]` | 1.91 (5%) :x: | 1.56 (1%) :x: |
...
| `["scalar", "arithmetic", ("mul", "Float64", "ComplexF32")]` | 0.36 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", ("2.7755602085408512e-17 <= abs(x) < 22.0", "negative argument", "Float64")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", ("2pow1023", "negative argument", "Float64")]` | 1.80 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("no reduction", "positive argument", "Float64", "sin_kernel")]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("very large", "negative argument", "Float64")]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sinh", ("very large", "positive argument", "Float64")]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countnothing", "Bool", 1)]` | 0.42 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "ComplexF64", 0)]` | 0.42 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "ComplexF64", 1)]` | 0.41 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Float32", 0)]` | 0.42 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum", "Float32", 0)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum", "Int64", 0)]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Int64", 1)]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "keys", "Union{Missing, Float64}", 1)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Missing, Bool}", 1)]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Missing, Int64}", 1)]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Union{Missing, Float32}", 1)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "sum", "Union{Missing, Float64}", 1)]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "sum", "Union{Missing, Int64}", 1)]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.10.0-DEV.1240
Commit 2cad2a771b (2023-05-08 14:22 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3900 MHz     464970 s      50026 s     413524 s   82757633 s          0 s
       #2  3522 MHz    8563035 s      31069 s     460817 s   74804461 s          0 s
       #3  3900 MHz     450925 s      30716 s     328330 s   82995908 s          0 s
       #4  3900 MHz     324719 s      27600 s     305769 s   82969636 s          0 s
  Memory: 31.313323974609375 GB (18125.8515625 MB free)
  Uptime: 8.40700853e6 sec
