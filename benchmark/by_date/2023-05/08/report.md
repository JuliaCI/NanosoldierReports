...
*Commit:* [JuliaLang/julia@5e7d7c3eeb78773f62bdf17267fb59f0d221be9a](https://github.com/JuliaLang/julia/commit/5e7d7c3eeb78773f62bdf17267fb59f0d221be9a)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/c83dff9cd40e5a5c87dc241a10cefc3ddc02c326...5e7d7c3eeb78773f62bdf17267fb59f0d221be9a)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5e7d7c3eeb78773f62bdf17267fb59f0d221be9a#commitcomment-112398084)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-05-08 vs [2023-05-02](../../2023-05/02/report.md)
...
| `["array", "reverse", "rev_load_fast!"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "accessor", "minute"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", ("BitVector", "10-90")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("mul", "Float64", "ComplexF32")]` | 2.80 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("very large", "negative argument", "Float64")]` | 1.68 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sinh", ("very large", "positive argument", "Float64")]` | 1.68 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "manual_example!", "Int32", 2, 64)]` | 1.20 (20%) :x: | 1.00 (1%)  |
...
| `["string", "==(::SubString, ::String)", "different"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "keys", "Union{Missing, Float64}", 1)]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Missing, Int64}", 1)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Nothing, BigInt}", 0)]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.10.0-DEV.1198
Commit 5e7d7c3eeb (2023-05-04 13:15 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3900 MHz     446600 s      50025 s     402607 s   80839198 s          0 s
       #2  3900 MHz    8016350 s      31054 s     445954 s   73412537 s          0 s
       #3  3532 MHz     432948 s      30716 s     323363 s   81065872 s          0 s
       #4  3900 MHz     313448 s      27600 s     301461 s   81038659 s          0 s
  Memory: 31.313323974609375 GB (18431.625 MB free)
  Uptime: 8.21123646e6 sec
