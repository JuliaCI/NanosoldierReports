...
**4818** benchmarks were executed, **124** showed regressions, and **99** showed improvements.
...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/525c655eefa4f6e35d011d8e35c37731179586aa#commitcomment-182180389)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-04-12 vs [2026-04-09](../../2026-04/09/report.md)
...
| `["dates", "string", "DateTime"]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", ("BitVector", "10-90")]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("0 <= abs(x) < 2f-12", "negative argument", "Float32")]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("zero", "Float32")]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["sort", "length = 3", "sort!(rand(Int, length))"]` | 1.41 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 30", "all same"]` | 0.78 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 30", "descending"]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 10000)")]` | 0.16 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 0.41 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 1.42 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 20000)")]` | 2.64 (30%) :x: | 1.00 (1%)  |
| `["string", "==(::SubString, ::String)", "different"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matmat", "(8, 8)", "(8, 8)")]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matvec", "(16, 16)", "(16,)")]` | 1.43 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "ComplexF64", 1)]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz       7490 s          2 s       1808 s     808144 s          0 s  
       #2  3500 MHz     187094 s          1 s       2865 s     628356 s          0 s  
       #3  3500 MHz       7343 s          5 s        784 s     808919 s          0 s  
       #4  3500 MHz       6317 s          1 s        790 s     811243 s          0 s  
  Memory: 31.301368713378906 GB (27764.94140625 MB free)
  Uptime: 819010.69 sec
