...
**4818** benchmarks were executed, **66** showed regressions, and **53** showed improvements.

![Spread of changes](summary.png)

## Job Properties

*Commit:* [JuliaLang/julia@d19eac062f4083e8cb4777323904cb87fab35200](https://github.com/JuliaLang/julia/commit/d19eac062f4083e8cb4777323904cb87fab35200)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/4fdd12e2776419e205b96c3d0a407ba682c9913d...d19eac062f4083e8cb4777323904cb87fab35200)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/d19eac062f4083e8cb4777323904cb87fab35200#commitcomment-183756517)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-04-28 vs [2026-04-26](../../2026-04/26/report.md)
...
| `["dates", "parse", ("DateTime", "DateFormat")]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("x one", "Float64")]` | 0.51 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 4π/4", "negative argument", "Float64")]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tanh", ("0 <= abs(x) < 2.0^-28", "positive argument", "Float64")]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", ("2.0^-28 <= abs(x) < 1.0", "negative argument", "Float64")]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", ("2.0^-28 <= abs(x) < 1.0", "positive argument", "Float64")]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", ("zero", "Float64")]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.02 (20%)  | 1.01 (1%) :x: |
| `["sort", "length = 3", "sort!(fill(missing, length), rev=true)"]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 30", "sort!(fill(missing, length), rev=true)"]` | 0.70 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", ("Tridiagonal", 1000)]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 10000)")]` | 1.96 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 4.65 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 0.27 (30%) :white_check_mark: | 1.00 (1%)  |
| `["string", "==(::SubString, ::String)", "equal"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", ("minimum", "(4, 4)")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.2086
Commit d19eac062f (2026-04-27 23:07 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz      32107 s         15 s       7512 s    2221551 s          0 s  
       #2  3501 MHz     340095 s          5 s       6724 s    1918552 s          0 s  
       #3  3500 MHz      16704 s          6 s       2189 s    2240735 s          0 s  
       #4  3501 MHz      14921 s          3 s       2380 s    2248033 s          0 s  
  Memory: 31.301368713378906 GB (27223.08203125 MB free)
  Uptime: 2.26747632e6 sec
