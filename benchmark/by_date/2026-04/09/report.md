...
**4818** benchmarks were executed, **278** showed regressions, and **123** showed improvements.
...
*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/4e3dc4ee59cc5f9383bc707f1ad3d1b4db28ce48...525c655eefa4f6e35d011d8e35c37731179586aa)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/525c655eefa4f6e35d011d8e35c37731179586aa#commitcomment-181917701)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-04-09 vs [2026-04-02](../../2026-04/02/report.md)
...
| `["array", "cat", ("catnd", 5)]` | 0.86 (5%) :white_check_mark: | 0.93 (1%) :white_check_mark: |
| `["array", "cat", ("catnd_setind", 5)]` | 0.51 (5%) :white_check_mark: | 0.89 (1%) :white_check_mark: |
| `["array", "cat", ("hvcat", 5)]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", ("sumvector", "SubArray{Float32, 2, Array{Float32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 1.55 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumvector", "SubArray{Float32, 2, BaseBenchmarks.ArrayBenchmarks.ArrayLS{Float32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, false}")]` | 1.60 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumvector", "SubArray{Int32, 2, Array{Int32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 1.64 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumvector", "SubArray{Int32, 2, BaseBenchmarks.ArrayBenchmarks.ArrayLS{Int32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, false}")]` | 1.67 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "initialization", ("Vector", "Int", "iterator")]` | 1.50 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", ("BitSet", "Int", "iterate second")]` | 1.38 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("BitSet", "Int", "last")]` | 1.39 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("Vector", "Int", "getindex")]` | 1.30 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findall", ("BitVector", "10-90")]` | 1.65 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.11 (5%) :x: | 1.07 (1%) :x: |
| `["inference", "abstract interpretation", "REPL.REPLCompletions.completions"]` | 1.09 (5%) :x: | 1.06 (1%) :x: |
| `["inference", "abstract interpretation", "broadcasting"]` | 1.08 (5%) :x: | 1.04 (1%) :x: |
| `["inference", "abstract interpretation", "many_const_calls"]` | 1.03 (5%)  | 1.06 (1%) :x: |
| `["inference", "abstract interpretation", "many_invoke_calls"]` | 1.06 (5%) :x: | 1.04 (1%) :x: |
| `["inference", "abstract interpretation", "many_local_vars"]` | 1.20 (5%) :x: | 1.09 (1%) :x: |
| `["inference", "abstract interpretation", "many_method_matches"]` | 1.08 (5%) :x: | 1.06 (1%) :x: |
| `["inference", "abstract interpretation", "many_opaque_closures"]` | 1.07 (5%) :x: | 1.06 (1%) :x: |
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 1.09 (5%) :x: | 1.04 (1%) :x: |
| `["inference", "abstract interpretation", "rand(Float64)"]` | 1.08 (5%) :x: | 1.04 (1%) :x: |
| `["inference", "abstract interpretation", "sin(42)"]` | 1.07 (5%) :x: | 1.04 (1%) :x: |
...
| `["inference", "allinference", "many_local_vars"]` | 1.07 (5%) :x: | 1.03 (1%) :x: |
...
| `["io", "array_limit", ("display", "Matrix{Float64}(100000000, 1)")]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", ("display", "Vector{Float64}(100000000,)")]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", ("sqrt", "typename(UnitUpperTriangular)", 1024)]` | 0.46 (45%) :white_check_mark: | 1.00 (1%)  |
| `["linalg", "small exp #29116"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["micro", "printfd"]` | 1.29 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("x zero", "y negative", "Float64")]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", ("x zero", "y positive", "Float32")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("x zero", "y positive", "Float64")]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", ("2pow127", "negative argument", "Float32")]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 2π/4", "negative argument", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 4π/4", "negative argument", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 6π/4", "negative argument", "Float64")]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 6π/4", "positive argument", "Float64")]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 8π/4", "negative argument", "Float64")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 8π/4", "positive argument", "Float64")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "two_reductions", "Int32", 3, 32)]` | 1.23 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "two_reductions", "Float32", 4, 63)]` | 1.38 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "sort(rand(10^8))"]` | 1.26 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "sortperm(rand(10^7))"]` | 0.46 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 3", "sort!(rand(2n, 2n, n); dims=1)"]` | 1.23 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 30", "all same"]` | 1.36 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 30", "descending"]` | 1.33 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "sparse matvec", "adjoint"]` | 0.58 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse matvec", "non-adjoint"]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (default), matrix rhs"]` | 10.84 (5%) :x: | 0.86 (1%) :white_check_mark: |
| `["sparse", "sparse solves", "least squares (default), vector rhs"]` | 6.07 (5%) :x: | 0.86 (1%) :white_check_mark: |
| `["sparse", "sparse solves", "least squares (qr), matrix rhs"]` | 10.81 (5%) :x: | 0.86 (1%) :white_check_mark: |
| `["sparse", "sparse solves", "least squares (qr), vector rhs"]` | 6.10 (5%) :x: | 0.86 (1%) :white_check_mark: |
...
| `["tuple", "index", ("sumelt", "NTuple", 3, "Float64")]` | 0.58 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countnothing", "BigInt", 0)]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "BigInt", 1)]` | 1.13 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_simplecopy", "BigFloat", 0)]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum", "Bool", 1)]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "Bool", 1)]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "filter", "Union{Missing, BigInt}", 1)]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "keys", "Union{Nothing, Float32}", 0)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz       6308 s          1 s       1402 s     581265 s          0 s  
       #2  3500 MHz     164475 s          0 s       2288 s     422882 s          0 s  
       #3  3500 MHz       5979 s          3 s        531 s     582586 s          0 s  
       #4  3500 MHz       5165 s          1 s        465 s     584080 s          0 s  
  Memory: 31.301368713378906 GB (27751.765625 MB free)
  Uptime: 590071.3 sec
