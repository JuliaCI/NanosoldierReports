...
**4818** benchmarks were executed, **96** showed regressions, and **136** showed improvements.
...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/525c655eefa4f6e35d011d8e35c37731179586aa#commitcomment-182543310)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-04-15 vs [2026-04-12](../../2026-04/12/report.md)
...
| `["dates", "string", "DateTime"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findall", ("ispos", "Vector{Float64}")]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "iterators", "zip(1:1, 1:1, 1:1, 1:1)"]` | 1.29 (5%) :x: | 1.00 (1%)  |
| `["problem", "simplex", "simplex"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y finite", "y positive", "x infinite", "x positive", "Float64")]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y zero", "y positive", "x negative", "Float32")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "revcomp"]` | 1.49 (25%) :x: | 1.00 (1%)  |
| `["simd", ("Cartesian", "axpy!", "Int64", 2, 31)]` | 1.24 (20%) :x: | 1.00 (1%)  |
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 2, 32)]` | 0.72 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Linear", "auto_axpy!", "Float32", 4096)]` | 0.80 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Linear", "axpy!", "Float32", 4096)]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Linear", "conditional_loop!_aliased", "Int64", 4096)]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Linear", "two_reductions", "Float64", 4095)]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.00 (20%)  | 1.02 (1%) :x: |
| `["sort", "length = 10", "all same"]` | 0.70 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 10", "descending"]` | 0.78 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 10", "sort!(rand(Int, length))"]` | 0.78 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 3", "descending"]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 3", "sort!(rand(Int, length))"]` | 0.61 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 0.32 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matmat", "(8, 8)", "(8, 8)")]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("collect", "filter", "ComplexF64", 0)]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countnothing", "BigFloat", 0)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_simplecopy", "Float64", 1)]` | 1.13 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_simplecopy", "Int64", 0)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_simplecopy", "Int8", 1)]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Bool", 0)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Bool", 1)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Int8", 0)]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Int8", 1)]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum2", "Bool", 1)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum2", "Int8", 0)]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum2", "Int8", 1)]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum4", "Bool", 0)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum4", "Bool", 1)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum4", "ComplexF64", 1)]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum4", "Int8", 0)]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum4", "Int8", 1)]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz      18634 s          6 s       4029 s    1128339 s          0 s  
       #2  3500 MHz     246500 s          1 s       3677 s     903264 s          0 s  
       #3  3500 MHz       9133 s          5 s        851 s    1141218 s          0 s  
       #4  3500 MHz       7620 s          1 s        853 s    1145017 s          0 s  
  Memory: 31.301368713378906 GB (27795.75390625 MB free)
  Uptime: 1.15422386e6 sec
