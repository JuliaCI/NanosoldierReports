...
*Commit:* [JuliaLang/julia@6691a755c3a5a9941c16df03142fed98f81eb1af](https://github.com/JuliaLang/julia/commit/6691a755c3a5a9941c16df03142fed98f81eb1af)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/0f56da8988366dd60e170932eefca4adb890acff...6691a755c3a5a9941c16df03142fed98f81eb1af)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/6691a755c3a5a9941c16df03142fed98f81eb1af#commitcomment-122434385)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-07-23 vs [2023-07-20](../../2023-07/20/report.md)
...
| `["collection", "optimizations", ("Set", "concrete", "Nothing")]` | 1.81 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findnext", ("BitVector", "10-90")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int64", 3, 31)]` | 0.76 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 2, 31)]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int64", 2, 32)]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse matvec", "adjoint"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (default), matrix rhs"]` | 0.11 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (default), vector rhs"]` | 0.19 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (qr), matrix rhs"]` | 0.11 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (qr), vector rhs"]` | 0.19 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(600, 400)")]` | 1.33 (30%) :x: | 1.00 (1%)  |
| `["string", "==(::SubString, ::String)", "different"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["string", "findfirst", "Char"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["string", "join"]` | 2.02 (40%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "eachindex", "Float64", 0)]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "keys", "ComplexF64", 0)]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   800 MHz      38454 s         24 s      23947 s   14754757 s          0 s
       #2   800 MHz    1171207 s         17 s      47364 s   13599452 s          0 s
       #3  3500 MHz      37074 s         15 s      24410 s   14740175 s          0 s
       #4   800 MHz      29066 s         17 s      25512 s   14745415 s          0 s
       #5   900 MHz      28727 s         25 s      28338 s   14697469 s          0 s
       #6  3508 MHz      32216 s         15 s      27487 s   14750202 s          0 s
       #7  2500 MHz      35191 s          4 s      34697 s   14745725 s          0 s
       #8   800 MHz      30360 s          9 s      22385 s   14759723 s          0 s
  Memory: 31.301593780517578 GB (25995.59765625 MB free)
  Uptime: 1.48329192e6 sec
