...
| `["misc", "foldl", "foldl(+, filter(...); init = 0.0)"]` | 3.42 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("0 <= abs(x) < 2^-28", "negative argument", "Float64")]` | 0.58 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Linear", "inner_aliased", "Float32", 4096)]` | 1.41 (20%) :x: | 1.00 (1%)  |
