...
*Commit:* [JuliaLang/julia@88edb11c0318e04129cb464f6d05d227a3d66dd0](https://github.com/JuliaLang/julia/commit/88edb11c0318e04129cb464f6d05d227a3d66dd0)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/76fa18281db20bde90d0534a2b08b092f165df8c...88edb11c0318e04129cb464f6d05d227a3d66dd0)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/88edb11c0318e04129cb464f6d05d227a3d66dd0#commitcomment-66859961)

*Tag Predicate:* `ALL`

*Daily Job:* 2022-02-16 vs [2022-02-13](../../2022-02/13/report.md)
...
| `["collection", "deletion", ("Set", "Int", "filter!")]` | 0.56 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "deletion", ("Vector", "Any", "pop!")]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "deletion", ("Vector", "String", "pop!")]` | 0.75 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "optimizations", ("Set", "concrete", "Nothing")]` | 1.37 (25%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "domsort_ssa!"]` | 1.06 (5%) :x: | 0.99 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 1.05 (5%)  | 0.97 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "rand(Float64)"]` | 0.99 (5%)  | 0.99 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "sin(42)"]` | 0.95 (5%)  | 0.91 (1%) :white_check_mark: |
| `["inference", "abstract_call_gf_by_type"]` | 1.08 (5%) :x: | 1.04 (1%) :x: |
| `["inference", "construct_ssa!"]` | 0.98 (5%)  | 0.97 (1%) :white_check_mark: |
| `["inference", "domsort_ssa!"]` | 0.97 (5%)  | 0.96 (1%) :white_check_mark: |
| `["inference", "optimization", "abstract_call_gf_by_type"]` | 1.30 (5%) :x: | 1.38 (1%) :x: |
| `["inference", "optimization", "construct_ssa!"]` | 0.99 (5%)  | 0.98 (1%) :white_check_mark: |
| `["inference", "optimization", "domsort_ssa!"]` | 0.92 (5%) :white_check_mark: | 0.99 (1%)  |
| `["inference", "optimization", "println(::QuoteNode)"]` | 0.89 (5%) :white_check_mark: | 0.92 (1%) :white_check_mark: |
| `["inference", "optimization", "sin(42)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["inference", "println(::QuoteNode)"]` | 0.96 (5%)  | 0.94 (1%) :white_check_mark: |
...
| `["scalar", "arithmetic", ("div", "ComplexF32", "ComplexF32")]` | 0.41 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("div", "Int64", "ComplexF32")]` | 0.36 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 4π/4", "negative argument", "Float32")]` | 1.57 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 4π/4", "negative argument", "Float64")]` | 1.54 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 4π/4", "positive argument", "Float32")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 5π/4", "negative argument", "Float32")]` | 1.57 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 5π/4", "negative argument", "Float64")]` | 1.54 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 4π/4", "negative argument", "Float64")]` | 1.54 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float32")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float64")]` | 1.54 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_simplecopy", "Int64", 0)]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 88edb11c03 (2022-02-15 04:15 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3591 MHz     134768 s        286 s      25316 s   29787060 s          0 s
       #2  3551 MHz    2940636 s        353 s     121171 s   26906148 s          0 s
       #3  3554 MHz     124862 s        250 s      19564 s   29816671 s          0 s
       #4  3621 MHz      90847 s        328 s      18897 s   29705976 s          0 s
  Memory: 31.32097625732422 GB (10420.71875 MB free)
  Uptime: 2.99920045e6 sec
