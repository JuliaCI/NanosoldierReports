...
*Commit:* [JuliaLang/julia@0eec0317b1991c477b87d1760233bed1043e052d](https://github.com/JuliaLang/julia/commit/0eec0317b1991c477b87d1760233bed1043e052d)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/1f111e1326a8de32264171c07c7007595a063524...0eec0317b1991c477b87d1760233bed1043e052d)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/0eec0317b1991c477b87d1760233bed1043e052d#commitcomment-137887939)

*Tag Predicate:* `ALL`

*Daily Job:* 2024-01-26 vs [2024-01-21](../../2024-01/21/report.md)
...
| `["array", "index", ("sumlogical", "SubArray{Int32, 2, Base.ReshapedArray{Int32, 2, SubArray{Int32, 3, Array{Int32, 3}, Tuple{Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}, Tuple{}}, Tuple{Base.Slice{Base.OneTo{Int64}}, UnitRange{Int64}}, true}")]` | 1.69 (50%) :x: | 1.00 (1%)  |
| `["array", "subarray", ("lucompletepivCopy!", 1000)]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", ("lucompletepivCopy!", 500)]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (10, "scal_tup")]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "initialization", ("Dict", "Int", "iterator")]` | 0.99 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "initialization", ("Dict", "Int", "loop", "sizehint!")]` | 0.97 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "initialization", ("Dict", "String", "iterator")]` | 1.00 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "initialization", ("Dict", "String", "loop", "sizehint!")]` | 0.98 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "initialization", ("Set", "Int", "iterator")]` | 1.01 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "initialization", ("Set", "Int", "loop", "sizehint!")]` | 1.00 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "initialization", ("Set", "String", "iterator")]` | 1.03 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "initialization", ("Set", "String", "loop", "sizehint!")]` | 1.02 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "optimizations", ("Dict", "abstract", "Int8")]` | 1.04 (25%)  | 0.92 (1%) :white_check_mark: |
| `["collection", "optimizations", ("Dict", "concrete", "Int8")]` | 0.99 (25%)  | 0.92 (1%) :white_check_mark: |
| `["collection", "optimizations", ("Set", "abstract", "Int8")]` | 1.00 (25%)  | 0.90 (1%) :white_check_mark: |
| `["collection", "optimizations", ("Set", "concrete", "Int8")]` | 1.00 (25%)  | 0.90 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "intersect", "Vector", "Vector")]` | 0.99 (25%)  | 0.88 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "symdiff", "Set", "Set")]` | 0.97 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "symdiff", "Vector")]` | 1.00 (25%)  | 0.98 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "symdiff", "Vector", "Vector")]` | 0.97 (25%)  | 0.96 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "union", "BitSet")]` | 1.00 (25%)  | 0.98 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "union", "BitSet", "BitSet")]` | 1.00 (25%)  | 0.98 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "union", "Set")]` | 0.99 (25%)  | 0.98 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "union", "Set", "Set")]` | 0.99 (25%)  | 0.98 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "union", "Vector")]` | 1.01 (25%)  | 0.98 (1%) :white_check_mark: |
| `["collection", "set operations", ("Set", "Int", "union", "Vector", "Vector")]` | 0.98 (25%)  | 0.98 (1%) :white_check_mark: |
| `["collection", "set operations", ("Vector", "Int", "intersect", "BitSet")]` | 1.01 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "set operations", ("Vector", "Int", "intersect", "BitSet", "BitSet")]` | 0.98 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "set operations", ("Vector", "Int", "intersect", "Set")]` | 1.04 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "set operations", ("Vector", "Int", "intersect", "Set", "Set")]` | 1.03 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "set operations", ("Vector", "Int", "intersect", "Vector")]` | 1.03 (25%)  | 0.98 (1%) :white_check_mark: |
| `["collection", "set operations", ("Vector", "Int", "intersect", "Vector", "Vector")]` | 1.02 (25%)  | 0.97 (1%) :white_check_mark: |
| `["collection", "set operations", ("Vector", "Int", "symdiff", "Vector")]` | 1.02 (25%)  | 0.99 (1%) :white_check_mark: |
| `["collection", "set operations", ("Vector", "Int", "symdiff", "Vector", "Vector")]` | 1.03 (25%)  | 0.98 (1%) :white_check_mark: |
| `["dates", "accessor", "millisecond"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "arithmetic", ("Date", "Day")]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["dates", "arithmetic", ("Date", "Year")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["dates", "string", "Date"]` | 0.42 (5%) :white_check_mark: | 0.60 (1%) :white_check_mark: |
| `["dates", "string", "DateTime"]` | 0.80 (5%) :white_check_mark: | 0.90 (1%) :white_check_mark: |
...
| `["linalg", "arithmetic", ("5-arg mul!", 3)]` | 1.53 (45%) :x: | 1.00 (1%)  |
| `["micro", "parseint"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (large)", "y positive", "x negative", "Float64")]` | 1.72 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "intfuncs", ("#3", "Int64", "+")]` | 1.41 (25%) :x: | 1.00 (1%)  |
| `["scalar", "mod2pi", ("argument reduction (easy) abs(x) < 7π/4", "positive argument", "Float64")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 8π/4", "positive argument", "Float64")]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 2, 63)]` | 1.52 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int32", 2, 63)]` | 1.21 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.00 (20%)  | 0.98 (1%) :white_check_mark: |
| `["string", "==(::AbstractString, ::AbstractString)", "equal"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["string", "==(::SubString, ::String)", "different length"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["string", "==(::SubString, ::String)", "different"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matvec", "(16, 16)", "(16,)")]` | 1.86 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_binaryop", "*", "Bool", "(false, true)")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.11.0-DEV.1376
Commit 0eec0317b1 (2024-01-25 07:58 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   900 MHz     730531 s        233 s     190798 s  175570499 s          0 s
       #2  3484 MHz   14224425 s        197 s     370957 s  161922418 s          0 s
       #3   800 MHz     683457 s        388 s     160939 s  175577440 s          0 s
       #4   800 MHz     566929 s        231 s     170810 s  175598839 s          0 s
       #5   800 MHz     561568 s        136 s     174101 s  175093194 s          0 s
       #6   800 MHz     593406 s        155 s     169121 s  175670190 s          0 s
       #7  2500 MHz     625148 s        148 s     190680 s  175666783 s          0 s
       #8  3500 MHz     601581 s        144 s     155512 s  175726533 s          0 s
  Memory: 31.301593780517578 GB (18955.30078125 MB free)
  Uptime: 1.766513396e7 sec
