...
**4818** benchmarks were executed, **55** showed regressions, and **133** showed improvements.

![Spread of changes](summary.png)

## Job Properties

*Commit:* [JuliaLang/julia@b841d233e9bf6d219b694aaaac8ee8f1b7f8f998](https://github.com/JuliaLang/julia/commit/b841d233e9bf6d219b694aaaac8ee8f1b7f8f998)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/34ef6ce4d9387f095494c2cc5ebe183dd376e34a...b841d233e9bf6d219b694aaaac8ee8f1b7f8f998)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b841d233e9bf6d219b694aaaac8ee8f1b7f8f998#commitcomment-191795927)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-07-09 vs [2026-07-07](../../2026-07/07/report.md)
...
| `["broadcast", "fusion", ("Float64", "(1000000,)", 2)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findall", ("> q0.95", "Vector{UInt8}")]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "repeat", (200, 24, 1)]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", ("0.5 <= abs(x) < 1", "negative argument", "Float32")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acos", ("small", "positive argument", "Float32")]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 0.94 (20%)  | 0.95 (1%) :white_check_mark: |
| `["sort", "issues", "sort(rand(10^8))"]` | 0.80 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "issues", "sortperm(collect(1000000:-1:1))"]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "issues", "sortperm(rand(10^7))"]` | 0.65 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 10", "mixed eltype with by order"]` | 1.22 (20%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", ("Bidiagonal", 10)]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("broadcast", "abs", "BigFloat", 0)]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "abs", "BigFloat", 1)]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("map", "abs", "BigFloat", 0)]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("map", "abs", "BigFloat", 1)]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_binaryop", "*", "BigFloat", "(true, true)")]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum", "BigFloat", 0)]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "BigFloat", 1)]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "BigInt", 1)]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum2", "BigFloat", 0)]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum2", "BigFloat", 1)]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum3", "BigFloat", 0)]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "BigFloat", 0)]` | 0.89 (5%) :white_check_mark: | 1.08 (1%) :x: |
| `["union", "array", ("perf_sum4", "BigFloat", 1)]` | 0.88 (5%) :white_check_mark: | 1.08 (1%) :x: |
| `["union", "array", ("skipmissing", "filter", "Union{Missing, Float64}", 1)]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "BigFloat", 0)]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Missing, BigFloat}", 1)]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Nothing, BigFloat}", 0)]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Nothing, Int64}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "sum", "BigFloat", 0)]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "sum", "Union{Missing, BigFloat}", 1)]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "sum", "Union{Nothing, BigFloat}", 0)]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
Build Info:
  Commit b841d233e9 (2026-07-09 05:24 UTC)
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz (haswell):
       ...
       #1  3500 MHz      86841 s         39 s      23757 s    8301531 s          0 s  
       #2  3500 MHz     894373 s         34 s      27727 s    7499048 s          0 s  
       #3  3500 MHz      66073 s         37 s      11984 s    8317215 s          0 s  
       #4  3500 MHz      69931 s         16 s      13577 s    8337713 s          0 s  
  Memory: 31.301368713378906 GiB (27162.40625 MiB free)
  Uptime: 8.43247493e6 sec
