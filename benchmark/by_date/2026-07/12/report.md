...
**4818** benchmarks were executed, **79** showed regressions, and **103** showed improvements.

![Spread of changes](summary.png)

## Job Properties

*Commit:* [JuliaLang/julia@b1f508aceff4861e4fdc164b8e78e2a20791bec1](https://github.com/JuliaLang/julia/commit/b1f508aceff4861e4fdc164b8e78e2a20791bec1)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/b841d233e9bf6d219b694aaaac8ee8f1b7f8f998...b1f508aceff4861e4fdc164b8e78e2a20791bec1)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b1f508aceff4861e4fdc164b8e78e2a20791bec1#commitcomment-192129192)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-07-12 vs [2026-07-09](../../2026-07/09/report.md)
...
| `["array", "index", ("sumvector", "SubArray{Int32, 2, Array{Int32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 1.74 (50%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "REPL.REPLCompletions.completions"]` | 0.98 (5%)  | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "broadcasting"]` | 0.98 (5%)  | 1.02 (1%) :x: |
...
| `["inference", "abstract interpretation", "many_local_vars"]` | 0.92 (5%) :white_check_mark: | 1.02 (1%) :x: |
| `["inference", "abstract interpretation", "many_method_matches"]` | 0.94 (5%) :white_check_mark: | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "many_opaque_closures"]` | 0.97 (5%)  | 1.01 (1%) :x: |
...
| `["inference", "abstract interpretation", "sin(42)"]` | 0.98 (5%)  | 1.01 (1%) :x: |
| `["inference", "optimization", "many_const_calls"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["linalg", "arithmetic", ("sqrt", "typename(UnitUpperTriangular)", 1024)]` | 1.96 (45%) :x: | 1.00 (1%)  |
| `["linalg", "blas", "gbmv!"]` | 1.49 (40%) :x: | 1.00 (1%)  |
...
| `["misc", "repeat", (200, 24, 1)]` | 3.74 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", ("argument reduction (easy) abs(x) < 2.0^20π/4", "positive argument", "Float64")]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 2π/4", "negative argument", "Float64")]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float64")]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 4π/4", "negative argument", "Float64")]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float64")]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 6π/4", "negative argument", "Float64")]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 6π/4", "positive argument", "Float64")]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 8π/4", "negative argument", "Float64")]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 8π/4", "positive argument", "Float64")]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["sort", "issues", "sortperm(rand(10^7))"]` | 1.50 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 10", "mixed eltype with by order"]` | 0.70 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("adjoint", "(20000, 10000)")]` | 1.35 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 1.49 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "misc", "longtuple"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("collect", "filter", "Float32", 0)]` | 2.22 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "Int64", 1)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "filter", "Union{Nothing, BigInt}", 0)]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.2637
Build Info:
  Commit b1f508acef (2026-07-11 18:37 UTC)
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz (haswell):
       ...
       #1  3500 MHz      88090 s         39 s      24365 s    8558175 s          0 s  
       #2  3500 MHz     908223 s         37 s      28522 s    7743028 s          0 s  
       #3  3500 MHz      67184 s         37 s      12436 s    8573507 s          0 s  
       #4  3500 MHz      71885 s         18 s      14044 s    8593979 s          0 s  
  Memory: 31.301368713378906 GiB (27031.33203125 MiB free)
  Uptime: 8.69153161e6 sec
