...
*Commit:* [JuliaLang/julia@5e8f8a9b987a71ea918591272d937c77b2c1b503](https://github.com/JuliaLang/julia/commit/5e8f8a9b987a71ea918591272d937c77b2c1b503)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/b44a95bca7239efc02df421ed4af0b733b97e617...5e8f8a9b987a71ea918591272d937c77b2c1b503)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5e8f8a9b987a71ea918591272d937c77b2c1b503#commitcomment-128916946)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-10-02 vs [2023-09-28](../../2023-09/28/report.md)
...
| `["collection", "iteration", ("IdDict", "Int", "iterate second")]` | 1.65 (25%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "two_reductions", "Int64", 2, 64)]` | 1.39 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "two_reductions", "Float64", 4, 63)]` | 1.21 (20%) :x: | 1.00 (1%)  |
| `["simd", ("Linear", "loop_fields!", "Float32", "BaseBenchmarks.SIMDBenchmarks.MutableFields", 4095)]` | 0.78 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "index", ("spvec", "integer", 10000)]` | 1.59 (30%) :x: | 1.00 (1%)  |
| `["string", "==(::AbstractString, ::AbstractString)", "identical"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["string", "==(::SubString, ::String)", "equal"]` | 1.48 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_simplecopy", "Float64", 1)]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum3", "Int8", 1)]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "eachindex", "BigFloat", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "BigInt", 0)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Int64", 0)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "eachindex", "Union{Nothing, BigFloat}", 0)]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "keys", "Union{Nothing, BigFloat}", 0)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.11.0-DEV.561
Commit 5e8f8a9b98 (2023-09-27 15:17 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   800 MHz     261124 s         95 s     137168 s   75665541 s          0 s
       #2   800 MHz    6885441 s        112 s     222532 s   68969282 s          0 s
       #3  3508 MHz     260743 s         89 s     121545 s   75594984 s          0 s
       #4   800 MHz     211337 s         97 s     134235 s   75626510 s          0 s
       #5   800 MHz     202964 s         68 s     136722 s   75387941 s          0 s
       #6   900 MHz     219910 s         79 s     131985 s   75681998 s          0 s
       #7   800 MHz     235981 s         36 s     152415 s   75670025 s          0 s
       #8  2500 MHz     216821 s         66 s     117080 s   75725273 s          0 s
  Memory: 31.301593780517578 GB (21854.734375 MB free)
  Uptime: 7.61544245e6 sec
