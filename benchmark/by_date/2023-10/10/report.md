...
*Commit:* [JuliaLang/julia@651aef941efedd2efbc816ca277832ca75ea81f6](https://github.com/JuliaLang/julia/commit/651aef941efedd2efbc816ca277832ca75ea81f6)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/5488b8139f3d6ca784b9f837049f815cfcb78be5...651aef941efedd2efbc816ca277832ca75ea81f6)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/651aef941efedd2efbc816ca277832ca75ea81f6#commitcomment-129633729)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-10-10 vs [2023-10-06](../../2023-10/06/report.md)
...
| `["array", "cat", ("hvcat", 5)]` | 1.45 (5%) :x: | 1.00 (1%)  |
| `["array", "cat", ("hvcat_setind", 5)]` | 1.52 (5%) :x: | 1.00 (1%)  |
...
| `["array", "index", ("sumcartesian", "SubArray{Int32, 2, BaseBenchmarks.ArrayBenchmarks.ArrayLS{Int32, 2}, Tuple{Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, false}")]` | 0.18 (50%) :white_check_mark: | 1.00 (1%)  |
| `["array", "index", ("sumcartesian", "SubArray{Int32, 2, Matrix{Int32}, Tuple{Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 0.18 (50%) :white_check_mark: | 1.00 (1%)  |
| `["array", "index", ("sumcartesian", "SubArray{Int32, 2, Matrix{Int32}, Tuple{UnitRange{Int64}, UnitRange{Int64}}, false}")]` | 0.18 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", ("sumeach", "SubArray{Int32, 2, Matrix{Int32}, Tuple{UnitRange{Int64}, UnitRange{Int64}}, false}")]` | 0.18 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "set operations", ("BitSet", "Int", "==", "self")]` | 2.62 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "⊆", "Set")]` | 1.95 (25%) :x: | 1.00 (1%)  |
...
| `["micro", "parseint"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "julia", ("parse", "nested")]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "Complex{UInt64}", "Complex{UInt64}")]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("very large", "negative argument", "Float64")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", ("2pow127", "positive argument", "Float32")]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 8π/4", "negative argument", "Float64")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "positive argument", "Float64")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 2.0^20π/4", "negative argument", "Float64", "sin_kernel")]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", ("2.0^-28 <= abs(x) < 1.0", "negative argument", "Float64")]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 2, 31)]` | 0.69 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "conditional_loop!", "Int64", 2, 32)]` | 0.66 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int64", 3, 32)]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int64", 4, 31)]` | 0.74 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "index", ("sumelt", "NTuple", 8, "Float64")]` | 1.41 (40%) :x: | 1.00 (1%)  |
| `["tuple", "index", ("sumelt", "TupleWrapper", 3, "Float64")]` | 1.86 (40%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", ("minimum", "(16,)")]` | 2.58 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", ("minimum", "(4,)")]` | 1.88 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", ("minimum", "(8, 8)")]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", ("sum", "(2,)")]` | 2.14 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "eachindex", "Bool", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "eachindex", "Int64", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Int8", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Missing, BigInt}", 1)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Missing, Bool}", 1)]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Missing, ComplexF64}", 1)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "eachindex", "Union{Nothing, Bool}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Nothing, ComplexF64}", 0)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Nothing, Float32}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Nothing, Float64}", 0)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Nothing, Int64}", 0)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Nothing, Int8}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "keys", "Bool", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "keys", "Float64", 0)]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "keys", "Int64", 0)]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "keys", "Int8", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "keys", "Union{Nothing, BigFloat}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "keys", "Union{Nothing, BigInt}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "keys", "Union{Nothing, Bool}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "keys", "Union{Nothing, ComplexF64}", 0)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "keys", "Union{Nothing, Float32}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "keys", "Union{Nothing, Float64}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.11.0-DEV.630
Commit 651aef941e (2023-10-10 12:38 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   900 MHz     287708 s        106 s     141539 s   82568289 s          0 s
       #2  3502 MHz    7562839 s        112 s     236524 s   75212819 s          0 s
       #3  2500 MHz     283651 s         94 s     125599 s   82502011 s          0 s
       #4   800 MHz     231242 s        112 s     138143 s   82531858 s          0 s
       #5   800 MHz     222167 s         74 s     142569 s   82269005 s          0 s
       #6   800 MHz     240187 s        100 s     137299 s   82588129 s          0 s
       #7   800 MHz     256132 s         41 s     157724 s   82577685 s          0 s
       #8   800 MHz     240999 s         72 s     121434 s   82630746 s          0 s
  Memory: 31.301593780517578 GB (22756.33984375 MB free)
  Uptime: 8.30938258e6 sec
