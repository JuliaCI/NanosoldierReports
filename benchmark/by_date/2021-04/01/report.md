...
*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/40267bb03d9a6fa3406d84ed3a932e1f55b3cb4d...13caa8abf2320ea7e6f7255adf3477cbd6096e87)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/13caa8abf2320ea7e6f7255adf3477cbd6096e87#commitcomment-48969684)

*Tag Predicate:* `ALL`

*Daily Job:* 2021-04-01 vs [2021-03-31](../../2021-03/31/report.md)
...
| `["array", "comprehension", ("collect", "Vector{Float64}")]` | 3.34 (5%) :x: | 1.00 (1%)  |
...
| `["array", "comprehension", ("comprehension_indexing", "Vector{Float64}")]` | 1.75 (30%) :x: | 1.00 (1%)  |
...
| `["array", "comprehension", ("comprehension_iteration", "Vector{Float64}")]` | 1.78 (5%) :x: | 1.00 (1%)  |
...
| `["broadcast", "mix_scalar_tuple", (10, "tup_tup")]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", ("Set", "Any", "pop!", "unspecified")]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", ("Vector", "Any", "getindex")]` | 1.39 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "⊆", "self")]` | 1.27 (25%) :x: | 1.00 (1%)  |
...
| `["misc", "18129"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "23042", "ComplexF64"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acosh", ("very large", "positive argument", "Float64")]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", ("0.5 <= abs(x) < 0.975", "negative argument", "Float64")]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", ("0.975 <= abs(x) < 1.0", "negative argument", "Float64")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("2 <= abs(x) < 2^28", "negative argument", "Float32")]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("2^-28 <= abs(x) < 2", "negative argument", "Float32")]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", ("2^-28 <= abs(x) < 2", "positive argument", "Float32")]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", ("39/16 <= abs(x) < 2^66", "positive argument", "Float64")]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) high", "y positive", "x positive", "Float64")]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 6π/4", "positive argument", "Float32", "cos_kernel")]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 7π/4", "positive argument", "Float32", "sin_kernel")]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 4π/4", "positive argument", "Float32")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", ("A_mul_Bc!", "sparse 200x200, dense 200x200 -> dense 200x200")]` | 1.30 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", ("A_mul_Bc", "sparse 500x500, dense 5x500 -> dense 500x5")]` | 1.46 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("map", "identity", "ComplexF64", 1)]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countnothing", "Bool", 1)]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "ComplexF64", 0)]` | 1.70 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Float32", 0)]` | 1.70 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Float64", 0)]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Int64", 1)]` | 1.70 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("sort", "Int64", 0)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8124M CPU @ 3.00GHz: 
       ...
       #1  3414 MHz     169250 s       1322 s      23951 s   32094783 s          0 s
       #2  3402 MHz    5433238 s        254 s     174574 s   26683307 s          0 s
       #3  3404 MHz      79642 s        217 s       5151 s   32207176 s          0 s
       #4  3419 MHz      88778 s        213 s       4922 s   32197440 s          0 s
       #5  3402 MHz      51669 s        226 s       4966 s   32208380 s          0 s
       #6  3417 MHz      71352 s        254 s       4681 s   32215856 s          0 s
       #7  3411 MHz      71726 s        139 s       5271 s   32215080 s          0 s
       #8  3419 MHz      61956 s        205 s       4577 s   32221932 s          0 s
       
  Memory: 30.362831115722656 GB (17093.56640625 MB free)
  Uptime: 3.229325e6 sec
