...
*Commit:* [JuliaLang/julia@117ef2e6911339a6eed8a6209853f59518f9bc24](https://github.com/JuliaLang/julia/commit/117ef2e6911339a6eed8a6209853f59518f9bc24)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/881e08bcff7fad1a662d07f0b5b13ba3d6fd2581...117ef2e6911339a6eed8a6209853f59518f9bc24)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/117ef2e6911339a6eed8a6209853f59518f9bc24#commitcomment-124156912)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-08-10 vs [2023-08-08](../../2023-08/08/report.md)
...
|----|------------|--------------|
| `["array", "accumulate", ("accumulate", "Float64")]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "accumulate", ("cumsum", "Float64")]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "optimizations", ("Vector", "concrete", "Nothing")]` | 0.24 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "allinference", "broadcasting"]` | 0.95 (5%)  | 0.98 (1%) :white_check_mark: |
| `["inference", "allinference", "many_const_calls"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "allinference", "many_invoke_calls"]` | 0.90 (5%) :white_check_mark: | 0.99 (1%)  |
| `["inference", "allinference", "many_method_matches"]` | 0.95 (5%)  | 0.98 (1%) :white_check_mark: |
| `["inference", "allinference", "rand(Float64)"]` | 0.95 (5%) :white_check_mark: | 0.99 (1%)  |
| `["inference", "allinference", "sin(42)"]` | 0.94 (5%) :white_check_mark: | 0.99 (1%)  |
| `["inference", "optimization", "REPL.REPLCompletions.completions"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["inference", "optimization", "broadcasting"]` | 0.94 (5%) :white_check_mark: | 0.99 (1%) :white_check_mark: |
...
| `["random", "ranges", ("RangeGenerator", "Int128", "1:4294967295")]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float32", "sin_kernel")]` | 0.53 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", ("argument reduction (easy) abs(x) > 2.0^20*π/2", "positive argument", "Float64")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "axpy!", "Float64", 3, 64)]` | 0.71 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "axpy!", "Int64", 2, 32)]` | 0.72 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "manual_example!", "Float32", 4, 64)]` | 0.76 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "manual_example!", "Float64", 3, 31)]` | 1.25 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "axpy!", "Float64", 3, 64)]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
