...
*Commit:* [JuliaLang/julia@a712455c99191e65ed4868b34b179b4f9767f255](https://github.com/JuliaLang/julia/commit/a712455c99191e65ed4868b34b179b4f9767f255)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/ff14eafd803558f4c1f9ecdeecc44d3a4caa7343...a712455c99191e65ed4868b34b179b4f9767f255)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/a712455c99191e65ed4868b34b179b4f9767f255#commitcomment-123430117)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-08-02 vs [2023-08-01](../../2023-08/01/report.md)
...
| `["collection", "optimizations", ("Set", "concrete", "Nothing")]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", ("BitSet", "Int", "length")]` | 1.63 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("IdDict", "Int", "in", "false")]` | 1.25 (25%) :x: | 1.00 (1%)  |
...
| `["dates", "parse", "DateTime"]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "optimization", "rand(Float64)"]` | 0.81 (5%) :white_check_mark: | 0.90 (1%) :white_check_mark: |
...
| `["misc", "julia", ("parse", "nested")]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("x one", "Float64")]` | 1.73 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 2, 31)]` | 0.68 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "filter", "Union{Nothing, Int64}", 0)]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Union{Missing, BigInt}", 1)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "BigFloat", 0)]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "Union{Missing, BigFloat}", 1)]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "Union{Nothing, BigFloat}", 0)]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.11.0-DEV.198
Commit a712455c99 (2023-07-31 12:02 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   900 MHz      56845 s         25 s      33663 s   23374074 s          0 s
       #2  3509 MHz    1898755 s         40 s      69116 s   21498275 s          0 s
       #3  2500 MHz      53819 s         58 s      34247 s   23352828 s          0 s
       #4   800 MHz      43423 s         19 s      37116 s   23356830 s          0 s
       #5   800 MHz      42334 s         35 s      39794 s   23277360 s          0 s
       #6   800 MHz      45952 s         41 s      37953 s   23368998 s          0 s
       #7   800 MHz      50501 s          5 s      47704 s   23363578 s          0 s
       #8   800 MHz      43434 s         21 s      32044 s   23384069 s          0 s
  Memory: 31.301593780517578 GB (25070.88671875 MB free)
  Uptime: 2.34889638e6 sec
