...
*Commit:* [JuliaLang/julia@3c64bc3dbeb5161a27f7df33c2e3ee3df1c32e5a](https://github.com/JuliaLang/julia/commit/3c64bc3dbeb5161a27f7df33c2e3ee3df1c32e5a)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/a712455c99191e65ed4868b34b179b4f9767f255...3c64bc3dbeb5161a27f7df33c2e3ee3df1c32e5a)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3c64bc3dbeb5161a27f7df33c2e3ee3df1c32e5a#commitcomment-123876047)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-08-07 vs [2023-08-02](../../2023-08/02/report.md)
...
| `["array", "cat", ("catnd", 5)]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "optimizations", ("Vector", "concrete", "Nothing")]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("BitSet", "Int", "length")]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "symdiff", "BitSet", "BitSet")]` | 1.38 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "symdiff", "Set", "Set")]` | 1.81 (25%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "many_const_calls"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "optimization", "many_method_matches"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "julia", ("parse", "nested")]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "Complex{UInt64}", "Complex{UInt64}")]` | 1.41 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float64", "cos_kernel")]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "positive argument", "Float32", "sin_kernel")]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "positive argument", "Float64", "cos_kernel")]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Linear", "inner_aliased", "Float32", 4096)]` | 1.24 (20%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_simplecopy", "Bool", 1)]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum2", "BigInt", 1)]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "filter", "Union{Nothing, Int64}", 0)]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   800 MHz      83830 s         26 s      39867 s   27954677 s          0 s
       #2   800 MHz    2345408 s         56 s      80857 s   25654157 s          0 s
       #3   800 MHz      80199 s         63 s      40293 s   27930081 s          0 s
       #4   800 MHz      68557 s         27 s      43588 s   27933715 s          0 s
       #5   800 MHz      64728 s         36 s      46766 s   27840435 s          0 s
       #6   800 MHz      69079 s         42 s      43480 s   27951925 s          0 s
       #7   800 MHz      74843 s         17 s      54976 s   27945155 s          0 s
       #8  3511 MHz      70818 s         23 s      38113 s   27964259 s          0 s
  Memory: 31.301593780517578 GB (24891.43359375 MB free)
  Uptime: 2.81072591e6 sec
