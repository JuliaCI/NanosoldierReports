...
*Commit:* [JuliaLang/julia@3e4b38684e38a015446253f5752ee9cf840f50cc](https://github.com/JuliaLang/julia/commit/3e4b38684e38a015446253f5752ee9cf840f50cc)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/c30d45dfdf63c83eb864ebe924a715fe283013b4...3e4b38684e38a015446253f5752ee9cf840f50cc)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3e4b38684e38a015446253f5752ee9cf840f50cc#commitcomment-134263029)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-12-05 vs [2023-11-30](../../2023-11/30/report.md)
...
| `["find", "findprev", ("ispos", "Vector{UInt64}")]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "iterators", "zip(1:1, 1:1, 1:1, 1:1)"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "julia", ("parse", "array")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "julia", ("parse", "function")]` | 0.60 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "julia", ("parse", "nested")]` | 0.53 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) high", "y positive", "x negative", "Float32")]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 3π/4", "positive argument", "Float32", "sin_kernel")]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", ("large", "negative argument", "Float64")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "Float64", 1)]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Int64", 0)]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Int64", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 3e4b38684e (2023-12-03 04:15 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   800 MHz     614516 s        166 s     171815 s  130647826 s          0 s
       #2  3500 MHz   11740428 s        169 s     316350 s  119401167 s          0 s
       #3  2500 MHz     577405 s        150 s     146639 s  130635248 s          0 s
       #4   800 MHz     476321 s        181 s     157636 s  130676543 s          0 s
       #5  1600 MHz     471847 s         96 s     161959 s  130281374 s          0 s
       #6   800 MHz     496876 s        127 s     156523 s  130737236 s          0 s
       #7   800 MHz     527364 s         90 s     177598 s  130723831 s          0 s
       #8   800 MHz     508342 s         96 s     141966 s  130780492 s          0 s
  Memory: 31.301593780517578 GB (19285.546875 MB free)
  Uptime: 1.315656637e7 sec
