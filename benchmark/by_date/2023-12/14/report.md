...
*Commit:* [JuliaLang/julia@d90fa45c6ac5da8398e6864128579df48edbf00c](https://github.com/JuliaLang/julia/commit/d90fa45c6ac5da8398e6864128579df48edbf00c)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/79de5f3caa4b013f089bd668ea7125c3ab9f39f2...d90fa45c6ac5da8398e6864128579df48edbf00c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/d90fa45c6ac5da8398e6864128579df48edbf00c#commitcomment-135016183)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-12-14 vs [2023-12-13](../../2023-12/13/report.md)
...
| `["alloc", "strings"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["array", "accumulate", ("cumsum!", "Int")]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["array", "any/all", ("any", "Vector{Int64} generator")]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "set operations", ("BitSet", "Int", "intersect", "BitSet", "BitSet")]` | 0.79 (25%)  | 0.95 (1%) :white_check_mark: |
| `["collection", "set operations", ("BitSet", "Int", "intersect", "Vector", "Vector")]` | 0.91 (25%)  | 0.99 (1%) :white_check_mark: |
...
| `["find", "findnext", ("ispos", "Vector{Float32}")]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "Float32", "ComplexF64")]` | 0.26 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (large)", "y positive", "x negative", "Float32")]` | 3.05 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int64", 4, 31)]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 2, 63)]` | 1.27 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Float64", 4, 31)]` | 1.38 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int32", 2, 31)]` | 0.62 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(600, 600)")]` | 0.68 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 2.13 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matvec", "(2, 2)", "(2,)")]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.11.0-DEV.1069
Commit d90fa45c6a (2023-12-10 15:45 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   900 MHz     645475 s        187 s     175821 s  138332597 s          0 s
       #2  3516 MHz   12498609 s        173 s     331999 s  126348278 s          0 s
       #3  2500 MHz     604620 s        162 s     149339 s  138326553 s          0 s
       #4   800 MHz     499068 s        182 s     160004 s  138366370 s          0 s
       #5   800 MHz     496228 s         97 s     164307 s  137954308 s          0 s
       #6   800 MHz     522413 s        136 s     158830 s  138427646 s          0 s
       #7   800 MHz     550935 s         95 s     179966 s  138417697 s          0 s
       #8   800 MHz     531936 s         99 s     144414 s  138473902 s          0 s
  Memory: 31.301593780517578 GB (19311.71875 MB free)
  Uptime: 1.392906113e7 sec
