...
*Commit:* [JuliaLang/julia@5c7d24493ebab184d4517ca556314524f4fcb47f](https://github.com/JuliaLang/julia/commit/5c7d24493ebab184d4517ca556314524f4fcb47f)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/144f58b4133ce9f304fc54852ae67366f5fd86b5...5c7d24493ebab184d4517ca556314524f4fcb47f)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5c7d24493ebab184d4517ca556314524f4fcb47f#commitcomment-139624871)

*Tag Predicate:* `ALL`

*Daily Job:* 2024-03-11 vs [2024-03-04](../../2024-03/04/report.md)
...
| `["collection", "set operations", ("empty", "Int", "<", "BitSet")]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.23 (5%) :x: | 1.22 (1%) :x: |
| `["inference", "abstract interpretation", "broadcasting"]` | 1.03 (5%)  | 0.98 (1%) :white_check_mark: |
...
| `["inference", "allinference", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.25 (5%) :x: | 1.23 (1%) :x: |
...
| `["misc", "parse", "Float64"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "acosh", ("very large", "positive argument", "Float64")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("add", "Int64", "Complex{UInt64}")]` | 2.08 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("div", "Complex{UInt64}", "Complex{UInt64}")]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", ("0.5 <= abs(x) < 0.975", "negative argument", "Float32")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", ("one", "negative argument", "Float32")]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float64", "cos_kernel")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 4π/4", "negative argument", "Float64", "sin_kernel")]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float64", "sin_kernel")]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 6π/4", "negative argument", "Float64", "cos_kernel")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 6π/4", "positive argument", "Float64", "cos_kernel")]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 8π/4", "negative argument", "Float64", "sin_kernel")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 8π/4", "positive argument", "Float64", "sin_kernel")]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "axpy!", "Int64", 2, 63)]` | 1.20 (20%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "manual_example!", "Float32", 2, 64)]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "manual_example!", "Float32", 2, 64)]` | 0.74 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("collect", "all", "BigInt", 0)]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("map", "identity", "BigInt", 0)]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "identity", "Float32", 0)]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
Commit 5c7d24493e (2024-03-09 22:22 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz     954074 s        458 s     233471 s  213715388 s          0 s
       #2  3500 MHz   15168786 s        232 s     392824 s  199449774 s          0 s
       #3  3501 MHz     741239 s        402 s     169543 s  214009438 s          0 s
       #4  3500 MHz     612645 s        269 s     178427 s  214013222 s          0 s
       #5  3501 MHz     604617 s        201 s     181332 s  213347933 s          0 s
       #6  3504 MHz     637163 s        198 s     176707 s  214102688 s          0 s
       #7  3502 MHz     671161 s        181 s     198519 s  214106042 s          0 s
       #8  3505 MHz     656457 s        154 s     164085 s  214153022 s          0 s
  Memory: 31.301593780517578 GB (18633.62109375 MB free)
  Uptime: 2.151659074e7 sec
