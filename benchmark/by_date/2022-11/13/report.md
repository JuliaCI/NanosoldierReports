...
*Commit:* [JuliaLang/julia@3510eeb4c99b6daa42a27d0f7d96be8af21067ac](https://github.com/JuliaLang/julia/commit/3510eeb4c99b6daa42a27d0f7d96be8af21067ac)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/5a323a6a99728fb03a5c37a4029dd529b5013495...3510eeb4c99b6daa42a27d0f7d96be8af21067ac)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3510eeb4c99b6daa42a27d0f7d96be8af21067ac#commitcomment-89804655)

*Tag Predicate:* `ALL`

*Daily Job:* 2022-11-13 vs [2022-11-10](../../2022-11/10/report.md)
...
|----|------------|--------------|
| `["array", "cat", ("catnd", 5)]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", ("sumcolon_view", "1.0:0.00010001000100010001:2.0")]` | 2.01 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumcolon_view", "1.0:1.0:100000.0")]` | 1.99 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumeach", "Base.ReinterpretArray{BaseBenchmarks.ArrayBenchmarks.PairVals{Int32}, 2, Int32, Matrix{Int32}, false}")]` | 1.67 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumlinear", "Base.ReinterpretArray{BaseBenchmarks.ArrayBenchmarks.PairVals{Int32}, 2, Int32, Matrix{Int32}, false}")]` | 1.67 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumrange_view", "1.0:0.00010001000100010001:2.0")]` | 2.15 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumrange_view", "1.0:1.0:100000.0")]` | 2.15 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "deletion", ("Set", "Any", "filter!")]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "optimizations", ("Set", "concrete", "Nothing")]` | 0.56 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "abstract_call_gf_by_type"]` | 0.83 (5%) :white_check_mark: | 0.94 (1%) :white_check_mark: |
...
| `["inference", "allinference", "abstract_call_gf_by_type"]` | 0.91 (5%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
...
| `["inference", "optimization", "abstract_call_gf_by_type"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "optimization", "construct_ssa!"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "23042", "Float64"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", ("2pow1023", "positive argument", "Float64")]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "positive argument", "Float32", "cos_kernel")]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["shootout", "fasta"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["shootout", "meteor_contest"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 3, 31)]` | 1.20 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 2, 31)]` | 1.26 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 4, 31)]` | 1.48 (20%) :x: | 1.00 (1%)  |
...
| `["simd", ("Linear", "sum_reduce", "Int64", 4096)]` | 0.73 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matvec", "(16, 16)", "(16,)")]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum", "Int8", 0)]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Int8", 1)]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum3", "Bool", 0)]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "eachindex", "Union{Missing, Int8}", 1)]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "keys", "Union{Missing, BigInt}", 1)]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Bool", 0)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Int8", 0)]` | 0.51 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.9.0-DEV.1796
Commit 3510eeb4c9 (2022-11-11 16:47 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3523 MHz     241279 s        464 s      53772 s   82905730 s          0 s
       #2  3524 MHz    6397514 s        173 s     189859 s   76667026 s          0 s
       #3  3508 MHz     273429 s        234 s      43055 s   82934185 s          0 s
       #4  3502 MHz     196152 s        268 s      41724 s   82950003 s          0 s
  Memory: 31.320838928222656 GB (16369.55859375 MB free)
  Uptime: 8.33225858e6 sec
