...
*Commit:* [JuliaLang/julia@b60d1db399f94cdf9acbea4078444e7f1fc84ba6](https://github.com/JuliaLang/julia/commit/b60d1db399f94cdf9acbea4078444e7f1fc84ba6)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/065ec06a5fa937ff9748bde2c558f4983b472f13...b60d1db399f94cdf9acbea4078444e7f1fc84ba6)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b60d1db399f94cdf9acbea4078444e7f1fc84ba6#commitcomment-171067684)

*Tag Predicate:* `ALL`

*Daily Job:* 2025-11-21 vs [2025-11-10](../../2025-11/10/report.md)
...
| `["broadcast", "dotop", ("Float64", "(1000000,)", 1)]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["dates", "accessor", "day"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.96 (5%)  | 0.99 (1%) :white_check_mark: |
...
| `["misc", "repeat", (200, 24, 1)]` | 0.31 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y negative", "x negative", "Float32")]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y positive", "x positive", "Float32")]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) small", "y positive", "x positive", "Float32")]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", ("x one", "Float32")]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", ("argument reduction (easy) abs(x) < 6π/4", "negative argument", "Float64")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "mod2pi", ("argument reduction (easy) abs(x) < 6π/4", "positive argument", "Float64")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "mod2pi", ("argument reduction (easy) abs(x) < 7π/4", "negative argument", "Float64")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "mod2pi", ("argument reduction (easy) abs(x) < 7π/4", "positive argument", "Float64")]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", ("argument reduction (hard) abs(x) < 6π/4", "negative argument", "Float64")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", ("no reduction", "positive argument", "Float64")]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "axpy!", "Float64", 3, 32)]` | 0.72 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "manual_example!", "Int64", 4, 32)]` | 1.25 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "two_reductions", "Float64", 4, 31)]` | 1.43 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.01 (20%)  | 0.97 (1%) :white_check_mark: |
| `["sort", "length = 3", "sort!(rand(2n, 2n, n); dims=2)"]` | 0.69 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 3", "sort!(rand(2n, 2n, n); dims=3)"]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", ("IJV", 10)]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 0.51 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "collect", "Int8", 0)]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.50
Commit b60d1db399 (2025-11-08 09:52 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz     511811 s        440 s     196882 s  150692521 s          0 s
       #2  3500 MHz    5186690 s        178 s     150818 s  146226678 s          0 s
       #3  3500 MHz     253475 s        187 s      76061 s  151226142 s          0 s
       #4  3500 MHz     263264 s        242 s      79361 s  151222458 s          0 s
       #5  3502 MHz     232463 s        224 s      90049 s  151122712 s          0 s
       #6  3503 MHz     241632 s        106 s      83097 s  150372717 s          0 s
       #7  3504 MHz     271686 s        280 s      83571 s  151047685 s          0 s
       #8  3500 MHz     269531 s        226 s      85983 s  151165302 s          0 s
  Memory: 31.30146026611328 GB (27889.63671875 MB free)
  Uptime: 1.516479784e7 sec
