...
*Commit:* [JuliaLang/julia@893635dc59b9831ce2513471663ba3c244c4d365](https://github.com/JuliaLang/julia/commit/893635dc59b9831ce2513471663ba3c244c4d365)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/1806b0bc31d262ed7181162f6caeb8e8b944ddae...893635dc59b9831ce2513471663ba3c244c4d365)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/893635dc59b9831ce2513471663ba3c244c4d365#commitcomment-172976511)

*Tag Predicate:* `ALL`

*Daily Job:* 2025-12-16 vs [2025-12-12](../../2025-12/12/report.md)
...
| `["broadcast", "mix_scalar_tuple", (5, "scal_tup_x3")]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", ("IdDict", "String", "push!", "overwrite")]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", ("rand", "MersenneTwister", "Int128")]` | 2.07 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "UInt64", "ComplexF32")]` | 2.01 (50%) :x: | 1.00 (1%)  |
...
| `["simd", ("Linear", "two_reductions", "Float64", 4096)]` | 1.29 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.01 (20%)  | 0.98 (1%) :white_check_mark: |
| `["sort", "issues", "sortperm(rand(10^7))"]` | 3.43 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("adjoint", "(20000, 10000)")]` | 11.05 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 14.57 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 2.12 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("collect", "filter", "Int8", 0)]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_binaryop", "*", "Int64", "(true, true)")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Int64", 0)]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.1372
Commit 893635dc59 (2025-12-16 08:28 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz     681603 s        609 s     254760 s  172399464 s          0 s
       #2  3500 MHz    7284995 s        222 s     187359 s  166076572 s          0 s
       #3  3500 MHz     318702 s        196 s      85556 s  173134882 s          0 s
       #4  3501 MHz     329079 s        246 s      88210 s  173132458 s          0 s
       #5  3503 MHz     286428 s        240 s     100901 s  173025488 s          0 s
       #6  3501 MHz     297931 s        142 s      93028 s  172168395 s          0 s
       #7  3503 MHz     338702 s        301 s      93052 s  172940907 s          0 s
       #8  3501 MHz     335796 s        232 s      94990 s  173069577 s          0 s
  Memory: 31.30146026611328 GB (27961.24609375 MB free)
  Uptime: 1.736414578e7 sec
