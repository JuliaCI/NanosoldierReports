...
*Commit:* [JuliaLang/julia@5dcd509b66f372291ee9cb0a6bbdea7e6cf72554](https://github.com/JuliaLang/julia/commit/5dcd509b66f372291ee9cb0a6bbdea7e6cf72554)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/aad72458539946bc7f2b1d1f6092f963fed4bd8c...5dcd509b66f372291ee9cb0a6bbdea7e6cf72554)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5dcd509b66f372291ee9cb0a6bbdea7e6cf72554#commitcomment-141612150)

*Tag Predicate:* `ALL`

*Daily Job:* 2024-05-02 vs [2024-04-22](../../2024-04/22/report.md)
...
| `["array", "equality", ("==", "Vector{Int64}")]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.57 (5%) :white_check_mark: | 0.57 (1%) :white_check_mark: |
...
| `["inference", "allinference", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.57 (5%) :white_check_mark: | 0.58 (1%) :white_check_mark: |
...
| `["random", "types", ("rand", "MersenneTwister", "ComplexF16")]` | 1.30 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand", "MersenneTwister", "Float16")]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randn", "MersenneTwister", "Float32")]` | 1.32 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", ("2pow1023", "negative argument", "Float64")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "exp2", ("2pow1023", "positive argument", "Float64")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "inner", "Int32", 3, 63)]` | 0.80 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 2, 31)]` | 0.66 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 2, 32)]` | 0.67 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 2, 63)]` | 0.50 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 2, 64)]` | 0.54 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 3, 31)]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "two_reductions", "Int32", 4, 63)]` | 0.57 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "manual_partition!", "Int32", 2, 31)]` | 1.33 (20%) :x: | 1.00 (1%)  |
...
| `["simd", ("Linear", "local_arrays", "Int64", 4096)]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.01 (20%)  | 0.97 (1%) :white_check_mark: |
| `["sort", "length = 10000", "sort!(fill(missing, length))"]` | 0.67 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("broadcast", "abs", "Float32", 1)]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.12.0-DEV.453
Commit 5dcd509b66 (2024-05-02 09:39 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz    1103009 s        568 s     252964 s  258626126 s          0 s
       #2  3499 MHz   17511756 s        299 s     439544 s  242133717 s          0 s
       #3  3501 MHz     893130 s        477 s     184527 s  258927530 s          0 s
       #4  3501 MHz     746779 s        357 s     192782 s  258914554 s          0 s
       #5  3501 MHz     734001 s        265 s     195147 s  258024997 s          0 s
       #6  3500 MHz     775644 s        268 s     190723 s  258998976 s          0 s
       #7  3501 MHz     818128 s        274 s     212826 s  259013113 s          0 s
       #8  3503 MHz     796857 s        244 s     178957 s  259070842 s          0 s
  Memory: 31.301593780517578 GB (18628.90625 MB free)
  Uptime: 2.60275057e7 sec
