...
*Commit:* [JuliaLang/julia@fc062919c3f474b365ebfd153fc16e0cfc9536fa](https://github.com/JuliaLang/julia/commit/fc062919c3f474b365ebfd153fc16e0cfc9536fa)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/75c38e3fdb0875bf0f5df3a7f0f6625556c9e2e8...fc062919c3f474b365ebfd153fc16e0cfc9536fa)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/fc062919c3f474b365ebfd153fc16e0cfc9536fa#commitcomment-138237474)

*Tag Predicate:* `ALL`

*Daily Job:* 2024-02-03 vs [2024-01-30](../../2024-01/30/report.md)
...
| `["array", "equality", ("isequal", "Vector{Int64} isequal Vector{Int64}")]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["array", "reverse", "rev_load_fast!"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("Vector", "Int", "⊆", "Vector")]` | 1.32 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", ("Vector{Bool}", "50-50")]` | 3.07 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", ("19/16 <= abs(x) < 39/16", "positive argument", "Float64")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y negative", "x negative", "Float64")]` | 1.50 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y negative", "x positive", "Float64")]` | 1.61 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y positive", "x negative", "Float64")]` | 1.61 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y positive", "x positive", "Float64")]` | 1.65 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tanh", ("0 <= abs(x) < 2.0^-28", "negative argument", "Float64")]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", ("0 <= abs(x) < 2.0^-28", "positive argument", "Float64")]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", ("0 <= abs(x) < 2f0^-12", "negative argument", "Float32")]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tanh", ("1.0 <= abs(x) < 22.0", "negative argument", "Float64")]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tanh", ("1.0 <= abs(x) < 22.0", "positive argument", "Float64")]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tanh", ("2.0^-28 <= abs(x) < 1.0", "negative argument", "Float64")]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", ("2.0^-28 <= abs(x) < 1.0", "positive argument", "Float64")]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", ("2f0^-12 <= abs(x) < 1f0", "positive argument", "Float32")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", ("zero", "Float64")]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "manual_example!", "Int64", 2, 32)]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 2, 31)]` | 0.51 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 2, 63)]` | 1.67 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_partition!", "Int32", 4, 31)]` | 1.27 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "small Float64 view"]` | 0.52 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "issues", "small Int view"]` | 0.37 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["string", "==(::AbstractString, ::AbstractString)", "different length"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_simplecopy", "Int64", 1)]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Missing, Int8}", 1)]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit fc062919c3 (2024-02-03 02:49 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   800 MHz     740941 s        239 s     193407 s  181860386 s          0 s
       #2   800 MHz   14500007 s        204 s     377433 s  167942580 s          0 s
       #3   800 MHz     692901 s        390 s     163059 s  181869179 s          0 s
       #4  2500 MHz     576485 s        247 s     172687 s  181885845 s          0 s
       #5  1600 MHz     569083 s        157 s     175880 s  181356526 s          0 s
       #6   800 MHz     601061 s        161 s     170966 s  181960020 s          0 s
       #7  3527 MHz     632824 s        156 s     192721 s  181958890 s          0 s
       #8   800 MHz     611428 s        151 s     157726 s  182015845 s          0 s
  Memory: 31.301593780517578 GB (18986.94921875 MB free)
  Uptime: 1.829586392e7 sec
