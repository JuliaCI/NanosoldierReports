...
**4818** benchmarks were executed, **227** showed regressions, and **126** showed improvements.
...
*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/1cd77b505ea6ff8f6b599fa7934e4a4a6a8e9c1b...4e3dc4ee59cc5f9383bc707f1ad3d1b4db28ce48)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/4e3dc4ee59cc5f9383bc707f1ad3d1b4db28ce48#commitcomment-181776765)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-03-28 vs [2026-02-27](../../2026-02/27/report.md)
...
| `["array", "equality", ("==", "Vector{Float64} == Vector{Float64}")]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["array", "equality", ("isequal", "Vector{Float64} isequal Vector{Float64}")]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["array", "equality", ("isequal", "Vector{Float64}")]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumvector", "Base.ReinterpretArray{BaseBenchmarks.ArrayBenchmarks.PairVals{Int32}, 2, Int64, Matrix{Int64}, false}")]` | 1.51 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumvector", "SubArray{Float32, 2, Array{Float32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 1.62 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumvector", "SubArray{Float32, 2, BaseBenchmarks.ArrayBenchmarks.ArrayLS{Float32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, false}")]` | 1.57 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumvector", "SubArray{Int32, 2, Array{Int32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 1.62 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("sumvector", "SubArray{Int32, 2, BaseBenchmarks.ArrayBenchmarks.ArrayLS{Int32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, false}")]` | 1.57 (50%) :x: | 1.00 (1%)  |
...
| `["broadcast", "mix_scalar_tuple", (10, "tup_tup")]` | 4.38 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "typeargs", ("array", 5)]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["collection", "deletion", ("Set", "String", "filter!")]` | 0.66 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "optimizations", ("Vector", "concrete", "Nothing")]` | 1.46 (25%) :x: | 1.00 (1%)  |
...
| `["dates", "string", "DateTime"]` | 0.95 (5%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
...
| `["inference", "abstract interpretation", "many_global_refs"]` | 1.12 (5%) :x: | 0.95 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "many_invoke_calls"]` | 1.03 (5%)  | 0.95 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "many_local_vars"]` | 1.86 (5%) :x: | 0.96 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "many_method_matches"]` | 1.07 (5%) :x: | 0.98 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "many_opaque_closures"]` | 6.69 (5%) :x: | 6.31 (1%) :x: |
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 0.35 (5%) :white_check_mark: | 0.34 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "sin(42)"]` | 1.03 (5%)  | 0.99 (1%) :white_check_mark: |
| `["inference", "allinference", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.06 (5%) :x: | 0.98 (1%) :white_check_mark: |
| `["inference", "allinference", "REPL.REPLCompletions.completions"]` | 1.04 (5%)  | 0.97 (1%) :white_check_mark: |
| `["inference", "allinference", "broadcasting"]` | 1.04 (5%)  | 0.98 (1%) :white_check_mark: |
| `["inference", "allinference", "many_const_calls"]` | 1.06 (5%) :x: | 0.97 (1%) :white_check_mark: |
| `["inference", "allinference", "many_global_refs"]` | 1.05 (5%) :x: | 0.98 (1%) :white_check_mark: |
| `["inference", "allinference", "many_invoke_calls"]` | 0.99 (5%)  | 0.95 (1%) :white_check_mark: |
| `["inference", "allinference", "many_local_vars"]` | 1.36 (5%) :x: | 0.99 (1%) :white_check_mark: |
| `["inference", "allinference", "many_method_matches"]` | 1.04 (5%)  | 0.96 (1%) :white_check_mark: |
| `["inference", "allinference", "many_opaque_closures"]` | 3.22 (5%) :x: | 2.73 (1%) :x: |
| `["inference", "allinference", "println(::QuoteNode)"]` | 0.38 (5%) :white_check_mark: | 0.34 (1%) :white_check_mark: |
| `["inference", "allinference", "rand(Float64)"]` | 1.03 (5%)  | 0.97 (1%) :white_check_mark: |
| `["inference", "allinference", "sin(42)"]` | 1.02 (5%)  | 0.96 (1%) :white_check_mark: |
| `["inference", "optimization", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.04 (5%)  | 0.99 (1%) :white_check_mark: |
| `["inference", "optimization", "REPL.REPLCompletions.completions"]` | 1.03 (5%)  | 0.97 (1%) :white_check_mark: |
| `["inference", "optimization", "broadcasting"]` | 1.04 (5%)  | 0.95 (1%) :white_check_mark: |
| `["inference", "optimization", "many_const_calls"]` | 1.10 (5%) :x: | 0.96 (1%) :white_check_mark: |
| `["inference", "optimization", "many_invoke_calls"]` | 1.00 (5%)  | 0.94 (1%) :white_check_mark: |
| `["inference", "optimization", "many_local_vars"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["inference", "optimization", "many_method_matches"]` | 1.02 (5%)  | 0.94 (1%) :white_check_mark: |
| `["inference", "optimization", "many_opaque_closures"]` | 1.02 (5%)  | 0.96 (1%) :white_check_mark: |
| `["inference", "optimization", "println(::QuoteNode)"]` | 1.10 (5%) :x: | 0.97 (1%) :white_check_mark: |
| `["inference", "optimization", "rand(Float64)"]` | 1.09 (5%) :x: | 0.98 (1%) :white_check_mark: |
| `["inference", "optimization", "sin(42)"]` | 1.10 (5%) :x: | 0.98 (1%) :white_check_mark: |
| `["io", "array_limit", ("display", "Matrix{Float64}(10000, 10000)")]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", ("display", "Matrix{Float64}(100000000, 1)")]` | 1.11 (5%) :x: | 0.98 (1%) :white_check_mark: |
| `["io", "array_limit", ("display", "Vector{Float64}(100000000,)")]` | 1.07 (5%) :x: | 0.98 (1%) :white_check_mark: |
...
| `["misc", "issue 12165", "Float16"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", ("rand", "MersenneTwister", "large Vector")]` | 1.37 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", ("0.00024414062f0 <= abs(x) < 9f0", "negative argument", "Float32")]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", ("0.00024414062f0 <= abs(x) < 9f0", "positive argument", "Float32")]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", ("9f0 <= abs(x) < 88.72283f0", "negative argument", "Float32")]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", ("9f0 <= abs(x) < 88.72283f0", "positive argument", "Float32")]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "exp2", ("2pow127", "positive argument", "Float32")]` | 1.41 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", ("argument reduction (easy) abs(x) < 5π/4", "positive argument", "Float64")]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "axpy!", "Float64", 2, 31)]` | 1.23 (20%) :x: | 1.00 (1%)  |
| `["simd", ("Cartesian", "axpy!", "Int64", 4, 64)]` | 1.21 (20%) :x: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 2, 32)]` | 1.22 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_example!", "Int64", 2, 63)]` | 1.20 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "two_reductions", "Int64", 4, 31)]` | 1.22 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.07 (20%)  | 0.94 (1%) :white_check_mark: |
...
| `["sparse", "sparse matvec", "adjoint"]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse matvec", "non-adjoint"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 1.71 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 5.00 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 20000)")]` | 5.06 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", ("sum", "(8, 8)")]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("broadcast", "identity", "BigInt", 0)]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countnothing", "BigFloat", 0)]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_simplecopy", "BigInt", 1)]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "Int64", 0)]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_sum4", "Int64", 1)]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "filter", "Union{Nothing, BigInt}", 0)]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Union{Nothing, Int64}", 0)]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Union{Nothing, ComplexF64}", 0)]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz       3277 s          0 s        850 s     462906 s          0 s  
       #2  3500 MHz      85345 s          0 s       1348 s     380685 s          0 s  
       #3  3500 MHz       3787 s          2 s        400 s     462927 s          0 s  
       #4  3501 MHz       2866 s          1 s        355 s     464244 s          0 s  
  Memory: 31.301368713378906 GB (27605.91015625 MB free)
  Uptime: 467753.79 sec
