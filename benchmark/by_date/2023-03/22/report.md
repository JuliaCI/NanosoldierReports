...
*Commit:* [JuliaLang/julia@489d076452130c718c7d77b157b0d503bfc31602](https://github.com/JuliaLang/julia/commit/489d076452130c718c7d77b157b0d503bfc31602)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/9c19f40962751acc5b8dc26558247cb621a90a58...489d076452130c718c7d77b157b0d503bfc31602)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/489d076452130c718c7d77b157b0d503bfc31602#commitcomment-105644852)

*Tag Predicate:* `ALL`

*Daily Job:* 2023-03-22 vs [2023-03-21](../../2023-03/21/report.md)
...
| `["find", "findall", ("> q0.8", "Vector{Bool}")]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", ("*", "typename(SymTridiagonal)", "typename(SymTridiagonal)", 1024)]` | 6.81 (45%) :x: | 1.00 (1%)  |
| `["linalg", "arithmetic", ("-", "Matrix", "Matrix", 1024)]` | 2.32 (45%) :x: | 1.00 (1%)  |
...
| `["scalar", "floatexp", ("exp10", "agument reduction, k = 83", "Float32")]` | 3.59 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("22.0 <= abs(x) < 709.7822265633563", "positive argument", "Float64")]` | 1.97 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Linear", "loop_fields!", "Int32", "BaseBenchmarks.SIMDBenchmarks.MutableFields", 4095)]` | 1.20 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 2.00 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matvec", "(4, 4)", "(4,)")]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", ("sum", "(4, 4)")]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3900 MHz     202693 s      20259 s     221884 s   41256066 s          0 s
       #2  3900 MHz    3361659 s      13076 s     241049 s   38171656 s          0 s
       #3  3900 MHz     206365 s      13439 s     195162 s   41329457 s          0 s
       #4  3508 MHz     155668 s      12721 s     193188 s   41344658 s          0 s
  Memory: 31.313323974609375 GB (25741.49609375 MB free)
  Uptime: 4.18908918e6 sec
