...
*Commit:* [JuliaLang/julia@9c1e1fa299502491e7e05215cf8d5e3b5221bfc3](https://github.com/JuliaLang/julia/commit/9c1e1fa299502491e7e05215cf8d5e3b5221bfc3)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/b1350e5378ca20bd717bd3ceb49d10b60d1d2e75...9c1e1fa299502491e7e05215cf8d5e3b5221bfc3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/9c1e1fa299502491e7e05215cf8d5e3b5221bfc3#commitcomment-177464666)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-02-17 vs [2026-02-06](../../2026-02/06/report.md)
...
| `["collection", "initialization", ("Vector", "Int", "iterator")]` | 1.47 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findall", ("ispos", "Vector{Float64}")]` | 1.70 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.49 (5%) :white_check_mark: | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "REPL.REPLCompletions.completions"]` | 0.62 (5%) :white_check_mark: | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "broadcasting"]` | 0.99 (5%)  | 1.03 (1%) :x: |
| `["inference", "abstract interpretation", "many_const_calls"]` | 0.83 (5%) :white_check_mark: | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "many_invoke_calls"]` | 1.02 (5%)  | 1.02 (1%) :x: |
| `["inference", "abstract interpretation", "many_local_vars"]` | 1.05 (5%)  | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "many_method_matches"]` | 0.98 (5%)  | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 0.93 (5%) :white_check_mark: | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "rand(Float64)"]` | 1.00 (5%)  | 1.02 (1%) :x: |
| `["inference", "abstract interpretation", "sin(42)"]` | 1.02 (5%)  | 1.01 (1%) :x: |
| `["inference", "allinference", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.57 (5%) :white_check_mark: | 1.01 (1%) :x: |
| `["inference", "allinference", "REPL.REPLCompletions.completions"]` | 0.60 (5%) :white_check_mark: | 1.03 (1%) :x: |
...
| `["inference", "allinference", "many_global_refs"]` | 0.97 (5%)  | 1.01 (1%) :x: |
| `["inference", "allinference", "many_invoke_calls"]` | 1.00 (5%)  | 1.02 (1%) :x: |
| `["inference", "allinference", "many_method_matches"]` | 1.00 (5%)  | 1.01 (1%) :x: |
| `["inference", "allinference", "many_opaque_closures"]` | 0.99 (5%)  | 1.02 (1%) :x: |
| `["inference", "allinference", "println(::QuoteNode)"]` | 0.92 (5%) :white_check_mark: | 1.01 (1%) :x: |
| `["inference", "allinference", "rand(Float64)"]` | 0.97 (5%)  | 1.01 (1%) :x: |
| `["inference", "allinference", "sin(42)"]` | 0.99 (5%)  | 1.01 (1%) :x: |
| `["inference", "optimization", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.98 (5%)  | 1.01 (1%) :x: |
| `["inference", "optimization", "REPL.REPLCompletions.completions"]` | 0.36 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "optimization", "broadcasting"]` | 0.97 (5%)  | 1.02 (1%) :x: |
| `["inference", "optimization", "many_global_refs"]` | 0.92 (5%) :white_check_mark: | 1.02 (1%) :x: |
| `["inference", "optimization", "many_invoke_calls"]` | 0.96 (5%)  | 1.03 (1%) :x: |
| `["inference", "optimization", "many_method_matches"]` | 0.99 (5%)  | 1.02 (1%) :x: |
| `["inference", "optimization", "many_opaque_closures"]` | 0.99 (5%)  | 1.02 (1%) :x: |
| `["inference", "optimization", "println(::QuoteNode)"]` | 0.95 (5%) :white_check_mark: | 1.01 (1%)  |
| `["inference", "optimization", "rand(Float64)"]` | 0.95 (5%) :white_check_mark: | 1.02 (1%) :x: |
...
| `["simd", ("Cartesian", "manual_example!", "Int32", 3, 31)]` | 1.20 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "two_reductions", "Float32", 4, 63)]` | 1.27 (20%) :x: | 1.00 (1%)  |
| `["sort", "issorted", ("forwards", "descending")]` | 0.77 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "issues", "sortperm(rand(10^7))"]` | 1.43 (20%) :x: | 1.00 (1%)  |
| `["sparse", "sparse matvec", "non-adjoint"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 10000)")]` | 2.03 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 2.06 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(600, 600)")]` | 1.33 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 1.55 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", ("sum", "(2, 2)")]` | 2.60 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.1730
Commit 9c1e1fa299 (2026-02-16 19:52 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz      79711 s         69 s      30710 s   22647584 s          0 s  
       #2  3500 MHz     796885 s         35 s      23360 s   21962614 s          0 s  
       #3  3501 MHz      39243 s         29 s      11828 s   22730422 s          0 s  
       #4  3500 MHz      40475 s         32 s      12167 s   22730226 s          0 s  
       #5  3503 MHz      35666 s         34 s      13888 s   22715535 s          0 s  
       #6  3501 MHz      37155 s         19 s      12996 s   22601103 s          0 s  
       #7  3503 MHz      41194 s         40 s      12839 s   22705652 s          0 s  
       #8  3286 MHz      41788 s         30 s      13241 s   22720811 s          0 s  
  Memory: 31.30146026611328 GB (27596.87109375 MB free)
  Uptime: 2.27951262e7 sec
