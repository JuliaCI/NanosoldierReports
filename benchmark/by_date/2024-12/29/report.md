...
*Commit:* [JuliaLang/julia@e3f90c4062af3a40ee548203242744424f2029fa](https://github.com/JuliaLang/julia/commit/e3f90c4062af3a40ee548203242744424f2029fa)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/d3c26b7ecce7e8319788bc0a035241d6dfd21ac0...e3f90c4062af3a40ee548203242744424f2029fa)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/e3f90c4062af3a40ee548203242744424f2029fa#commitcomment-150803053)

*Tag Predicate:* `ALL`

*Daily Job:* 2024-12-29 vs [2024-12-19](../../2024-12/19/report.md)
...
| `["array", "equality", ("==", "BitArray")]` | 1.20 (5%) :x: | 1.00 (1%)  |
...
| `["array", "index", ("sumvector_view", "SubArray{Float32, 2, Matrix{Float32}, Tuple{Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 1.55 (50%) :x: | 1.00 (1%)  |
...
| `["inference", "allinference", "broadcasting"]` | 1.04 (5%)  | 1.03 (1%) :x: |
| `["inference", "optimization", "broadcasting"]` | 1.10 (5%) :x: | 1.15 (1%) :x: |
...
| `["misc", "foldl", "foldl(+, filter(...); init = 0.0)"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "acos", ("zero", "Float64")]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acosh", ("1 <= abs(x) < 2", "positive argument", "Float32")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", ("2^-28 <= abs(x) < 0.5", "negative argument", "Float32")]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atanh", ("2^-28 <= abs(x) < 0.5", "positive argument", "Float32")]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 3, 63)]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Linear", "axpy!", "Float64", 4096)]` | 1.23 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.01 (20%)  | 1.01 (1%) :x: |
| `["sort", "length = 10", "Int unions with missing"]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "index", ("sumelt", "TupleWrapper", 3, "Float64")]` | 2.21 (40%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", ("sumabs", "(2,)")]` | 0.54 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("broadcast", "*", "Float32", "(false, true)")]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_binaryop", "*", "BigFloat", "(false, false)")]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz     902784 s        360 s     229504 s  174467333 s          0 s
       #2  3500 MHz   13737825 s        113 s     276160 s  161673163 s          0 s
       #3  3500 MHz     681070 s        140 s     103105 s  174886024 s          0 s
       #4  3501 MHz     666794 s        122 s     125562 s  174798642 s          0 s
       #5  3504 MHz     577558 s         91 s      91624 s  174851470 s          0 s
       #6  3501 MHz     623219 s         78 s     120160 s  173988349 s          0 s
       #7  3501 MHz     666885 s        143 s      98527 s  174744365 s          0 s
       #8  3501 MHz     588793 s         96 s      83065 s  174934637 s          0 s
  Memory: 31.30148696899414 GB (19381.98828125 MB free)
  Uptime: 1.757586376e7 sec
