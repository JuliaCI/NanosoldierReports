...
*Commit:* [JuliaLang/julia@13f446e9f4d518b20faea68d2e239fcabd462ea9](https://github.com/JuliaLang/julia/commit/13f446e9f4d518b20faea68d2e239fcabd462ea9)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/582585bfb0a5494d41fd28b47a9774d498c608d9...13f446e9f4d518b20faea68d2e239fcabd462ea9)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/13f446e9f4d518b20faea68d2e239fcabd462ea9#commitcomment-150476601)

*Tag Predicate:* `ALL`

*Daily Job:* 2024-12-17 vs [2024-12-12](../../2024-12/12/report.md)
...
|----|------------|--------------|
| `["array", "accumulate", ("accumulate", "Float64")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "accumulate", ("accumulate", "Int")]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "accumulate", ("cumsum", "Float64")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "equality", ("==", "Vector{Int16}")]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", ("Dict", "Int", "in", "true")]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "many_global_refs"]` | 1.60 (5%) :x: | 1.12 (1%) :x: |
| `["inference", "abstract interpretation", "sin(42)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["inference", "allinference", "many_global_refs"]` | 1.18 (5%) :x: | 1.05 (1%) :x: |
| `["linalg", "arithmetic", ("-", "typename(Diagonal)", "typename(Diagonal)", 256)]` | 0.52 (45%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "foldl", "foldl(+, filter(...); init = 0.0)"]` | 1.65 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", ("0 <= abs(x) < 7/16", "negative argument", "Float64")]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", ("0 <= abs(x) < 7/16", "positive argument", "Float32")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", ("0 <= abs(x) < 7/16", "positive argument", "Float64")]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (large)", "y negative", "x positive", "Float64")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (large)", "y positive", "x negative", "Float64")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (large)", "y positive", "x positive", "Float64")]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y negative", "x negative", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y negative", "x positive", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y positive", "x negative", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y positive", "x positive", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y infinite", "y positive", "x finite", "x negative", "Float32")]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float64", "sin_kernel")]` | 1.51 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", ("2pow3", "negative argument", "Float32")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", ("zero", "Float32")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Linear", "inner", "Float32", 4096)]` | 1.33 (20%) :x: | 1.00 (1%)  |
...
| `["sort", "length = 10", "ascending"]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", ("SymTridiagonal", 100)]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", ("Tridiagonal", 10)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", ("Tridiagonal", 100)]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "index", ("spmat", "range", 10)]` | 1.44 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum3", "Float64", 1)]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "BigInt", 1)]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3502 MHz     800464 s        340 s     212582 s  164668574 s          0 s
       #2  3499 MHz   12112665 s        112 s     255115 s  153394906 s          0 s
       #3  3500 MHz     618345 s        132 s      97085 s  165031210 s          0 s
       #4  3500 MHz     606742 s        113 s     118658 s  164946558 s          0 s
       #5  3503 MHz     521766 s         81 s      86087 s  164997687 s          0 s
       #6  3501 MHz     563932 s         70 s     113262 s  164181556 s          0 s
       #7  3504 MHz     601962 s        124 s      92472 s  164899839 s          0 s
       #8  3501 MHz     531341 s         84 s      77526 s  165077765 s          0 s
  Memory: 31.30148696899414 GB (19229.08203125 MB free)
  Uptime: 1.658304002e7 sec
