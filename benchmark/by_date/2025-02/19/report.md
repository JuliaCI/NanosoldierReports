...
*Commit:* [JuliaLang/julia@39255d47db7657950ff1c82137ecec5a70bae622](https://github.com/JuliaLang/julia/commit/39255d47db7657950ff1c82137ecec5a70bae622)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/20162ea3949c5e9cf8c803b5b2b7b249c57108e4...39255d47db7657950ff1c82137ecec5a70bae622)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/39255d47db7657950ff1c82137ecec5a70bae622#commitcomment-152771618)

*Tag Predicate:* `ALL`

*Daily Job:* 2025-02-19 vs [2025-02-17](../../2025-02/17/report.md)
...
| `["problem", "raytrace", "raytrace"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("very large", "positive argument", "Float32")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", ("zero", "Float64")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 5π/4", "positive argument", "Float32")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "inner", "Float64", 4, 31)]` | 1.37 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int64", 3, 64)]` | 1.22 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 0.99 (20%)  | 1.10 (1%) :x: |
...
| `["tuple", "linear algebra", ("matmat", "(2, 2)", "(2, 2)")]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matmat", "(4, 4)", "(4, 4)")]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matvec", "(16, 16)", "(16,)")]` | 0.48 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.13.0-DEV.74
Commit 39255d47db (2025-02-15 22:59 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz      62283 s         36 s      22118 s   18491754 s          0 s
       #2  3500 MHz    1864660 s         42 s      34861 s   16682638 s          0 s
       #3  3500 MHz      49867 s         36 s      10209 s   18521583 s          0 s
       #4  3501 MHz      46692 s         66 s      10750 s   18523682 s          0 s
       #5  3502 MHz      40402 s         35 s       9742 s   18513229 s          0 s
       #6  3335 MHz      45199 s         11 s      12248 s   18424488 s          0 s
       #7  3503 MHz      54111 s         18 s      10363 s   18498969 s          0 s
       #8  3502 MHz      43463 s          2 s       9943 s   18521780 s          0 s
  Memory: 31.301467895507812 GB (28303.69140625 MB free)
  Uptime: 1.85913057e6 sec
