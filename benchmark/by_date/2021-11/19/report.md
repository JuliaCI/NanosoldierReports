...
*Commit:* [JuliaLang/julia@61c6f33d5e649145e451d56ee859ff6833421aab](https://github.com/JuliaLang/julia/commit/61c6f33d5e649145e451d56ee859ff6833421aab)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/d958c8c23af18c7cbafc08f655cc7244ec14f6d6...61c6f33d5e649145e451d56ee859ff6833421aab)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/61c6f33d5e649145e451d56ee859ff6833421aab#commitcomment-60569015)

*Tag Predicate:* `ALL`

*Daily Job:* 2021-11-19 vs [2021-11-16](../../2021-11/16/report.md)
...
| `["array", "cat", ("catnd", 5)]` | 1.19 (5%) :x: | 1.01 (1%) :x: |
...
| `["array", "index", ("sumrange", "SubArray{Int32, 2, Base.ReshapedArray{Int32, 2, SubArray{Int32, 3, BaseBenchmarks.ArrayBenchmarks.ArrayLS{Int32, 3}, Tuple{Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, false}, Tuple{Base.MultiplicativeInverses.SignedMultiplicativeInverse{Int64}, Base.MultiplicativeInverses.SignedMultiplicativeInverse{Int64}}}, Tuple{Base.Slice{Base.OneTo{Int64}}, UnitRange{Int64}}, false}")]` | 1.76 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "iteration", ("Vector", "Int", "iterate")]` | 1.39 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findall", ("ispos", "Vector{Int64}")]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["frontend", "nestedscopes"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "read", "read"]` | 1.33 (5%) :x: | 1.00 (1%)  |
| `["io", "skipchars"]` | 0.58 (5%) :white_check_mark: | 1.01 (1%)  |
| `["linalg", "small exp #29116"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["micro", "fib"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["micro", "printfd"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "20517"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["misc", "23042", "Float32"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["misc", "allocation elision view", "conditional"]` | 1.79 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "issue 12165", "Float32"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", ("rand!", "RandomDevice", "'a':'z'")]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "large BitSet")]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "large Dict")]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "large Set")]` | 0.61 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "large String")]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "large Vector")]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "small BitSet")]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "small Dict")]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "small Set")]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "small String")]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand!", "RandomDevice", "small Vector")]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "'a':'z'")]` | 0.64 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "large BitSet")]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "large Dict")]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "large Set")]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "large String")]` | 0.65 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "large Vector")]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "small BitSet")]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "small Dict")]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "small Set")]` | 0.57 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "small String")]` | 0.64 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", ("rand", "RandomDevice", "small Vector")]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", ("rand!", "RandomDevice", "Int", "1:1000")]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", ("rand", "RandomDevice", "Int", "1:1000")]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("rand!", "RandomDevice", "Float64")]` | 0.56 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("rand", "RandomDevice", "Float64")]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("rand", "RandomDevice", "ImplicitFloat64")]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("rand", "RandomDevice", "Int64")]` | 0.57 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randexp!", "RandomDevice", "Float64")]` | 0.56 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randexp", "RandomDevice", "Float64")]` | 0.59 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randexp", "RandomDevice", "ImplicitFloat64")]` | 0.59 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randn!", "RandomDevice", "Float64")]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randn", "RandomDevice", "Float64")]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randn", "RandomDevice", "ImplicitFloat64")]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asin", ("small", "negative argument", "Float32")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 2.0^20π/4", "positive argument", "Float32", "cos_kernel")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float64", "cos_kernel")]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 2.0^20π/4", "positive argument", "Float32", "sin_kernel")]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "axpy!", "Int32", 2, 31)]` | 0.73 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 4, 32)]` | 1.24 (20%) :x: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "axpy!", "Float32", 2, 31)]` | 1.39 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "axpy!", "Int32", 4, 31)]` | 1.27 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 3, 32)]` | 1.24 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int32", 2, 31)]` | 0.78 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int32", 2, 63)]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int32", 3, 31)]` | 1.25 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int32", 4, 31)]` | 0.64 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", ("IV", 1000)]` | 1.53 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "sparse matvec", "non-adjoint"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
| `["string", "readuntil", "target length 50000"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("map", "*", "Float32", "(false, true)")]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("map", "abs", "Float64", 0)]` | 1.45 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countequals", "Bool")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8124M CPU @ 3.00GHz: 
       ...
       #1  3405 MHz     506074 s       5192 s     100738 s  232576100 s          0 s
       #2  3419 MHz   19848564 s       2404 s    1195171 s  212150777 s          0 s
       #3  3401 MHz     507923 s       2286 s      60466 s  232628041 s          0 s
       #4  3400 MHz     482370 s       2360 s      55661 s  232659097 s          0 s
       #5  3401 MHz     339953 s       2452 s      53525 s  232777447 s          0 s
       #6  3411 MHz     323707 s       2192 s      52463 s  232823239 s          0 s
       #7  3419 MHz     263426 s       2316 s      52152 s  232882366 s          0 s
       #8  3418 MHz     313972 s       2359 s      52122 s  232811800 s          0 s
       
  Memory: 30.362831115722656 GB (13641.7109375 MB free)
  Uptime: 2.332101024e7 sec
