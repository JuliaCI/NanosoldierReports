...
**4818** benchmarks were executed, **51** showed regressions, and **63** showed improvements.
...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/48ff18f4cd57135f7178a789007584a92ec94d63#commitcomment-185596525)
...
| `["collection", "deletion", ("Set", "String", "filter")]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["misc", "iterators", "zip(1:1)"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "repeat", (200, 1, 24)]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.02 (20%)  | 1.04 (1%) :x: |
| `["sort", "length = 10", "all same"]` | 0.57 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 10", "mixed eltype with by order"]` | 1.23 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("transpose", "(20000, 20000)")]` | 1.77 (30%) :x: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matmat", "(2, 2)", "(2, 2)")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "misc", "11899"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", ("minimum", "(4, 4)")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz      42718 s         21 s      11305 s    3793436 s          0 s  
       #2  3500 MHz     465370 s          8 s      11362 s    3376195 s          0 s  
       #3  3641 MHz      26108 s         16 s       4444 s    3811243 s          0 s  
       #4  3500 MHz      25098 s          9 s       4953 s    3822737 s          0 s  
  Memory: 31.301368713378906 GB (27389.91015625 MB free)
  Uptime: 3.85737157e6 sec
