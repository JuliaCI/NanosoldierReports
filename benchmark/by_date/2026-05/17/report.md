...
**4818** benchmarks were executed, **119** showed regressions, and **114** showed improvements.

![Spread of changes](summary.png)

## Job Properties

*Commit:* [JuliaLang/julia@48ff18f4cd57135f7178a789007584a92ec94d63](https://github.com/JuliaLang/julia/commit/48ff18f4cd57135f7178a789007584a92ec94d63)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/2569364ac493319a7570dad3925b0f387e7b76c7...48ff18f4cd57135f7178a789007584a92ec94d63)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/48ff18f4cd57135f7178a789007584a92ec94d63#commitcomment-185625604)
...
| `["io", "serialization", ("deserialize", "Vector{String}")]` | 0.40 (5%) :white_check_mark: | 0.55 (1%) :white_check_mark: |
...
| `["scalar", "acos", ("small", "negative argument", "Float64")]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asin", ("small", "negative argument", "Float64")]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("x zero", "y positive", "Float64")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["sort", "length = 10", "all same"]` | 0.57 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 10", "mixed eltype with by order"]` | 1.21 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 3", "all same"]` | 0.76 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 10000)")]` | 125441.10 (30%) :x: | Inf (1%) :x: |
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 646096.77 (30%) :x: | Inf (1%) :x: |
| `["sparse", "transpose", ("adjoint", "(600, 400)")]` | 1079.12 (30%) :x: | Inf (1%) :x: |
| `["sparse", "transpose", ("adjoint", "(600, 600)")]` | 1299.15 (30%) :x: | Inf (1%) :x: |
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 281784.41 (30%) :x: | Inf (1%) :x: |
| `["sparse", "transpose", ("transpose", "(20000, 20000)")]` | 686713.23 (30%) :x: | Inf (1%) :x: |
| `["sparse", "transpose", ("transpose", "(600, 400)")]` | 902.87 (30%) :x: | Inf (1%) :x: |
| `["sparse", "transpose", ("transpose", "(600, 600)")]` | 1440.00 (30%) :x: | Inf (1%) :x: |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz      44261 s         21 s      11608 s    3828782 s          0 s  
       #2  3409 MHz     495444 s          8 s      11895 s    3382936 s          0 s  
       #3  3500 MHz      27065 s         16 s       4492 s    3847493 s          0 s  
       #4  3500 MHz      26024 s          9 s       4999 s    3859104 s          0 s  
  Memory: 31.301368713378906 GB (27143.9453125 MB free)
  Uptime: 3.89473472e6 sec
