...
**4818** benchmarks were executed, **119** showed regressions, and **113** showed improvements.

![Spread of changes](summary.png)

## Job Properties

*Commit:* [JuliaLang/julia@aa83c3cdb04e78986fdb12f1bdee30982163e6f2](https://github.com/JuliaLang/julia/commit/aa83c3cdb04e78986fdb12f1bdee30982163e6f2)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/ecceaba1c5f236d76aa46d6daf118b19a5855263...aa83c3cdb04e78986fdb12f1bdee30982163e6f2)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/aa83c3cdb04e78986fdb12f1bdee30982163e6f2#commitcomment-186995766)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-05-29 vs [2026-05-26](../../2026-05/26/report.md)
...
|----|------------|--------------|
| `["alloc", "strings"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "setindex!", ("setindex!", 5)]` | 1.41 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (10, "tup_tup")]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (5, "scal_tup_x3")]` | 1.46 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findall", ("ispos", "Vector{Float64}")]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findprev", ("Vector{Bool}", "50-50")]` | 2.91 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", ("display", "Vector{Float64}(100000000,)")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y finite", "y negative", "x infinite", "x positive", "Float64")]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y zero", "y positive", "x positive", "Float64")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", ("arg reduction I", "negative argument", "Float32")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", ("arg reduction I", "positive argument", "Float32")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", ("arg reduction II", "negative argument", "Float32")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", ("arg reduction II", "positive argument", "Float32")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", ("one", "Float32")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "misc", "longtuple"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz (haswell):
       ...
       #1  3491 MHz      53300 s         22 s      14126 s    4874293 s          0 s  
       #2  3500 MHz     564805 s         15 s      14779 s    4368493 s          0 s  
       #3  3500 MHz      35349 s         21 s       6190 s    4891700 s          0 s  
       #4  3500 MHz      34502 s         10 s       6878 s    4906494 s          0 s  
  Memory: 31.301368713378906 GiB (27298.84765625 MiB free)
  Uptime: 4.95413793e6 sec
