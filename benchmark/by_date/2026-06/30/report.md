...
**4818** benchmarks were executed, **63** showed regressions, and **79** showed improvements.

![Spread of changes](summary.png)

## Job Properties

*Commit:* [JuliaLang/julia@fcc4213c488a1fa3b88271776636d45fc1ca42c7](https://github.com/JuliaLang/julia/commit/fcc4213c488a1fa3b88271776636d45fc1ca42c7)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/6e8868916ab43edd961e82684f154b0261ddb3c1...fcc4213c488a1fa3b88271776636d45fc1ca42c7)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/fcc4213c488a1fa3b88271776636d45fc1ca42c7#commitcomment-190733771)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-06-30 vs [2026-06-28](../../2026-06/28/report.md)
...
| `["array", "bool", "boolarray_bool_load!"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["broadcast", "mix_scalar_tuple", (5, "scal_tup")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (5, "scal_tup_x3")]` | 1.39 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", ("ispos", "Vector{Int8}")]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "acos", ("abs(x) < 0.5", "negative argument", "Float64")]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", ("abs(x) < 0.5", "positive argument", "Float64")]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", ("one", "negative argument", "Float32")]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", ("one", "positive argument", "Float32")]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acosh", ("one", "Float32")]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", ("abs(x) < 0.5", "negative argument", "Float64")]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", ("22.0 <= abs(x) < 709.7822265633563", "negative argument", "Float64")]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("very large", "positive argument", "Float64")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matvec", "(4, 4)", "(4,)")]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_binaryop", "*", "Float32", "(true, true)")]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.2462
Build Info:
  Commit fcc4213c48 (2026-06-29 20:30 UTC)
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz (haswell):
       ...
       #1  3500 MHz      80616 s         36 s      21545 s    7533814 s          0 s  
       #2  3500 MHz     811800 s         30 s      24455 s    6808104 s          0 s  
       #3  3500 MHz      61047 s         31 s      10796 s    7549126 s          0 s  
       #4  3500 MHz      61830 s         15 s      12067 s    7570500 s          0 s  
  Memory: 31.301368713378906 GiB (27103.296875 MiB free)
  Uptime: 7.65454145e6 sec
