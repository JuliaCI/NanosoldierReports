...
**4818** benchmarks were executed, **71** showed regressions, and **100** showed improvements.

![Spread of changes](summary.png)

## Job Properties

*Commit:* [JuliaLang/julia@d99fded7bf84695d3f7afa1e88db0058529a70bb](https://github.com/JuliaLang/julia/commit/d99fded7bf84695d3f7afa1e88db0058529a70bb)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/a8f97b19441f82ba082d7c01cbcea45b49f691a6...d99fded7bf84695d3f7afa1e88db0058529a70bb)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/d99fded7bf84695d3f7afa1e88db0058529a70bb#commitcomment-188124555)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-06-09 vs [2026-06-07](../../2026-06/07/report.md)
...
| `["find", "findprev", ("Vector{Bool}", "50-50")]` | 2.97 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "abstract interpretation", "REPL.REPLCompletions.completions"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "abstract interpretation", "broadcasting"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "abstract interpretation", "many_global_refs"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "many_method_matches"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "rand(Float64)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "allinference", "many_const_calls"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "allinference", "many_global_refs"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "allinference", "many_method_matches"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "allinference", "many_opaque_closures"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "allinference", "println(::QuoteNode)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["inference", "optimization", "broadcasting"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "23042", "ComplexF32"]` | 0.56 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "UInt64", "ComplexF64")]` | 0.24 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "two_reductions", "Float64", 3, 31)]` | 1.21 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 1.00 (20%)  | 0.97 (1%) :white_check_mark: |
| `["sort", "issues", "sortperm(rand(10^7))"]` | 0.46 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", ("sum", "(8,)")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.2311
Build Info:
  Commit d99fded7bf (2026-06-08 19:45 UTC)
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz (haswell):
       ...
       #1  3500 MHz      67319 s         26 s      16967 s    5741844 s          0 s  
       #2  3500 MHz     685249 s         22 s      18659 s    5129430 s          0 s  
       #3  3500 MHz      48412 s         25 s       7792 s    5759436 s          0 s  
       #4  3500 MHz      48092 s         12 s       8682 s    5776321 s          0 s  
  Memory: 31.301368713378906 GiB (27488.32421875 MiB free)
  Uptime: 5.84066734e6 sec
