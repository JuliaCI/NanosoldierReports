...
**4818** benchmarks were executed, **198** showed regressions, and **90** showed improvements.

![Spread of changes](summary.png)

## Job Properties

*Commit:* [JuliaLang/julia@e319a303a7401f0151246323b53c03f9255b8586](https://github.com/JuliaLang/julia/commit/e319a303a7401f0151246323b53c03f9255b8586)

*Comparison Range:* [link](https://github.com/JuliaLang/julia/compare/ce8c59448aaff9dc258a4ac919bd7c0c42e5d6a1...e319a303a7401f0151246323b53c03f9255b8586)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/e319a303a7401f0151246323b53c03f9255b8586#commitcomment-189743706)

*Tag Predicate:* `ALL`

*Daily Job:* 2026-06-21 vs [2026-06-18](../../2026-06/18/report.md)
...
| `["array", "setindex!", ("setindex!", 4)]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "optimizations", ("Dict", "concrete", "Nothing")]` | 1.45 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", ("Vector{Bool}", "50-50")]` | 2.93 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "repeat", (200, 24, 1)]` | 3.15 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", ("0.5 <= abs(x) < 0.975", "positive argument", "Float64")]` | 1.34 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", ("0.975 <= abs(x) < 1.0", "negative argument", "Float64")]` | 1.34 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", ("0.975 <= abs(x) < 1.0", "positive argument", "Float64")]` | 1.37 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", ("19/16 <= abs(x) < 39/16", "negative argument", "Float64")]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", ("7/16 <= abs(x) < 11/16", "positive argument", "Float64")]` | 1.39 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float32", "sin_kernel")]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "positive argument", "Float32", "sin_kernel")]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", ("2.7755602085408512e-17 <= abs(x) < 22.0", "negative argument", "Float64")]` | 1.38 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cosh", ("2.7755602085408512e-17 <= abs(x) < 22.0", "positive argument", "Float64")]` | 1.38 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cosh", ("22.0 <= abs(x) < 709.7822265633563", "negative argument", "Float64")]` | 1.38 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cosh", ("22.0 <= abs(x) < 709.7822265633563", "positive argument", "Float64")]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", ("argument reduction (easy) abs(x) > 2.0^20*π/2", "positive argument", "Float64")]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 4π/4", "negative argument", "Float64", "sin_kernel")]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float64", "sin_kernel")]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float32", "cos_kernel")]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float32", "sin_kernel")]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float64", "cos_kernel")]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("0 <= abs(x) < 2f-12", "negative argument", "Float32")]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sinh", ("0 <= abs(x) < 2f-12", "positive argument", "Float32")]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sinh", ("zero", "Float32")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", ("large", "positive argument", "Float64")]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tanh", ("1.0 <= abs(x) < 22.0", "negative argument", "Float64")]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tanh", ("1.0 <= abs(x) < 22.0", "positive argument", "Float64")]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("collect", "filter", "Float32", 0)]` | 2.06 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.2425
Build Info:
  Commit e319a303a7 (2026-06-20 03:52 UTC)
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz (haswell):
       ...
       #1  3501 MHz      75371 s         31 s      19638 s    6765227 s          0 s  
       #2  3500 MHz     765329 s         27 s      22092 s    6080693 s          0 s  
       #3  3500 MHz      55772 s         29 s       9434 s    6781923 s          0 s  
       #4  3500 MHz      56615 s         14 s      10614 s    6800840 s          0 s  
  Memory: 31.301368713378906 GiB (26917.16796875 MiB free)
  Uptime: 6.87708173e6 sec
