...
| `["array", "cat", ("catnd_setind", 5)]` | 0.98 (5%)  | 0.94 (1%) :white_check_mark: |
...
| `["array", "index", ("sumcolon", "SubArray{Float32, 2, Matrix{Float32}, Tuple{Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 1.44 (50%)  | 0.97 (1%) :white_check_mark: |
...
| `["array", "index", ("sumlogical", "SubArray{Float32, 2, Base.ReshapedArray{Float32, 2, SubArray{Float32, 3, Array{Float32, 3}, Tuple{Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}, Tuple{}}, Tuple{Base.Slice{Base.OneTo{Int64}}, UnitRange{Int64}}, true}")]` | 1.04 (50%)  | 0.67 (1%) :white_check_mark: |
...
| `["array", "index", ("sumrange", "Base.ReinterpretArray{BaseBenchmarks.ArrayBenchmarks.PairVals{Float32}, 2, Float32, Matrix{Float32}, false}")]` | 1.05 (50%)  | 0.97 (1%) :white_check_mark: |
...
| `["array", "index", ("sumvector", "Base.ReinterpretArray{BaseBenchmarks.ArrayBenchmarks.PairVals{Float32}, 2, Float64, Matrix{Float64}, false}")]` | 0.97 (50%)  | 0.75 (1%) :white_check_mark: |
...
| `["array", "index", ("sumvector_view", "1.0:0.00010001000100010001:2.0")]` | 1.00 (50%)  | 0.75 (1%) :white_check_mark: |
...
| `["array", "index", ("sumvector_view", "SubArray{Int32, 2, BaseBenchmarks.ArrayBenchmarks.ArrayLS{Int32, 2}, Tuple{Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, false}")]` | 1.04 (50%)  | 0.75 (1%) :white_check_mark: |
...
| `["collection", "queries & updates", ("IdDict", "Int", "pop!", "specified")]` | 1.15 (25%)  | 0.75 (1%) :white_check_mark: |
...
| `["collection", "set operations", ("Set", "Int", "intersect", "Set", "Set")]` | 1.02 (25%)  | 0.86 (1%) :white_check_mark: |
...
| `["find", "findall", ("> q0.5", "Vector{Float32}")]` | 0.25 (5%) :white_check_mark: | 1.01 (1%) :x: |
...
| `["random", "ranges", ("rand!", "RandomDevice", "Int", "1:1000")]` | 2.23 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", ("rand", "ImplicitRNG", "Int", "1:1000")]` | 0.59 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", ("rand", "RandomDevice", "Int", "1:1000")]` | 2.12 (25%) :x: | 1.00 (1%)  |
| `["random", "sequences", ("randcycle", "MersenneTwister", "5")]` | 1.02 (25%)  | 0.75 (1%) :white_check_mark: |
| `["random", "sequences", ("randperm", "MersenneTwister", "5")]` | 0.98 (25%)  | 0.75 (1%) :white_check_mark: |
...
| `["random", "types", ("rand", "ImplicitRNG", "Float64")]` | 0.45 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("rand", "ImplicitRNG", "ImplicitFloat64")]` | 0.45 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", ("rand", "MersenneTwister", "Complex{Int16}")]` | 1.58 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand", "MersenneTwister", "Complex{UInt16}")]` | 1.63 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand", "MersenneTwister", "UInt64")]` | 1.25 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand", "RandomDevice", "Float64")]` | 2.19 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand", "RandomDevice", "ImplicitFloat64")]` | 2.18 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("rand", "RandomDevice", "Int64")]` | 2.15 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randexp!", "RandomDevice", "Float64")]` | 2.27 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randexp", "ImplicitRNG", "Float64")]` | 0.50 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randexp", "ImplicitRNG", "ImplicitFloat64")]` | 0.50 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randexp", "RandomDevice", "Float64")]` | 2.15 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randexp", "RandomDevice", "ImplicitFloat64")]` | 2.15 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randn!", "RandomDevice", "Float64")]` | 2.07 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randn", "ImplicitRNG", "Float64")]` | 0.55 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randn", "ImplicitRNG", "ImplicitFloat64")]` | 0.48 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("randn", "RandomDevice", "Float64")]` | 2.13 (25%) :x: | 1.00 (1%)  |
| `["random", "types", ("randn", "RandomDevice", "ImplicitFloat64")]` | 2.15 (25%) :x: | 1.00 (1%)  |
| `["scalar", "acos", ("abs(x) < 0.5", "negative argument", "Float32")]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", ("abs(x) < 0.5", "positive argument", "Float64")]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("2 <= abs(x) < 2^28", "negative argument", "Float64")]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("2^-28 <= abs(x) < 2", "positive argument", "Float64")]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", ("0 <= abs(x) < 7/16", "positive argument", "Float64")]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", ("11/16 <= abs(x) < 19/16", "positive argument", "Float32")]` | 1.28 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", ("11/16 <= abs(x) < 19/16", "positive argument", "Float64")]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", ("19/16 <= abs(x) < 39/16", "negative argument", "Float32")]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", ("7/16 <= abs(x) < 11/16", "negative argument", "Float32")]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", ("7/16 <= abs(x) < 11/16", "negative argument", "Float64")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", ("7/16 <= abs(x) < 11/16", "positive argument", "Float32")]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", ("7/16 <= abs(x) < 11/16", "positive argument", "Float64")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", ("very large", "negative argument", "Float32")]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y negative", "x negative", "Float64")]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y positive", "x negative", "Float64")]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y positive", "x positive", "Float32")]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) safe (small)", "y positive", "x positive", "Float64")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("no reduction", "zero", "Float64")]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", ("very small", "negative argument", "Float32")]` | 124.59 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", ("very small", "negative argument", "Float64")]` | 164.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", ("very small", "positive argument", "Float32")]` | 124.68 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", ("very small", "positive argument", "Float64")]` | 164.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", ("zero", "Float32")]` | 1.81 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", ("zero", "Float64")]` | 1.72 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 2.0^20π/4", "negative argument", "Float32", "sin_kernel")]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "fannkuch"]` | 0.87 (5%) :white_check_mark: | 0.86 (1%) :white_check_mark: |
| `["shootout", "meteor_contest"]` | 0.94 (5%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
| `["shootout", "nbody"]` | 0.99 (5%)  | 0.93 (1%) :white_check_mark: |
| `["shootout", "nbody_vec"]` | 1.29 (5%) :x: | 0.71 (1%) :white_check_mark: |
| `["shootout", "revcomp"]` | 1.16 (25%)  | 0.97 (1%) :white_check_mark: |
| `["simd", ("auto_manual_example!", "Int32", 4096)]` | 1.20 (20%) :x: | 1.00 (1%)  |
...
| `["simd", ("loop_fields!", "Int32", "BaseBenchmarks.SIMDBenchmarks.ImmutableFields", 4095)]` | 0.11 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("loop_fields!", "Int32", "BaseBenchmarks.SIMDBenchmarks.MutableFields", 4096)]` | 0.10 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", ("Bidiagonal", 10)]` | 0.93 (5%) :white_check_mark: | 0.85 (1%) :white_check_mark: |
| `["sparse", "constructors", ("Diagonal", 10)]` | 0.89 (5%) :white_check_mark: | 0.87 (1%) :white_check_mark: |
| `["sparse", "constructors", ("IJV", 10)]` | 1.05 (5%) :x: | 0.75 (1%) :white_check_mark: |
| `["sparse", "constructors", ("IJV", 100)]` | 0.86 (5%) :white_check_mark: | 0.91 (1%) :white_check_mark: |
...
| `["sparse", "constructors", ("SymTridiagonal", 10)]` | 0.92 (5%) :white_check_mark: | 0.92 (1%) :white_check_mark: |
| `["sparse", "constructors", ("Tridiagonal", 10)]` | 0.89 (5%) :white_check_mark: | 0.92 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "OneTo", 10)]` | 0.94 (30%)  | 0.87 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "array", 10)]` | 1.02 (30%)  | 0.93 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "OneTo", 10)]` | 0.96 (30%)  | 0.75 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "OneTo", 100)]` | 0.99 (30%)  | 0.80 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "OneTo", 1000)]` | 0.92 (30%)  | 0.89 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "array", 10)]` | 0.96 (30%)  | 0.81 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "array", 100)]` | 1.08 (30%)  | 0.94 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "logical", 10)]` | 1.02 (30%)  | 0.78 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "logical", 100)]` | 1.00 (30%)  | 0.94 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "logical", 1000)]` | 0.50 (30%) :white_check_mark: | 0.99 (1%)  |
| `["sparse", "index", ("spmat", "col", "range", 10)]` | 0.98 (30%)  | 0.75 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "range", 100)]` | 1.00 (30%)  | 0.80 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "col", "range", 1000)]` | 0.91 (30%)  | 0.89 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "logical", 10)]` | 1.00 (30%)  | 0.81 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "range", 10)]` | 0.94 (30%)  | 0.87 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "row", "OneTo", 10)]` | 1.04 (30%)  | 1.12 (1%) :x: |
| `["sparse", "index", ("spmat", "row", "OneTo", 100)]` | 0.96 (30%)  | 0.69 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "row", "OneTo", 1000)]` | 0.95 (30%)  | 0.77 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "row", "array", 10)]` | 1.02 (30%)  | 1.12 (1%) :x: |
| `["sparse", "index", ("spmat", "row", "array", 100)]` | 1.00 (30%)  | 0.69 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "row", "array", 1000)]` | 1.11 (30%)  | 0.77 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "row", "logical", 10)]` | 1.01 (30%)  | 1.04 (1%) :x: |
| `["sparse", "index", ("spmat", "row", "logical", 100)]` | 1.36 (30%) :x: | 1.05 (1%) :x: |
| `["sparse", "index", ("spmat", "row", "logical", 1000)]` | 0.63 (30%) :white_check_mark: | 1.05 (1%) :x: |
| `["sparse", "index", ("spmat", "row", "range", 10)]` | 1.01 (30%)  | 1.12 (1%) :x: |
| `["sparse", "index", ("spmat", "row", "range", 100)]` | 0.88 (30%)  | 0.69 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "row", "range", 1000)]` | 0.90 (30%)  | 0.77 (1%) :white_check_mark: |
| `["sparse", "index", ("spmat", "splogical", 10)]` | 0.92 (30%)  | 0.80 (1%) :white_check_mark: |
...
| `["sparse", "index", ("spvec", "array", 1000)]` | 1.06 (30%)  | 0.99 (1%) :white_check_mark: |
| `["sparse", "index", ("spvec", "logical", 1000)]` | 0.51 (30%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
| `["sparse", "index", ("spvec", "range", 1000)]` | 0.95 (30%)  | 0.92 (1%) :white_check_mark: |
| `["sparse", "matmul", ("A_mul_B", "dense 50x50, sparse 50x5 -> dense 50x5")]` | 1.04 (30%)  | 0.97 (1%) :white_check_mark: |
| `["sparse", "matmul", ("A_mul_B", "dense 5x500, sparse 500x50 -> dense 5x50")]` | 1.00 (30%)  | 0.97 (1%) :white_check_mark: |
| `["sparse", "matmul", ("A_mul_Bc", "sparse 500x500, dense 5x500 -> dense 500x5")]` | 1.44 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", ("A_mul_Bc", "sparse 50x500, dense 5x500 -> dense 50x5")]` | 1.55 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", ("A_mul_Bt", "dense 50x50, sparse 5x50 -> dense 50x5")]` | 1.07 (30%)  | 0.97 (1%) :white_check_mark: |
...
| `["sparse", "matmul", ("At_mul_B", "dense 50x5, sparse 50x500 -> dense 5x500")]` | 1.92 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", ("At_mul_B", "dense 50x50, sparse 50x5 -> dense 50x5")]` | 1.03 (30%)  | 0.97 (1%) :white_check_mark: |
...
| `["sparse", "matmul", ("At_mul_Bt", "dense 500x5, sparse 50x500 -> dense 5x50")]` | 1.03 (30%)  | 0.97 (1%) :white_check_mark: |
...
| `["string", "join"]` | 1.14 (40%)  | 0.82 (1%) :white_check_mark: |
| `["string", "readuntil", "backtracking"]` | 1.06 (5%) :x: | 0.98 (1%) :white_check_mark: |
| `["string", "readuntil", "barbarian backtrack"]` | 1.10 (5%) :x: | 0.97 (1%) :white_check_mark: |
| `["string", "readuntil", "no backtracking"]` | 1.15 (5%) :x: | 0.96 (1%) :white_check_mark: |
| `["string", "readuntil", "target length 1"]` | 0.80 (5%) :white_check_mark: | 1.20 (1%) :x: |
| `["string", "readuntil", "target length 1000"]` | 1.10 (5%) :x: | 1.50 (1%) :x: |
| `["string", "readuntil", "target length 2"]` | 1.06 (5%) :x: | 1.50 (1%) :x: |
| `["string", "readuntil", "target length 50000"]` | 1.10 (5%) :x: | 1.50 (1%) :x: |
| `["string", "repeat", "repeat char 2"]` | 0.52 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "misc", "longtuple"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", ("sum", "(16,)")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("sum", "(2, 2)")]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("broadcast", "*", "Bool", "(true, true)")]` | 1.02 (5%)  | 0.98 (1%) :white_check_mark: |
| `["union", "array", ("broadcast", "*", "Float64", "(false, true)")]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "*", "Int64", "(false, false)")]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "*", "Int64", "(false, true)")]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "*", "Int64", "(true, true)")]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "*", "Int8", "(false, false)")]` | 1.18 (5%) :x: | 0.97 (1%) :white_check_mark: |
| `["union", "array", ("broadcast", "*", "Int8", "(false, true)")]` | 0.83 (5%) :white_check_mark: | 0.99 (1%) :white_check_mark: |
...
| `["union", "array", ("broadcast", "abs", "Bool", 0)]` | 0.88 (5%) :white_check_mark: | 0.83 (1%) :white_check_mark: |
| `["union", "array", ("broadcast", "abs", "Bool", 1)]` | 0.83 (5%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
| `["union", "array", ("broadcast", "abs", "ComplexF64", 1)]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "abs", "Float32", 0)]` | 0.55 (5%) :white_check_mark: | 0.99 (1%)  |
| `["union", "array", ("broadcast", "abs", "Float32", 1)]` | 0.90 (5%) :white_check_mark: | 0.99 (1%)  |
...
| `["union", "array", ("broadcast", "abs", "Int8", 1)]` | 0.63 (5%) :white_check_mark: | 0.99 (1%) :white_check_mark: |
...
| `["union", "array", ("broadcast", "identity", "Bool", 0)]` | 0.88 (5%) :white_check_mark: | 0.83 (1%) :white_check_mark: |
...
| `["union", "array", ("broadcast", "identity", "Int64", 0)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "identity", "Int64", 1)]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "identity", "Int8", 0)]` | 0.69 (5%) :white_check_mark: | 0.97 (1%) :white_check_mark: |
| `["union", "array", ("broadcast", "identity", "Int8", 1)]` | 0.82 (5%) :white_check_mark: | 0.99 (1%) :white_check_mark: |
| `["union", "array", ("collect", "all", "BigFloat", 0)]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("collect", "all", "BigFloat", 1)]` | 1.49 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("collect", "all", "BigInt", 0)]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("collect", "all", "BigInt", 1)]` | 1.32 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("collect", "all", "Bool", 0)]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("collect", "all", "Bool", 1)]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("collect", "all", "Float32", 1)]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("collect", "all", "Float64", 0)]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("collect", "all", "Int8", 1)]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("collect", "filter", "BigFloat", 0)]` | 0.97 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("collect", "filter", "BigFloat", 1)]` | 1.04 (5%)  | 0.96 (1%) :white_check_mark: |
| `["union", "array", ("collect", "filter", "BigInt", 0)]` | 1.04 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("collect", "filter", "BigInt", 1)]` | 1.01 (5%)  | 0.96 (1%) :white_check_mark: |
| `["union", "array", ("collect", "filter", "Bool", 0)]` | 1.13 (5%) :x: | 1.26 (1%) :x: |
| `["union", "array", ("collect", "filter", "Bool", 1)]` | 1.12 (5%) :x: | 0.96 (1%) :white_check_mark: |
| `["union", "array", ("collect", "filter", "ComplexF64", 0)]` | 1.09 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("collect", "filter", "ComplexF64", 1)]` | 1.10 (5%) :x: | 0.96 (1%) :white_check_mark: |
...
| `["union", "array", ("collect", "filter", "Float64", 0)]` | 1.08 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("collect", "filter", "Float64", 1)]` | 1.06 (5%) :x: | 0.96 (1%) :white_check_mark: |
| `["union", "array", ("collect", "filter", "Int64", 0)]` | 1.04 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("collect", "filter", "Int64", 1)]` | 1.15 (5%) :x: | 0.96 (1%) :white_check_mark: |
| `["union", "array", ("collect", "filter", "Int8", 0)]` | 1.21 (5%) :x: | 1.26 (1%) :x: |
| `["union", "array", ("collect", "filter", "Int8", 1)]` | 1.10 (5%) :x: | 0.96 (1%) :white_check_mark: |
...
| `["union", "array", ("map", "*", "ComplexF64", "(false, false)")]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "ComplexF64", "(false, true)")]` | 1.30 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "ComplexF64", "(true, true)")]` | 1.30 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "Float32", "(false, false)")]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "Float32", "(false, true)")]` | 1.71 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "Float32", "(true, true)")]` | 1.63 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "Float64", "(false, false)")]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("map", "*", "Int64", "(true, true)")]` | 1.40 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "Int8", "(false, false)")]` | 1.33 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "Int8", "(false, true)")]` | 1.60 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "Int8", "(true, true)")]` | 1.71 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("map", "identity", "Int64", 1)]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_binaryop", "*", "Bool", "(false, true)")]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_binaryop", "*", "Bool", "(true, true)")]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_binaryop", "*", "Int8", "(false, false)")]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_binaryop", "*", "Int8", "(false, true)")]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_binaryop", "*", "Int8", "(true, true)")]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countnothing", "Bool", 0)]` | 1.78 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "ComplexF64", 0)]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "ComplexF64", 1)]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Float32", 1)]` | 1.78 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Float64", 1)]` | 1.78 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Int64", 0)]` | 1.77 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Int64", 1)]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_countnothing", "Int8", 1)]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum", "Bool", 0)]` | 1.49 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Bool", 1)]` | 1.49 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum", "Int64", 1)]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Int8", 0)]` | 1.33 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_sum", "Int8", 1)]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "Bool", 1)]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum4", "Int8", 1)]` | 1.32 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "collect", "BigFloat", 0)]` | 1.01 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "BigInt", 0)]` | 1.07 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Bool", 0)]` | 1.10 (5%) :x: | 1.26 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "ComplexF64", 0)]` | 1.03 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Float32", 0)]` | 1.07 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Float64", 0)]` | 1.04 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Int64", 0)]` | 1.04 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Int8", 0)]` | 1.07 (5%) :x: | 1.26 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Missing, BigFloat}", 1)]` | 1.00 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Missing, BigInt}", 1)]` | 1.01 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Missing, Bool}", 1)]` | 1.13 (5%) :x: | 1.26 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Missing, ComplexF64}", 1)]` | 1.09 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Missing, Float32}", 1)]` | 1.31 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Missing, Float64}", 1)]` | 1.15 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Missing, Int64}", 1)]` | 1.09 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Missing, Int8}", 1)]` | 1.17 (5%) :x: | 1.26 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Nothing, BigFloat}", 0)]` | 1.07 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Nothing, BigInt}", 0)]` | 1.03 (5%)  | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Nothing, Bool}", 0)]` | 1.15 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Nothing, ComplexF64}", 0)]` | 1.10 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Nothing, Float32}", 0)]` | 1.16 (5%) :x: | 1.27 (1%) :x: |
| `["union", "array", ("skipmissing", "collect", "Union{Nothing, Float64}", 0)]` | 1.07 (5%) :x: | 1.27 (1%) :x: |
...
| `["union", "array", ("skipmissing", "sum", "Union{Missing, Bool}", 1)]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Union{Missing, Int64}", 1)]` | 1.29 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "sum", "Union{Missing, Int8}", 1)]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Union{Nothing, Float32}", 0)]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("skipmissing", "sum", "Union{Nothing, Float64}", 0)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("sort", "Union{Missing, Float32}", 1)]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "Union{Missing, Float64}", 1)]` | 0.61 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "Union{Nothing, Bool}", 0)]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "Union{Nothing, Float32}", 0)]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "Union{Nothing, Float64}", 0)]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "Union{Nothing, Int64}", 0)]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("sort", "Union{Nothing, Int8}", 0)]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
