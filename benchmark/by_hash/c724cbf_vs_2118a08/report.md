...
*Commits:* [JuliaLang/julia@c724cbff6c08c1a12febbc1f8047c7ba4c47794c](https://github.com/JuliaLang/julia/commit/c724cbff6c08c1a12febbc1f8047c7ba4c47794c) vs [JuliaLang/julia@2118a08ae9f9b0742596015a2fcc692e2ff61db3](https://github.com/JuliaLang/julia/commit/2118a08ae9f9b0742596015a2fcc692e2ff61db3)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/2118a08ae9f9b0742596015a2fcc692e2ff61db3..c724cbff6c08c1a12febbc1f8047c7ba4c47794c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/43852#issuecomment-1033840576)
...
| `["collection", "queries & updates", ("Vector", "String", "in", "true")]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "intersect", "Vector")]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", ("Vector", "Int", "⊆", "Vector")]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["dates", "arithmetic", ("DateTime", "Month")]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "abstract_call_gf_by_type"]` | 1.27 (5%) :x: | 1.08 (1%) :x: |
| `["inference", "abstract interpretation", "domsort_ssa!"]` | 1.04 (5%)  | 0.99 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 1.08 (5%) :x: | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "rand(Float64)"]` | 1.00 (5%)  | 0.99 (1%) :white_check_mark: |
| `["inference", "abstract interpretation", "sin(42)"]` | 0.95 (5%) :white_check_mark: | 0.91 (1%) :white_check_mark: |
| `["inference", "abstract_call_gf_by_type"]` | 1.10 (5%) :x: | 1.04 (1%) :x: |
| `["inference", "construct_ssa!"]` | 1.00 (5%)  | 0.97 (1%) :white_check_mark: |
| `["inference", "domsort_ssa!"]` | 0.98 (5%)  | 0.96 (1%) :white_check_mark: |
| `["inference", "optimization", "abstract_call_gf_by_type"]` | 1.34 (5%) :x: | 1.38 (1%) :x: |
| `["inference", "optimization", "construct_ssa!"]` | 1.01 (5%)  | 0.98 (1%) :white_check_mark: |
| `["inference", "println(::QuoteNode)"]` | 1.00 (5%)  | 0.98 (1%) :white_check_mark: |
| `["inference", "rand(Float64)"]` | 0.90 (5%) :white_check_mark: | 0.87 (1%) :white_check_mark: |
| `["inference", "sin(42)"]` | 0.89 (5%) :white_check_mark: | 0.87 (1%) :white_check_mark: |
...
| `["scalar", "acosh", ("one", "Float64")]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", ("argument reduction (easy) abs(x) < 4π/4", "positive argument", "Float64")]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", ("very small", "negative argument", "Float32")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "axpy!", "Int32", 3, 32)]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 4, 63)]` | 1.27 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_partition!", "Int32", 4, 31)]` | 1.24 (20%) :x: | 1.00 (1%)  |
...
| `["string", "findfirst", "Char"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("broadcast", "identity", "Bool", 1)]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "identity", "ComplexF64", 1)]` | 1.30 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("collect", "all", "Int8", 1)]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "abs", "Bool", 1)]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "identity", "Bool", 1)]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.8.0-DEV.1498
Commit c724cbff6c (2022-02-09 14:35 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz     139783 s        312 s      21194 s   23191784 s          0 s
       #2  3500 MHz    2161798 s        223 s      89386 s   21123073 s          0 s
       #3  3500 MHz     143596 s        226 s      14964 s   23213298 s          0 s
       #4  3500 MHz      98518 s        188 s      14491 s   23148382 s          0 s
  Memory: 31.32097625732422 GB (9799.2421875 MB free)
  Uptime: 2.33963003e6 sec
...
```
Julia Version 1.8.0-DEV.1477
Commit 2118a08ae9 (2022-02-09 11:19 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 20.04.3 LTS
  uname: Linux 5.4.0-94-generic #106-Ubuntu SMP Thu Jan 6 23:58:14 UTC 2022 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3500 MHz     140720 s        312 s      21393 s   23316538 s          0 s
       #2  3500 MHz    2281509 s        223 s      93773 s   21125169 s          0 s
       #3  3500 MHz     144107 s        226 s      14989 s   23338929 s          0 s
       #4  3500 MHz      99428 s        188 s      14512 s   23273255 s          0 s
  Memory: 31.32097625732422 GB (9431.40625 MB free)
  Uptime: 2.3522497e6 sec
