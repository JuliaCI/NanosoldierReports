...
*Commits:* [JuliaLang/julia@4ff1f007974a4ea1d89e636d8feed83723bbb779](https://github.com/JuliaLang/julia/commit/4ff1f007974a4ea1d89e636d8feed83723bbb779) vs [JuliaLang/julia@f66fd47f2daa9a7139f72617d74bbd1efaafd766](https://github.com/JuliaLang/julia/commit/f66fd47f2daa9a7139f72617d74bbd1efaafd766)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/f66fd47f2daa9a7139f72617d74bbd1efaafd766..4ff1f007974a4ea1d89e636d8feed83723bbb779)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/53484#issuecomment-1977468501)
...
| `["array", "index", ("mapr_access", "SubArray{Float32, 2, Array{Float32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, true}")]` | 1.85 (50%) :x: | 1.00 (1%)  |
| `["array", "index", ("mapr_access", "SubArray{Float32, 2, BaseBenchmarks.ArrayBenchmarks.ArrayLS{Float32, 3}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}, Base.Slice{Base.OneTo{Int64}}}, false}")]` | 1.86 (50%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", ("Vector{Bool}", "50-50")]` | 0.32 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findprev", ("ispos", "Vector{UInt64}")]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "abstract interpretation", "broadcasting"]` | 1.56 (5%) :x: | 1.63 (1%) :x: |
...
| `["scalar", "arithmetic", ("div", "ComplexF64", "ComplexF64")]` | 1.37 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", ("2.7755602085408512e-17 <= abs(x) < 22.0", "negative argument", "Float64")]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", ("2.7755602085408512e-17 <= abs(x) < 22.0", "positive argument", "Float64")]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", ("22.0 <= abs(x) < 709.7822265633563", "negative argument", "Float64")]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", ("22.0 <= abs(x) < 709.7822265633563", "positive argument", "Float64")]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", ("very large", "negative argument", "Float64")]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", ("very large", "positive argument", "Float64")]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "manual_example!", "Int64", 2, 63)]` | 0.74 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "manual_example!", "Int64", 2, 63)]` | 0.71 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "two_reductions", "Float32", 3, 63)]` | 1.27 (20%) :x: | 1.00 (1%)  |
| `["sort", "issues", "partialsort!(rand(10_000), 1:3, rev=true)"]` | 0.99 (20%)  | 0.97 (1%) :white_check_mark: |
| `["sort", "length = 3", "sort!(fill(missing, length))"]` | 0.33 (20%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.12.0-DEV.130
Commit 4ff1f00797 (2024-03-04 21:14 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz     796164 s        210 s     172228 s  208276896 s          0 s
       #2  3500 MHz    7944120 s        466 s     276333 s  200918045 s          0 s
       #3  3500 MHz     779646 s        247 s     215358 s  208252157 s          0 s
       #4  3500 MHz     645996 s        199 s     157725 s  208260975 s          0 s
       #5  3503 MHz     669770 s        220 s     202753 s  207511958 s          0 s
       #6  3503 MHz     687963 s        154 s     186712 s  208285480 s          0 s
       #7  3501 MHz     751008 s        230 s     179083 s  208246653 s          0 s
       #8  3503 MHz     719356 s        232 s     220138 s  208297472 s          0 s
  Memory: 31.301593780517578 GB (20193.88671875 MB free)
  Uptime: 2.094190622e7 sec
...
```
Julia Version 1.12.0-DEV.127
Commit f66fd47f2d (2024-03-04 21:14 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 22.04.3 LTS
  uname: Linux 5.15.0-76-generic #83-Ubuntu SMP Thu Jun 15 19:16:32 UTC 2023 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz     796814 s        210 s     172414 s  208402592 s          0 s
       #2  3500 MHz    8067815 s        466 s     278543 s  200918979 s          0 s
       #3  3500 MHz     780235 s        247 s     215374 s  208378375 s          0 s
       #4  3501 MHz     646085 s        199 s     157734 s  208387607 s          0 s
       #5  3500 MHz     669870 s        220 s     202760 s  207638396 s          0 s
       #6  3505 MHz     688139 s        154 s     186720 s  208412128 s          0 s
       #7  3503 MHz     751149 s        230 s     179088 s  208373329 s          0 s
       #8  3503 MHz     719427 s        232 s     220143 s  208424225 s          0 s
  Memory: 31.301593780517578 GB (20260.78125 MB free)
  Uptime: 2.095459018e7 sec
