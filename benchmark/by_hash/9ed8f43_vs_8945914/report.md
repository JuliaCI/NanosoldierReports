...
*Commits:* [mofeing/julia@9ed8f4344444fc7de5a2db895a51e2a01b68b903](https://github.com/mofeing/julia/commit/9ed8f4344444fc7de5a2db895a51e2a01b68b903) vs [JuliaLang/julia@8945914d4f86cd38f1b079cfc916f881eddbb3c2](https://github.com/JuliaLang/julia/commit/8945914d4f86cd38f1b079cfc916f881eddbb3c2)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/8945914d4f86cd38f1b079cfc916f881eddbb3c2..mofeing/julia:9ed8f4344444fc7de5a2db895a51e2a01b68b903)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/53070#issuecomment-2073010083)
...
| `["array", "equality", ("==", "Vector{Int64}")]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "julia", ("parse", "nested")]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", ("no reduction", "zero", "Float64")]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", ("zero", "Float32")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", ("small", "negative argument", "Float64")]` | 0.43 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", ("zero", "Float64")]` | 0.44 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 2.0^20π/4", "negative argument", "Float64")]` | 1.50 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (easy) abs(x) < 2.0^20π/4", "positive argument", "Float64")]` | 1.49 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 2π/4", "negative argument", "Float32")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 2π/4", "negative argument", "Float64")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float32")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float64")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 4π/4", "negative argument", "Float64")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float64")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 6π/4", "negative argument", "Float32")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 6π/4", "negative argument", "Float64")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 6π/4", "positive argument", "Float32")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 6π/4", "positive argument", "Float64")]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 8π/4", "negative argument", "Float32")]` | 1.48 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 8π/4", "negative argument", "Float64")]` | 1.48 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 8π/4", "positive argument", "Float32")]` | 1.48 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", ("argument reduction (hard) abs(x) < 8π/4", "positive argument", "Float64")]` | 1.48 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "inner", "Int32", 2, 31)]` | 0.76 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 2, 31)]` | 0.67 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 2, 32)]` | 0.67 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "two_reductions", "Int32", 3, 32)]` | 0.78 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 3, 63)]` | 0.56 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Cartesian", "two_reductions", "Int32", 3, 64)]` | 0.60 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Linear", "local_arrays", "Int64", 4095)]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Linear", "local_arrays", "Int64", 4096)]` | 0.76 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 3", "all same"]` | 1.86 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 3", "sort!(rand(2n, 2n, n); dims=1)"]` | 0.73 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matmat", "(4, 4)", "(4, 4)")]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matvec", "(16, 16)", "(16,)")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "linear algebra", ("matvec", "(8, 8)", "(8,)")]` | 1.37 (5%) :x: | 1.00 (1%)  |
| `["tuple", "misc", "11899"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("minimum", "(2, 2)")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("minimum", "(2,)")]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("minimum", "(4,)")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("sum", "(2,)")]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("sumabs", "(2, 2)")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("sumabs", "(2,)")]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("sumabs", "(4, 4)")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("map", "*", "Float32", "(false, true)")]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "collect", "Union{Missing, ComplexF64}", 1)]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.12.0-DEV.477
Commit 9ed8f43444 (2024-04-23 16:53 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz    1082708 s        566 s     250052 s  250884682 s          0 s
       #2  3500 MHz   17185312 s        290 s     432286 s  234703982 s          0 s
       #3  3500 MHz     872351 s        470 s     182233 s  251185328 s          0 s
       #4  3500 MHz     727913 s        340 s     190581 s  251176568 s          0 s
       #5  3501 MHz     717161 s        250 s     193075 s  250319772 s          0 s
       #6  3410 MHz     758537 s        263 s     188681 s  251258517 s          0 s
       #7  3302 MHz     799702 s        260 s     210666 s  251271094 s          0 s
       #8  3302 MHz     778123 s        208 s     176664 s  251328825 s          0 s
  Memory: 31.301593780517578 GB (18099.328125 MB free)
  Uptime: 2.525057233e7 sec
...
Commit 8945914d4f (2024-04-23 16:51 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 22.04.3 LTS
  uname: Linux 5.15.0-76-generic #83-Ubuntu SMP Thu Jun 15 19:16:32 UTC 2023 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3500 MHz    1083538 s        566 s     250286 s  251028050 s          0 s
       #2  3499 MHz   17326949 s        290 s     434537 s  234704949 s          0 s
       #3  3500 MHz     872597 s        470 s     182247 s  251329908 s          0 s
       #4  3501 MHz     728024 s        340 s     190595 s  251321169 s          0 s
       #5  3501 MHz     717232 s        250 s     193082 s  250464356 s          0 s
       #6  3500 MHz     758631 s        263 s     188689 s  251403260 s          0 s
       #7  3503 MHz     800105 s        260 s     210677 s  251415521 s          0 s
       #8  3503 MHz     778277 s        208 s     176674 s  251473488 s          0 s
  Memory: 31.301593780517578 GB (18112.875 MB free)
  Uptime: 2.526505815e7 sec
  Load Avg:  1.0  1.0  1.0
  WORD_SIZE: 64
