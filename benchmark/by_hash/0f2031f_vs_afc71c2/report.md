...
**4818** benchmarks were executed, **141** showed regressions, and **142** showed improvements.

## Job Properties

*Commits:* [JuliaLang/julia@0f2031fd150d453d8e86990e500f26c78c43adfa](https://github.com/JuliaLang/julia/commit/0f2031fd150d453d8e86990e500f26c78c43adfa) vs [JuliaLang/julia@afc71c255e327d8a64b69061c15994e80740974d](https://github.com/JuliaLang/julia/commit/afc71c255e327d8a64b69061c15994e80740974d)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/afc71c255e327d8a64b69061c15994e80740974d...0f2031fd150d453d8e86990e500f26c78c43adfa)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/59950#issuecomment-4275463791)
...
| `["broadcast", "mix_scalar_tuple", (10, "scal_tup")]` | 4.78 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (10, "tup_tup")]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "initialization", ("IdDict", "Int", "iterator")]` | 1.34 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("BitSet", "Int", "length")]` | 2.42 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "==", "self")]` | 2.50 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "setdiff", "Set")]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "⊆", "Set")]` | 1.97 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "⊆", "Vector")]` | 1.92 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findall", ("> q0.95", "Vector{Int64}")]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", ("+", "typename(SymTridiagonal)", "typename(SymTridiagonal)", 256)]` | 1.50 (45%) :x: | 1.10 (1%) :x: |
| `["linalg", "arithmetic", ("-", "typename(SymTridiagonal)", "typename(SymTridiagonal)", 1024)]` | 1.28 (45%)  | 1.03 (1%) :x: |
| `["linalg", "arithmetic", ("-", "typename(SymTridiagonal)", "typename(SymTridiagonal)", 256)]` | 1.62 (45%) :x: | 1.10 (1%) :x: |
...
| `["problem", "monte carlo", "euro_option_devec"]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", ("0.5 <= abs(x) < 1", "positive argument", "Float32")]` | 1.64 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "Complex{Int64}", "Complex{Int64}")]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", ("0.5 <= abs(x) < 0.975", "positive argument", "Float32")]` | 1.75 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("2 <= abs(x) < 2^28", "negative argument", "Float32")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", ("2 <= abs(x) < 2^28", "positive argument", "Float32")]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "manual_example!", "Int32", 3, 32)]` | 1.24 (20%) :x: | 1.00 (1%)  |
| `["simd", ("Cartesian", "manual_example!", "Int32", 4, 32)]` | 1.25 (20%) :x: | 1.00 (1%)  |
...
| `["simd", ("CartesianPartition", "manual_example!", "Float64", 3, 32)]` | 2.14 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_example!", "Float64", 4, 31)]` | 1.64 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_example!", "Float64", 4, 32)]` | 2.07 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_example!", "Int64", 3, 32)]` | 1.49 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_example!", "Int64", 4, 32)]` | 1.43 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 0.13 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("broadcast", "*", "Int8", "(false, true)")]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "*", "Int8", "(true, true)")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("broadcast", "abs", "BigFloat", 1)]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("map", "*", "ComplexF64", "(false, false)")]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countequals", "Int8")]` | 1.78 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.2059
Commit 0f2031fd15 (2026-04-17 15:58 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz      11084 s          7 s       2632 s    1413023 s          0 s  
       #2  3500 MHz     119315 s          2 s       3256 s    1304714 s          0 s  
       #3  3500 MHz       8636 s          4 s       1633 s    1413676 s          0 s  
       #4  3499 MHz       8080 s          4 s       1823 s    1416257 s          0 s  
  Memory: 31.301372528076172 GB (27257.33984375 MB free)
  Uptime: 1.42846451e6 sec
...
```
Julia Version 1.14.0-DEV.2058
Commit afc71c255e (2026-04-19 00:58 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 22.04.5 LTS
  uname: Linux 5.15.0-174-generic #184-Ubuntu SMP Fri Mar 13 18:41:50 UTC 2026 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3500 MHz      11229 s          7 s       2737 s    1427236 s          0 s  
       #2  3501 MHz     133553 s          2 s       3481 s    1304774 s          0 s  
       #3  3500 MHz       8677 s          4 s       1636 s    1428121 s          0 s  
       #4  3500 MHz       8097 s          4 s       1825 s    1430744 s          0 s  
  Memory: 31.301372528076172 GB (27537.40625 MB free)
  Uptime: 1.44298687e6 sec
