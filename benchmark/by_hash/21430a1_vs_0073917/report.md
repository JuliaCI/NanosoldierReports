...
*Commits:* [JuliaLang/julia@21430a16d040e8adc95bad038bff26b389358184](https://github.com/JuliaLang/julia/commit/21430a16d040e8adc95bad038bff26b389358184) vs [JuliaLang/julia@00739173311983479fee3f5f826e4b763872860a](https://github.com/JuliaLang/julia/commit/00739173311983479fee3f5f826e4b763872860a)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/00739173311983479fee3f5f826e4b763872860a..21430a16d040e8adc95bad038bff26b389358184)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/55767#issuecomment-2357215135)
...
| `["array", "index", ("sumcolon", "1.0:0.00010001000100010001:2.0")]` | 0.50 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "iteration", ("Set", "Any", "iterate second")]` | 1.28 (25%) :x: | 1.00 (1%)  |
...
| `["io", "skipchars"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["micro", "fib"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["misc", "23042", "Float64"]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 9π/4", "negative argument", "Float32", "cos_kernel")]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", ("0.00024414062f0 <= abs(x) < 9f0", "negative argument", "Float32")]` | 0.36 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 3, 31)]` | 1.94 (20%) :x: | 1.00 (1%)  |
| `["simd", ("Cartesian", "conditional_loop!", "Int32", 3, 63)]` | 1.47 (20%) :x: | 1.00 (1%)  |
| `["simd", ("Cartesian", "manual_example!", "Int64", 2, 63)]` | 1.21 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 3, 63)]` | 1.43 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "inner", "Int32", 3, 63)]` | 1.21 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "manual_example!", "Float64", 2, 64)]` | 1.38 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", ("Ac_mul_B", "dense 5x50, sparse 5x50 -> dense 50x50")]` | 1.32 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("collect", "filter", "BigFloat", 1)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("collect", "filter", "BigInt", 1)]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("map", "*", "Int8", "(false, true)")]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("map", "abs", "ComplexF64", 0)]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_countequals", "BigFloat")]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "eachindex", "Union{Missing, Int8}", 1)]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Float64", 0)]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.12.0-DEV.1231
Commit 21430a16d0 (2024-09-17 23:47 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz     422720 s        182 s     113319 s   85907800 s          0 s
       #2  3500 MHz    5453313 s         93 s     132741 s   80906604 s          0 s
       #3  3500 MHz     298141 s        122 s      49887 s   86137217 s          0 s
       #4  3501 MHz     292812 s         95 s      60545 s   86094133 s          0 s
       #5  3501 MHz     247832 s         70 s      43231 s   86120824 s          0 s
       #6  3501 MHz     271328 s         59 s      57624 s   85706325 s          0 s
       #7  3502 MHz     285803 s        108 s      48302 s   86076144 s          0 s
       #8  3502 MHz     253546 s         73 s      39605 s   86160255 s          0 s
  Memory: 31.30148696899414 GB (21563.26953125 MB free)
  Uptime: 8.65280594e6 sec
...
Commit 0073917331 (2024-09-17 23:47 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 22.04.4 LTS
  uname: Linux 5.15.0-112-generic #122-Ubuntu SMP Thu May 23 07:48:21 UTC 2024 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz     423807 s        183 s     113994 s   86049758 s          0 s
       #2  3500 MHz    5594206 s         93 s     134899 s   80907646 s          0 s
       #3  3500 MHz     298831 s        122 s      49910 s   86280576 s          0 s
       #4  3501 MHz     292857 s         95 s      60550 s   86238147 s          0 s
       #5  3503 MHz     247934 s         70 s      43235 s   86264686 s          0 s
       #6  3501 MHz     271434 s         59 s      57629 s   85850094 s          0 s
       #7  3503 MHz     285991 s        108 s      48310 s   86220027 s          0 s
       #8  3504 MHz     253672 s         73 s      39615 s   86304184 s          0 s
  Memory: 31.30148696899414 GB (21543.24609375 MB free)
  Uptime: 8.66721528e6 sec
