...
*Commits:* [JuliaLang/julia@3a6353468de941edde10511266d32421362d799c](https://github.com/JuliaLang/julia/commit/3a6353468de941edde10511266d32421362d799c) vs [JuliaLang/julia@bd8dbc388c7b89f68838ca554ed7ba91740cce75](https://github.com/JuliaLang/julia/commit/bd8dbc388c7b89f68838ca554ed7ba91740cce75)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/bd8dbc388c7b89f68838ca554ed7ba91740cce75..3a6353468de941edde10511266d32421362d799c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/41199#issuecomment-1147144382)
...
| `["inference", "abstract interpretation", "abstract_call_gf_by_type"]` | 1.28 (5%) :x: | 1.12 (1%) :x: |
| `["inference", "abstract interpretation", "construct_ssa!"]` | 1.20 (5%) :x: | 1.08 (1%) :x: |
...
| `["inference", "abstract_call_gf_by_type"]` | 1.16 (5%) :x: | 1.10 (1%) :x: |
| `["inference", "construct_ssa!"]` | 1.07 (5%) :x: | 1.05 (1%) :x: |
| `["inference", "optimization", "abstract_call_gf_by_type"]` | 1.06 (5%) :x: | 1.03 (1%) :x: |
...
| `["random", "collections", ("rand", "ImplicitRNG", "large String")]` | 1.49 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", ("rand", "ImplicitRNG", "small String")]` | 1.37 (25%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 2, 63)]` | 1.72 (20%) :x: | 1.00 (1%)  |
| `["simd", ("CartesianPartition", "conditional_loop!", "Int32", 4, 31)]` | 1.52 (20%) :x: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", ("matvec", "(8, 8)", "(8,)")]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", ("minimum", "(2, 2)")]` | 1.61 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", ("minimum", "(2,)")]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", ("sum", "(16,)")]` | 0.57 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_simplecopy", "Int8", 1)]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum3", "Float32", 1)]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Union{Missing, Float64}", 1)]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
Commit 3a6353468d (2022-06-06 07:35 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3405 MHz      15811 s         48 s       5760 s   11047243 s          0 s
       #2  2921 MHz     307817 s          3 s      17657 s   10743829 s          0 s
       #3  2913 MHz      13916 s         15 s       5094 s   11044902 s          0 s
       #4  2907 MHz      13235 s         43 s       5009 s   11042595 s          0 s
       #5  3022 MHz      14289 s         32 s       5122 s   11008705 s          0 s
       #6  2612 MHz      15245 s         16 s       4986 s   11043986 s          0 s
       #7  2918 MHz      15557 s         14 s       5226 s   11048162 s          0 s
       #8  2891 MHz      15452 s         33 s       5105 s   11045445 s          0 s
  Memory: 31.32082748413086 GB (21065.8515625 MB free)
  Uptime: 1.10783947e6 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3583 MHz      16385 s         48 s       5904 s   11143443 s          0 s
       #2  3107 MHz     398899 s          3 s      21748 s   10745738 s          0 s
       #3  2977 MHz      14140 s         15 s       5104 s   11141731 s          0 s
       #4  2976 MHz      13510 s         43 s       5025 s   11139298 s          0 s
       #5  3160 MHz      14332 s         32 s       5129 s   11105622 s          0 s
       #6  2611 MHz      15292 s         16 s       4995 s   11141004 s          0 s
       #7  2786 MHz      16401 s         14 s       5252 s   11144366 s          0 s
       #8  3058 MHz      15459 s         33 s       5113 s   11142506 s          0 s
  Memory: 31.32082748413086 GB (20628.63671875 MB free)
  Uptime: 1.11754773e6 sec
  Load Avg:  1.0  1.0  1.0
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-13.0.1 (ORCJIT, haswell)
