...
*Commits:* [aviatesk/julia@06b2bf21d34b4c2b1774cd7c970cd0c77574d98e](https://github.com/aviatesk/julia/commit/06b2bf21d34b4c2b1774cd7c970cd0c77574d98e) vs [JuliaLang/julia@5e8d7edfffbac8a69fad0f901089bbaa97d10434](https://github.com/JuliaLang/julia/commit/5e8d7edfffbac8a69fad0f901089bbaa97d10434)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/5e8d7edfffbac8a69fad0f901089bbaa97d10434..aviatesk/julia:06b2bf21d34b4c2b1774cd7c970cd0c77574d98e)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/40880#issuecomment-925533279)
...
| `["collection", "deletion", ("Set", "Int", "filter!")]` | 1.42 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("Dict", "Any", "in", "false")]` | 1.50 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("Vector", "Int", "in", "false")]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("empty", "Int", "<", "BitSet")]` | 2.02 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findall", ("> q0.8", "Vector{UInt64}")]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", ("abs(x) < 0.5", "negative argument", "Float32")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", ("2 <= abs(x) < 2^28", "negative argument", "Float32")]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", ("2 <= abs(x) < 2^28", "positive argument", "Float32")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("x one", "Float32")]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["shootout", "k_nucleotide"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("manual_example!", "Float64", 4095)]` | 0.70 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["string", "repeat", "repeat str len 16"]` | 2.42 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.8.0-DEV.580
Commit 06b2bf21d3 (2021-09-23 06:08 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8124M CPU @ 3.00GHz: 
       ...
       #1  3400 MHz     377854 s       3555 s      38298 s  183136022 s          0 s
       #2  3400 MHz   15222004 s       1466 s     853238 s  167483488 s          0 s
       #3  3404 MHz     269546 s       1321 s      14073 s  183278194 s          0 s
       #4  3410 MHz     310149 s       1320 s      15205 s  183235782 s          0 s
       #5  3420 MHz     178918 s       1345 s      13044 s  183343561 s          0 s
       #6  3420 MHz     206388 s       1296 s      12321 s  183343806 s          0 s
       #7  3403 MHz     168643 s       1225 s      13609 s  183380416 s          0 s
       #8  3410 MHz     162068 s       1401 s      12051 s  183371949 s          0 s
       
  Memory: 30.362831115722656 GB (8951.5546875 MB free)
  Uptime: 1.835679716e7 sec
...
Commit 5e8d7edfff (2021-09-23 02:12 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 20.04.3 LTS
  uname: Linux 5.4.0-1037-aws #39-Ubuntu SMP Thu Jan 14 02:56:06 UTC 2021 x86_64 x86_64
  CPU: Intel(R) Xeon(R) Platinum 8124M CPU @ 3.00GHz: 
              speed         user         nice          sys         idle          irq
       #1  3423 MHz     377938 s       3555 s      38325 s  183243460 s          0 s
       #2  3407 MHz   15320861 s       1466 s     860260 s  167485172 s          0 s
       #3  3406 MHz     269607 s       1321 s      14084 s  183385684 s          0 s
       #4  3400 MHz     311262 s       1320 s      15247 s  183342188 s          0 s
       #5  3400 MHz     178972 s       1345 s      13060 s  183451054 s          0 s
       #6  3402 MHz     206824 s       1296 s      12336 s  183450917 s          0 s
       #7  3406 MHz     168725 s       1225 s      13622 s  183487881 s          0 s
       #8  3405 MHz     162108 s       1401 s      12062 s  183479451 s          0 s
       
  Memory: 30.362831115722656 GB (8959.74609375 MB free)
  Uptime: 1.836755346e7 sec
  Load Avg:  1.0  1.0  1.0
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-12.0.1 (ORCJIT, skylake-avx512)
