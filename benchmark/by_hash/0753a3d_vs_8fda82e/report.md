...
*Commits:* [JuliaLang/julia@0753a3de131db58d0692094adcf8c590b45dc4ae](https://github.com/JuliaLang/julia/commit/0753a3de131db58d0692094adcf8c590b45dc4ae) vs [JuliaLang/julia@8fda82e2406559a5925b7ee4c645e0412379b243](https://github.com/JuliaLang/julia/commit/8fda82e2406559a5925b7ee4c645e0412379b243)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/8fda82e2406559a5925b7ee4c645e0412379b243..0753a3de131db58d0692094adcf8c590b45dc4ae)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/60353#issuecomment-3639029579)
...
| `["find", "findall", ("Vector{Bool}", "10-90")]` | 1.50 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "UInt64", "ComplexF64")]` | 4.33 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 2.0^20π/4", "negative argument", "Float32", "cos_kernel")]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 2.0^20π/4", "negative argument", "Float64", "cos_kernel")]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 2.0^20π/4", "positive argument", "Float32", "cos_kernel")]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 2π/4", "negative argument", "Float64", "sin_kernel")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 3π/4", "negative argument", "Float64", "sin_kernel")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 4π/4", "negative argument", "Float32", "cos_kernel")]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 4π/4", "negative argument", "Float64", "cos_kernel")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 5π/4", "negative argument", "Float32", "cos_kernel")]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", ("argument reduction (easy) abs(x) < 5π/4", "negative argument", "Float64", "cos_kernel")]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float64", "sin_kernel")]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 2π/4", "positive argument", "Float32", "cos_kernel")]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 3π/4", "positive argument", "Float32", "cos_kernel")]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 3π/4", "positive argument", "Float64", "cos_kernel")]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 4π/4", "negative argument", "Float32", "sin_kernel")]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 4π/4", "negative argument", "Float64", "sin_kernel")]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 4π/4", "positive argument", "Float32", "sin_kernel")]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 4π/4", "positive argument", "Float64", "sin_kernel")]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 5π/4", "negative argument", "Float32", "sin_kernel")]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 5π/4", "negative argument", "Float64", "sin_kernel")]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 5π/4", "positive argument", "Float32", "sin_kernel")]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 8π/4", "negative argument", "Float32", "sin_kernel")]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 8π/4", "positive argument", "Float32", "sin_kernel")]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 9π/4", "negative argument", "Float32", "sin_kernel")]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 2π/4", "positive argument", "Float32", "cos_kernel")]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 4π/4", "negative argument", "Float32", "sin_kernel")]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float32", "sin_kernel")]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 6π/4", "negative argument", "Float32", "cos_kernel")]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 6π/4", "positive argument", "Float32", "cos_kernel")]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 8π/4", "negative argument", "Float32", "sin_kernel")]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 8π/4", "negative argument", "Float64", "sin_kernel")]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (hard) abs(x) < 8π/4", "positive argument", "Float32", "sin_kernel")]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("0 <= abs(x) < 2.0^-28", "negative argument", "Float64")]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sinh", ("0 <= abs(x) < 2.0^-28", "positive argument", "Float64")]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", ("zero", "Float64")]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", ("adjoint", "(20000, 10000)")]` | 0.15 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("adjoint", "(20000, 20000)")]` | 0.18 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 10000)")]` | 0.62 (30%) :white_check_mark: | 1.00 (1%)  |
| `["string", "==(::SubString, ::String)", "different length"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["string", "readuntil", "target length 1"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["tuple", "index", ("sumelt", "TupleWrapper", 3, "Float64")]` | 1.73 (40%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("collect", "filter", "BigInt", 1)]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "perf_sumskipmissing", "Int8", 0)]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.1358
Commit 0753a3de13 (2025-12-10 20:08 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz     651150 s        564 s     243622 s  166927709 s          0 s
       #2  3500 MHz    6242810 s        202 s     170152 s  161618106 s          0 s
       #3  3501 MHz     295450 s        195 s      82198 s  167644118 s          0 s
       #4  3500 MHz     300565 s        244 s      85152 s  167646302 s          0 s
       #5  3503 MHz     265941 s        228 s      97169 s  167536301 s          0 s
       #6  3604 MHz     277070 s        141 s      89504 s  166703231 s          0 s
       #7  3503 MHz     312898 s        292 s      89744 s  167456950 s          0 s
       #8  3503 MHz     311585 s        232 s      91891 s  167581203 s          0 s
  Memory: 31.30146026611328 GB (27584.875 MB free)
  Uptime: 1.6812104e7 sec
...
```
Julia Version 1.14.0-DEV.1352
Commit 8fda82e240 (2025-12-10 20:06 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 22.04.5 LTS
  uname: Linux 5.15.0-140-generic #150-Ubuntu SMP Sat Apr 12 06:00:09 UTC 2025 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3500 MHz     652835 s        565 s     245030 s  167130804 s          0 s
       #2  3405 MHz    6446078 s        202 s     172840 s  161618883 s          0 s
       #3  3501 MHz     295579 s        195 s      82211 s  167850668 s          0 s
       #4  3500 MHz     300654 s        244 s      85171 s  167852910 s          0 s
       #5  3503 MHz     266012 s        228 s      97175 s  167742782 s          0 s
       #6  3501 MHz     277131 s        141 s      89511 s  166909523 s          0 s
       #7  3502 MHz     313352 s        292 s      89764 s  167663174 s          0 s
       #8  3503 MHz     311638 s        232 s      91898 s  167787857 s          0 s
  Memory: 31.30146026611328 GB (27729.02734375 MB free)
  Uptime: 1.68327778e7 sec
