...
*Commits:* [JuliaLang/julia@ec112541f86f20a35fb7b19695f3625b302267d5](https://github.com/JuliaLang/julia/commit/ec112541f86f20a35fb7b19695f3625b302267d5) vs [JuliaLang/julia@6052e445dc5e2687e3c262fa5ba4b84a23dc4ed4](https://github.com/JuliaLang/julia/commit/6052e445dc5e2687e3c262fa5ba4b84a23dc4ed4)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/6052e445dc5e2687e3c262fa5ba4b84a23dc4ed4..ec112541f86f20a35fb7b19695f3625b302267d5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/49591#issuecomment-1531972619)
...
| `["broadcast", "mix_scalar_tuple", (10, "tup_tup")]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (3, "scal_tup")]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (3, "scal_tup_x3")]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (5, "scal_tup")]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", (5, "tup_tup")]` | 4.05 (5%) :x: | 1.00 (1%)  |
...
| `["dates", "accessor", "hour"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "accessor", "millisecond"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["dates", "accessor", "second"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.13 (5%) :x: | 1.03 (1%) :x: |
| `["inference", "abstract interpretation", "REPL.REPLCompletions.completions"]` | 1.12 (5%) :x: | 1.03 (1%) :x: |
| `["inference", "abstract interpretation", "broadcasting"]` | 2.55 (5%) :x: | 1.77 (1%) :x: |
...
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 1.12 (5%) :x: | 1.05 (1%) :x: |
| `["inference", "allinference", "Base.init_stdio(::Ptr{Cvoid})"]` | 1.06 (5%) :x: | 1.01 (1%)  |
...
| `["inference", "allinference", "println(::QuoteNode)"]` | 1.07 (5%) :x: | 1.02 (1%) :x: |
...
| `["linalg", "arithmetic", ("3-arg mul!", 2)]` | 2.16 (45%) :x: | 1.00 (1%)  |
...
| `["misc", "parse", "Float64"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", ("rand!", "ImplicitRNG", "Int", "1:1000")]` | 0.64 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", ("minimum", "(8, 8)")]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
Commit ec112541f8 (2023-05-02 20:26 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3900 MHz     374386 s      41838 s     335619 s   76153800 s          0 s
       #2  3900 MHz    3987223 s      32153 s     368087 s   72613829 s          0 s
       #3  3524 MHz     375271 s      32622 s     290648 s   76155569 s          0 s
       #4  3900 MHz     294734 s      26764 s     304898 s   76204968 s          0 s
  Memory: 31.313323974609375 GB (17593.22265625 MB free)
  Uptime: 7.7201245e6 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3900 MHz     375353 s      42110 s     336678 s   76255526 s          0 s
       #2  3900 MHz    4088025 s      32153 s     370087 s   72615706 s          0 s
       #3  3900 MHz     376556 s      32622 s     290698 s   76258710 s          0 s
       #4  3499 MHz     295272 s      26764 s     304937 s   76308862 s          0 s
  Memory: 31.313323974609375 GB (17578.9140625 MB free)
  Uptime: 7.73059292e6 sec
