...
*Commit(s):* [JuliaLang/julia@85c46c01160563d34d42a307ee9a23dae8174580](https://github.com/JuliaLang/julia/commit/85c46c01160563d34d42a307ee9a23dae8174580) vs [JuliaLang/julia@ebcc603bdf33babea30a2f2d722269bcb34c4cee](https://github.com/JuliaLang/julia/commit/ebcc603bdf33babea30a2f2d722269bcb34c4cee)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/39160#issuecomment-764776792)
...
```
NanosoldierError: failed to run benchmarks against comparison commit: failed process: Process(`/home/nanosoldier/workdir/jl_X97z8U/julia -e 'VERSION >= v"0.7.0-DEV.3656" && using Pkg; Pkg.update()'`, ProcessExited(1)) [1]
