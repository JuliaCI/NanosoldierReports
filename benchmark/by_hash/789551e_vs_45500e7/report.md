...
*Commits:* [JuliaLang/julia@789551e60511d5af92ed9f052149f636ff109a22](https://github.com/JuliaLang/julia/commit/789551e60511d5af92ed9f052149f636ff109a22) vs [JuliaLang/julia@45500e7d14a867751a33e35bb1945df94fd5c0b0](https://github.com/JuliaLang/julia/commit/45500e7d14a867751a33e35bb1945df94fd5c0b0)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/45500e7d14a867751a33e35bb1945df94fd5c0b0..789551e60511d5af92ed9f052149f636ff109a22)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/61168#issuecomment-3975311579)
...
| `["collection", "iteration", ("Dict", "Int", "iterate")]` | 1.31 (25%) :x: | 1.00 (1%)  |
...
| `["inference", "abstract interpretation", "broadcasting"]` | 1.04 (5%)  | 1.03 (1%) :x: |
| `["inference", "abstract interpretation", "many_const_calls"]` | 1.00 (5%)  | 1.01 (1%) :x: |
| `["inference", "abstract interpretation", "many_invoke_calls"]` | 1.05 (5%) :x: | 1.02 (1%) :x: |
| `["inference", "abstract interpretation", "many_local_vars"]` | 1.65 (5%) :x: | 1.01 (1%)  |
| `["inference", "abstract interpretation", "many_method_matches"]` | 1.03 (5%)  | 1.02 (1%) :x: |
...
| `["inference", "allinference", "many_local_vars"]` | 1.21 (5%) :x: | 0.99 (1%)  |
| `["inference", "optimization", "many_const_calls"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "optimization", "many_local_vars"]` | 0.89 (5%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
...
| `["scalar", "atanh", ("2^-28 <= abs(x) < 0.5", "negative argument", "Float32")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sort", "length = 10", "Float64 unions with missing"]` | 1.20 (20%) :x: | 1.00 (1%)  |
| `["sort", "length = 10", "ascending"]` | 0.70 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 10", "sort!(fill(missing, length))"]` | 0.53 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 100", "sort!(fill(missing, length))"]` | 0.80 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 3", "ascending"]` | 0.52 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 3", "sort!(fill(missing, length))"]` | 0.67 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 30", "ascending"]` | 0.79 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "length = 30", "sort!(fill(missing, length))"]` | 0.51 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse solves", "square system (ldlt), matrix rhs"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", ("transpose", "(20000, 20000)")]` | 1.82 (30%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.14.0-DEV.1814
Commit 789551e605 (2026-02-27 08:52 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz     117031 s         81 s      36171 s   23444328 s          0 s  
       #2  3499 MHz     412621 s         42 s      17830 s   23197070 s          0 s  
       #3  3501 MHz      76172 s         39 s      11686 s   23539289 s          0 s  
       #4  3500 MHz      57973 s         21 s      11137 s   23558122 s          0 s  
       #5  3503 MHz      32393 s         31 s      13015 s   23562947 s          0 s  
       #6  3501 MHz      91745 s         30 s      11958 s   23388714 s          0 s  
       #7  3500 MHz     111625 s         30 s      11881 s   23481966 s          0 s  
       #8  3503 MHz     145258 s         27 s      12502 s   23459454 s          0 s  
  Memory: 31.30146026611328 GB (27767.19140625 MB free)
  Uptime: 2.363847933e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3500 MHz     117194 s         81 s      36287 s   23464000 s          0 s  
       #2  3500 MHz     432300 s         42 s      18076 s   23197146 s          0 s  
       #3  3499 MHz      76193 s         39 s      11688 s   23559264 s          0 s  
       #4  3499 MHz      57978 s         21 s      11137 s   23578116 s          0 s  
       #5  3501 MHz      32405 s         31 s      13017 s   23582917 s          0 s  
       #6  3501 MHz      91749 s         30 s      11959 s   23408671 s          0 s  
       #7  3503 MHz     111662 s         30 s      11883 s   23501926 s          0 s  
       #8  3500 MHz     145266 s         27 s      12503 s   23479442 s          0 s  
  Memory: 31.30146026611328 GB (28060.36328125 MB free)
  Uptime: 2.36584804e7 sec
