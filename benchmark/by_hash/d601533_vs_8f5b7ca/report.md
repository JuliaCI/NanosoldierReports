...
*Commits:* [JuliaLang/julia@d6015338d886157638f864459564276653151403](https://github.com/JuliaLang/julia/commit/d6015338d886157638f864459564276653151403) vs [JuliaLang/julia@8f5b7ca12ad48c6d740e058312fc8cf2bbe67848](https://github.com/JuliaLang/julia/commit/8f5b7ca12ad48c6d740e058312fc8cf2bbe67848)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/8f5b7ca12ad48c6d740e058312fc8cf2bbe67848..d6015338d886157638f864459564276653151403)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/56228#issuecomment-2429609566)
...
| `["inference", "abstract interpretation", "println(::QuoteNode)"]` | 1.12 (5%) :x: | 1.08 (1%) :x: |
...
| `["inference", "allinference", "println(::QuoteNode)"]` | 1.10 (5%) :x: | 1.10 (1%) :x: |
...
| `["scalar", "asin", ("abs(x) < 0.5", "positive argument", "Float64")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", ("2pow127", "positive argument", "Float32")]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["shootout", "meteor_contest"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["sort", "insertionsort", "sort forwards"]` | 0.80 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["string", "replace"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", ("perf_sum2", "Int8", 0)]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum3", "ComplexF64", 1)]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["union", "array", ("perf_sum3", "Float64", 1)]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", ("perf_sum4", "Int8", 0)]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit d6015338d8 (2024-10-21 16:04 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3500 MHz     430996 s        165 s     139941 s  115772995 s          0 s
       #2  3499 MHz    3055195 s        119 s     130618 s  113163460 s          0 s
       #3  3500 MHz     290567 s        137 s      73169 s  116012300 s          0 s
       #4  3500 MHz     280267 s         78 s      74524 s  116025394 s          0 s
       #5  3503 MHz     235367 s         64 s      53730 s  115990760 s          0 s
       #6  3501 MHz     249412 s        129 s      60556 s  115413982 s          0 s
       #7  3502 MHz     280894 s         82 s      60733 s  115928849 s          0 s
       #8  3503 MHz     278836 s         73 s      64266 s  116002339 s          0 s
  Memory: 31.30147933959961 GB (19424.75390625 MB free)
  Uptime: 1.164438243e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3500 MHz     432006 s        165 s     140530 s  115889048 s          0 s
       #2  3499 MHz    3169772 s        119 s     132856 s  113164518 s          0 s
       #3  3500 MHz     291193 s        137 s      73189 s  116129512 s          0 s
       #4  3500 MHz     280371 s         78 s      74529 s  116143152 s          0 s
       #5  3503 MHz     235515 s         64 s      53735 s  116108380 s          0 s
       #6  3500 MHz     249584 s        129 s      60563 s  115531507 s          0 s
       #7  3500 MHz     280942 s         82 s      60738 s  116046665 s          0 s
       #8  3503 MHz     278980 s         73 s      64275 s  116120048 s          0 s
  Memory: 31.30147933959961 GB (19400.3125 MB free)
  Uptime: 1.165616999e7 sec
