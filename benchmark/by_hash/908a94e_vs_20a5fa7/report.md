...
*Commits:* [JuliaLang/julia@908a94e1b3ac43be3231a9a5dfeba4e1ba6de0be](https://github.com/JuliaLang/julia/commit/908a94e1b3ac43be3231a9a5dfeba4e1ba6de0be) vs [JuliaLang/julia@20a5fa751aa613b3244c9158581bcc85f049dc5c](https://github.com/JuliaLang/julia/commit/20a5fa751aa613b3244c9158581bcc85f049dc5c)

*Comparison Diff:* [link](https://github.com/JuliaLang/julia/compare/20a5fa751aa613b3244c9158581bcc85f049dc5c..908a94e1b3ac43be3231a9a5dfeba4e1ba6de0be)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/51599#issuecomment-1749815967)
...
| `["array", "cat", "4467"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "equality", ("isequal", "Vector{Int64} isequal Vector{Int64}")]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", ("sumeach_view", "Base.ReinterpretArray{BaseBenchmarks.ArrayBenchmarks.PairVals{Float32}, 2, Float32, Matrix{Float32}, false}")]` | 0.19 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", ("sumlinear_view", "Base.ReinterpretArray{Float32, 2, Int32, Matrix{Int32}, false}")]` | 0.03 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["broadcast", "mix_scalar_tuple", (10, "scal_tup_x3")]` | 686.98 (5%) :x: | Inf (1%) :x: |
...
| `["collection", "optimizations", ("Vector", "concrete", "Nothing")]` | 2.87 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("BitSet", "Int", "first")]` | 0.51 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", ("IdDict", "Int", "in", "true")]` | 2.81 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", ("IdDict", "Int", "push!", "new")]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", ("BitSet", "Int", "symdiff", "Set", "Set")]` | 0.67 (25%) :white_check_mark: | 0.91 (1%) :white_check_mark: |
...
| `["dates", "accessor", "minute"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "construction", "Date"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["inference", "allinference", "Base.init_stdio(::Ptr{Cvoid})"]` | 0.98 (5%)  | 1.03 (1%) :x: |
| `["inference", "allinference", "REPL.REPLCompletions.completions"]` | 0.96 (5%)  | 1.03 (1%) :x: |
| `["inference", "allinference", "broadcasting"]` | 0.96 (5%)  | 1.01 (1%) :x: |
| `["inference", "allinference", "many_const_calls"]` | 1.02 (5%)  | 1.04 (1%) :x: |
| `["inference", "allinference", "many_invoke_calls"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["inference", "allinference", "many_opaque_closures"]` | 0.94 (5%) :white_check_mark: | 0.99 (1%)  |
| `["inference", "allinference", "println(::QuoteNode)"]` | 1.01 (5%)  | 1.04 (1%) :x: |
| `["inference", "allinference", "sin(42)"]` | 1.02 (5%)  | 1.05 (1%) :x: |
...
| `["misc", "afoldl", "Float64"]` | 1.50 (5%) :x: | 1.00 (1%)  |
...
| `["random", "types", ("rand!", "MersenneTwister", "Complex{UInt64}")]` | 0.39 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("rand", "MersenneTwister", "Complex{Int64}")]` | 0.55 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", ("rand", "MersenneTwister", "Complex{UInt64}")]` | 0.55 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", ("div", "ComplexF32", "Complex{UInt64}")]` | 1.82 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("div", "Complex{Int64}", "ComplexF32")]` | 1.65 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("div", "Complex{Int64}", "Complex{UInt64}")]` | 2.24 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("div", "Complex{UInt64}", "ComplexF32")]` | 1.70 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("div", "Complex{UInt64}", "Complex{Int64}")]` | 2.67 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", ("div", "Complex{UInt64}", "Complex{UInt64}")]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) high", "y negative", "x negative", "Float32")]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) high", "y negative", "x negative", "Float64")]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) high", "y negative", "x positive", "Float32")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) high", "y negative", "x positive", "Float64")]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) high", "y positive", "x negative", "Float32")]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) high", "y positive", "x negative", "Float64")]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) high", "y positive", "x positive", "Float32")]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("abs(y/x) small", "y positive", "x negative", "Float32")]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) small", "y positive", "x negative", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("abs(y/x) small", "y positive", "x positive", "Float32")]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y finite", "y negative", "x infinite", "x negative", "Float32")]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("y finite", "y negative", "x infinite", "x negative", "Float64")]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("y finite", "y negative", "x infinite", "x positive", "Float32")]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("y finite", "y negative", "x infinite", "x positive", "Float64")]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("y finite", "y positive", "x infinite", "x negative", "Float32")]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y finite", "y positive", "x infinite", "x positive", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("y infinite", "y negative", "x finite", "x negative", "Float32")]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y infinite", "y negative", "x infinite", "x negative", "Float32")]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y infinite", "y positive", "x infinite", "x negative", "Float32")]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("y infinite", "y positive", "x infinite", "x negative", "Float64")]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", ("y infinite", "y positive", "x infinite", "x positive", "Float32")]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", ("y zero", "y negative", "x negative", "Float64")]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "fastmath", ("div", "Complex{UInt64}")]` | 1.46 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", ("argument reduction (hard) abs(x) < 4π/4", "positive argument", "Float64")]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", ("argument reduction (paynehanek) abs(x) > 2.0^20*π/2", "negative argument", "Float64")]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 2.0^20π/4", "negative argument", "Float64", "sin_kernel")]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 2.0^20π/4", "positive argument", "Float64", "sin_kernel")]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", ("argument reduction (easy) abs(x) < 9π/4", "positive argument", "Float64", "sin_kernel")]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["simd", ("Linear", "loop_fields!", "Float32", "BaseBenchmarks.SIMDBenchmarks.ImmutableFields", 4096)]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Linear", "loop_fields!", "Float32", "BaseBenchmarks.SIMDBenchmarks.MutableFields", 4095)]` | 0.74 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Linear", "loop_fields!", "Float32", "BaseBenchmarks.SIMDBenchmarks.MutableFields", 4096)]` | 0.78 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", ("Linear", "sum_reduce", "Int32", 4096)]` | 0.72 (20%) :white_check_mark: | 1.00 (1%)  |
| `["sort", "issorted", ("reverse", "ascending")]` | 1.79 (30%) :x: | 1.00 (1%)  |
| `["sort", "issorted", ("reverse", "random")]` | 1.52 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", ("skipmissing", "sum", "Union{Nothing, Int64}", 0)]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.11.0-DEV.607
Commit 908a94e1b3 (2023-10-06 00:07 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1   900 MHz     268784 s         95 s     112853 s   78587121 s          0 s
       #2   800 MHz    3770014 s         49 s     172948 s   74924613 s          0 s
       #3   800 MHz     274013 s        101 s     164696 s   78523476 s          0 s
       #4   800 MHz     217136 s         61 s     112351 s   78547540 s          0 s
       #5   800 MHz     227184 s         74 s     158320 s   78209508 s          0 s
       #6  3508 MHz     234208 s         49 s     142311 s   78555321 s          0 s
       #7  2500 MHz     263145 s        105 s     131852 s   78544440 s          0 s
       #8   800 MHz     247153 s         60 s     173027 s   78539941 s          0 s
  Memory: 31.301593780517578 GB (22819.59375 MB free)
  Uptime: 7.90585184e6 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3513 MHz     269538 s         96 s     113045 s   78715111 s          0 s
       #2  2500 MHz    3896398 s         49 s     174805 s   74925570 s          0 s
       #3  1600 MHz     274617 s        101 s     164710 s   78652037 s          0 s
       #4   800 MHz     217204 s         61 s     112359 s   78676549 s          0 s
       #5   800 MHz     227338 s         74 s     158330 s   78338368 s          0 s
       #6   800 MHz     234270 s         49 s     142316 s   78684445 s          0 s
       #7   800 MHz     263275 s        105 s     131858 s   78673488 s          0 s
       #8   800 MHz     247280 s         60 s     173034 s   78668994 s          0 s
  Memory: 31.301593780517578 GB (22800.43359375 MB free)
  Uptime: 7.91877176e6 sec
